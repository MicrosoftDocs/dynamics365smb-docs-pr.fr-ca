...
Les articles peuvent être des articles en inventaire et des services, représentés par les types **Inventaire** et **Service** sur la fiche article. Le processus de facture vente est identique pour les deux types d'article. Pour plus d'informations, reportez vous à [Procédure : enregistrer de nouveaux articles](inventory-how-register-new-items.md).
