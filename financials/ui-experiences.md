...
> [!NOTE]  
>   Ce paramètre s'applique à tous les utilisateurs au sein de votre compagnie.
...
| Suite |Affiche plus d'actions et de champs pour des secteurs d'activité essentiels et pour d'autres secteurs, tels que la gestion de projets, la gestion d'immobilisation, et l'analyse par dimensions. |
