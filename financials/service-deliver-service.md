...
|Créez des documents contenant des informations sur un service, telles que les réparations et l'entretien, pour les articles de service.|[Procédure : créer des commandes service](service-how-to-create-service-orders.md)|
...
|Reportez les commandes de service pour les services en vue de mettre à jour votre comptabilité.|[Procédure : reporter des commandes et des notes de crédit service](service-how-to-post-service-orders.md)|  
|Créez et reportez des factures pour les services que vous avez fournis.|[Procédure : créer des notes de crédit ou des factures service](service-how-create-invoices.md)|  
