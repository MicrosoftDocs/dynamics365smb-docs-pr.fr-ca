...
| --- | --- |
| Tous les représentants et contacts |Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche** ![Page ou état pour la recherche](media/ui-search/search_small.png "Icône Page ou état pour la recherche"), entrez **Liste des opportunités**, puis sélectionnez le lien associé. |
...
## <a name="close-opportunities"></a>Fermez les opportunités
