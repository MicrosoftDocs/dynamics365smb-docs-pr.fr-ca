...
Les modifications de la valeur inventaire découlant de la vente sont automatiquement rapprochées avec vos livres financiers lorsque vous reportez des transactions article. Pour plus d'informations, voir [Avancé : Rapprochement stock](advanced-inventory-reconciliation.md).
