...
|Code compensation bancaire émetteur|Code compensation bancaire|Compte bancaire|L'identificateur de la banque de l'émetteur en rapport avec le registre des noms de banque utilisé|  
|BIC banque émetteur|Code SWIFT|Compte bancaire|L'identificateur BIC du compte bancaire de l'émetteur|  
|Devise compte bancaire émetteur|Code devise|Compte bancaire|Le code devise du compte bancaire émetteur|  
|N° document|N° document|Ligne journal général|Le numéro de document de la ligne paiement|  
|N° doc. ext. référence|N° doc. ext. référence|Ligne journal général|Le numéro de document externe de la facture ou de la note de crédit sur lequel la ligne paiement est affectée|  
|Code destinataire|N° compte|Ligne journal général|Le numéro de client ou fournisseur qui est spécifié sur la ligne paiement.|  
...
|Référence paiement|Référence paiement|Ligne journal général|La référence de paiement de la ligne paiement|  
...
|Std compensation bancaire destinataire|Code compensation bancaire|Comte bancaire du client/Compte bancaire du fournisseur|L'identificateur du compte bancaire bénéficiaire en rapport avec le registre des noms de banque qui est utilisé|  
|Adresse messagerie destinataire|E-mail |Client/Fournisseur|Adresse électronique du destinataire|  
|Message au destinataire 1|Message au destinataire|Ligne journal général|Le message au destinataire qui est spécifié sur la ligne règlement|  
|Montant|Montant|Ligne journal général|Le montant sur la ligne de paiement|  
|Code devise|Code devise|Ligne journal général|Le code devise sur la ligne paiement.|  
|Date transfert|Date de report|Ligne journal général|Date de report de la ligne paiement|  
|Montant facture|Montant initial|Écriture client/fournisseur|Le montant sur l'écriture à laquelle le paiement est affecté|  
|Date facture|Date du document|Écriture client/fournisseur|La date de facture sur l'écriture à laquelle le paiement est affecté|  
...
|Modèle journal général|Nom modèle journal|Ligne journal général|Le modèle du journal général qui est utilisé pour la ligne paiement|  
|Nom lot de journal général|Nom lot de journal|Ligne journal général|Le nom du lot journal général qui est utilisé pour la ligne paiement|  
