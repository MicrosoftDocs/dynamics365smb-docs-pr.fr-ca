...
|Configurer et personnaliser les articles de service et les groupes de service. Cela implique de définir les compétences requises par un service et les directives dépannage.| [Procédure : créer des articles de service :](service-how-to-create-service-items.md)|  
