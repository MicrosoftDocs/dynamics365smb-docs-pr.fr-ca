...
description: "Décrit comment identifier une recette ou une dépense dans une période autre que la période de report de la transaction en échelonnant automatiquement les recettes et les dépenses selon un calendrier précis."
