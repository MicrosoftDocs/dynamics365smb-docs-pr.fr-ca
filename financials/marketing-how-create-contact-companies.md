...
## <a name="create-a-company-contact-from-a-customer-vendor-or-bank-account"></a>Créer un contact compagnie à partir d'un client, d'un fournisseur ou d'un compte bancaire
