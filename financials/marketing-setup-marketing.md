...
## <a name="automatically-copy-specific-information-from-the-contact-companies-to-the-contact-persons"></a>Copiez automatiquement les informations spécifiques des compagnies contact vers les personnes contact.
...
## <a name="assign-a-number-series-to-contacts-and-opportunities"></a>Affecter une série de numéros aux contacts et aux opportunités
...
## <a name="set-up-email-logging"></a>Configurer la connexion à la messagerie
