...
|Transférez les écritures vers les écritures de coûts avec un traitement en lot.|[Comment transférer les écritures vers les écritures de coûts](finance-how-to-transfer-general-ledger-entries-to-cost-entries.md)|  
