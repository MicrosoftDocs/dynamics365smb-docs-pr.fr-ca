...
---
# <a name="how-to-manage-employee-absence"></a>Procédure : gérer les absences des employés
Pour gérer l'absence d'un salarié, vous devez l'enregistrer dans la fenêtre **Saisie des absences**. Elle peut alors être affichée de différentes façons à des fins d'analyse ou de génération de rapport.

Vous pouvez afficher les absences des employés dans deux fenêtres différentes :
