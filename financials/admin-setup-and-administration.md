...
|Configurer un serveur SMTP pour activer une communication entrante et sortante dans Dynamics 365 for Financials via courriel| [Procédure : configurer l'adresse de courriel manuellement ou à l'aide de la configuration assistée](madeira-how-setup-email.md)|  
...
|Configurer une nouvelle unité fonctionnelle à l'aide de modèles|[Création de compagnies dans [!INCLUDE[d365fin](includes/d365fin_md.md)]](about-new-company.md)|  
