...
7. <span data-ttu-id="e5eb3-120">Pour reporter la facture, sélectionnez l'action **Reporter**.</span><span class="sxs-lookup"><span data-stu-id="e5eb3-120">To post the invoice, choose the **Post** action.</span></span>  
