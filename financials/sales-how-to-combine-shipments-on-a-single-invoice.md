...
6. Pour reporter la facture, sélectionnez l'action **Reporter**.  
...
1. Choisissez l'icône ![Page ou rapport pour la recherche](media/ui-search/search_small.png "icône Page ou rapport pour la recherche"), entrez **Regrouper les livraisons**, puis sélectionnez le lien associé. Le formulaire de demande de traitement en lot s'ouvre.  
...
1. Choisissez l'icône ![Page ou rapport pour la recherche](media/ui-search/search_small.png "icône Page ou rapport pour la recherche"), entrez **Supprimer les documents de vente facturés**, puis sélectionnez le lien associé.  
