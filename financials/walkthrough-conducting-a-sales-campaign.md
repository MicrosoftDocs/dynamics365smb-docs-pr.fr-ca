...
description: "Une promotion désigne tout type d'utilisation impliquant plusieurs contacts. La sélection du public cible de votre promotion représente une étape importante de la configuration. Pour ce faire, dans Finance and Operations, Business edition, créez un segment ou un groupe de contacts à l'aide de filtres."
author: SorenGP
