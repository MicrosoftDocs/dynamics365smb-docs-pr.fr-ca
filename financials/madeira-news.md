...
- Vous pouvez désormais configurer des articles hors inventaire (les articles que vous proposez aux clients, mais que vous ne stockez pas dans l'inventaire). Pour en savoir plus, voir [Utiliser des articles non stockés](inventory-how-work-nonstock-items.md).
...
Vous pouvez ajouter des attributs à vos articles en inventaire qui facilitent la recherche de produits pour vos clients. Pour en savoir plus, voir [Utiliser les attributs d'article](inventory-how-work-item-attributes.md).  
