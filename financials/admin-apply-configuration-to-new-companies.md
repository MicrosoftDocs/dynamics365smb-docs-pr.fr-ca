...
|Charger et importer un package de configuration avec PowerShell.|[Configurer de nouvelles compagnies à l'aide d'une applet de commande](admin-how-to-configure-new-companies-using-a-cmdlet.md)|
