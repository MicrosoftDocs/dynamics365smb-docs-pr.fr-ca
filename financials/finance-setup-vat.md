...
* Configurez une ligne pour les ventes contenant les mêmes informations que pour les achats. Si vous avez déjà configuré des lignes dans la fenêtre Configuration report de taxe pour les achats effectués auprès de pays/régions de l'UE, vous pouvez également utiliser ces lignes pour les ventes.  
