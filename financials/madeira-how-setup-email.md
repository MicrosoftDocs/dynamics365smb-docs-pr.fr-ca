...
---
# <a name="how-to-set-up-email-manually-or-using-the-assisted-setup"></a>Procédure : configurer l'adresse de courriel manuellement ou à l'aide de la configuration assistée
