...
---
# <a name="how-to-work-with-intercompany-documents-and-journals"></a>Procédure : utiliser des documents et journaux intercompagnies
...
2. Sélectionnez **Nouveau** pour créer un document de vente. Pour en savoir plus, voir [Procédure : vendre des produits](sales-how-sell-products.md).  
...
> [!NOTE]
> Si vous effectuez l'étape 4, le document de vente est déplacé vers votre boîte d'envoi intercompagnies, d'où vous pouvez l'envoyer ultérieurement. Pour plus d'informations, voir [Procédure : gérer la boîte de réception et la boîte d'envoi intersociétés](intercompany-how-manage-intercompany-inbox.md).
