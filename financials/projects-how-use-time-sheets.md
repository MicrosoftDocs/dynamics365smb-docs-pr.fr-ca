...
2. Ouvrez une feuille de temps à partir de la liste.  
    ...
    **Remarque** : Vous ne pouvez rouvrir que les lignes dont le statut est **Approuvé**. Vous ne pouvez pas rouvrir les lignes dont le statut est **Rejeté**. Vous ne pouvez pas rouvrir une feuille de temps qui a été reportée.  
