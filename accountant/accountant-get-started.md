...
## <a name="accountant-hub"></a>Portail Comptable
Vous pouvez accéder à [!INCLUDE[d365acc_long](includes/d365acc_md.md)] en vous connectant à partir de [Dynamics 365 — Portail Comptable sur Microsoft.com](https://www.microsoft.com/en-us/dynamics365/financial-insights-for-accountants).  
...
Une compagnie qui utilise [!INCLUDE[d365fin](includes/d365fin_md.md)] peut vous inviter dans [!INCLUDE[d365fin](includes/d365fin_md.md)] comme comptable externe en utilisant un assistant. En outre, il est préférable que vous saisissiez l'adresse électronique que vous prévoyez d'utiliser pour votre travail de comptabilité (de cette manière, vous pouvez choisir si vous souhaitez utiliser *me@accountant.com* ou *me@client.com*)  
