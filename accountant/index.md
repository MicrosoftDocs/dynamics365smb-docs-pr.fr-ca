...
Vous pouvez accéder à [!INCLUDE [d365acc](includes/d365acc_md.md)] en vous connectant à partir de [Dynamics 365 — Portail Comptable sur Microsoft.com](https://www.microsoft.com/en-us/dynamics365/financial-insights-for-accountants). Il est gratuit, et il est rapide de démarrer et d'ajouter vos clients au tableau de bord. Pour plus d'informations, consultez [Prise en main de Accountant Hub](get-started.md).  
