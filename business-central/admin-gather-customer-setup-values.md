...
description: Si vous souhaitez utiliser RapidStart Services, le questionnaire de configuration permet de réduire la mise en œuvre en rationalisant la création de nouvelles compagnies et en proposant aux clients un fichier Excel ou XML.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
Lorsque le client remplit le questionnaire, vous importez le fichier dans la nouvelle compagnie [!INCLUDE[prod_short](includes/prod_short.md)] du client. Votre client et vous-même devez valider les réponses au questionnaire avant de les appliquer à la compagnie.
...
* Questions that are closed ended, meaning that the customer must choose an answer, and can choose only one. -->
 ...
 Vous pouvez créer des questionnaires uniquement pour les tables de type configuration. Par exemple, vous pouvez utiliser cet outil pour entrer des informations dans les pages suivantes :  
