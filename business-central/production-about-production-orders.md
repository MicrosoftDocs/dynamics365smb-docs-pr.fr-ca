...
## <a name="production-order-creation" />Création des bons de production
...
## <a name="limitations-on-production-order-creation" />Limitations de la création de bons de production
...
## <a name="production-order-status" />État du bon de production
...
### <a name="simulated-production-order" />Bon de production simulé
...
### <a name="planned-production-order" />Ordre de production planifié
...
### <a name="firm-planned-production-order" />Bon de production planifié ferme
...
### <a name="released-production-order" />Ordre de production envoyé
...
### <a name="finished-production-order" />Bon de production achevé
...
## <a name="production-order-execution" />Exécution d'un bon de production
...
### <a name="posting-consumption-and-output" />Report de la consommation et de la production
...
### <a name="production-journal" />Journal de production
