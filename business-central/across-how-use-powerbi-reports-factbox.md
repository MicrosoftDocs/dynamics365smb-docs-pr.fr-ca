...
ms.author: jswymer
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-includeprodshortincludesprodshortmd" />Création de rapports Power BI pour afficher les données de liste dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="set-the-report-size-and-color" />Définissez la taille et la couleur du rapport
...
## <a name="reports-with-multiple-pages" />Rapports avec plusieurs pages
...
### <a name="you-cant-see-the-report-in-the-select-report-pane" />Vous ne pouvez pas voir le rapport dans le volet Sélectionner un rapport
...
### <a name="report-is-loaded-but-blank-not-filtered-or-filtered-incorrectly" />Le rapport est chargé, mais vide, non filtré ou filtré incorrectement
...
### <a name="report-is-loaded-but-it-shows-a-page-you-didnt-expect" />Le rapport est chargé, mais il affiche une page à laquelle vous ne vous attendiez pas.

Vérifiez que la page que vous souhaitez afficher est la première page de votre rapport.  

### <a name="report-appears-with-an-unwanted-gray-boarder-or-its-too-small-or-too-large" />L rapport apparaît avec des bordures grises non désirées, il est trop petit ou trop grand.
