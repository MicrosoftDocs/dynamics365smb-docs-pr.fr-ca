...
### <a name="when-i-get-data-from-business-central-to-use-in-my-power-bi-reports-i-see-some-values-like-_x0020_-what-are-these-values" />Lorsque je reçois des données de Business Central à utiliser dans mes rapports Power BI, je vois des valeurs comme « _x0020_ ». Quelles sont ces valeurs ?
