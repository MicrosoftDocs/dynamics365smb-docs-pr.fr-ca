...
Vous devez ajouter votre compte d'utilisateur administrateur pour [!INCLUDE[prod_short](includes/prod_short.md)] en tant qu'utilisateur dans [!INCLUDE[prod_short](includes/cds_long_md.md)]. Lorsque vous configurez la connexion entre [!INCLUDE[prod_short](includes/prod_short.md)] et [!INCLUDE[prod_short](includes/cds_long_md.md)], nous utilisons ce compte une fois pour installer et configurer certaines composantes requises. 
