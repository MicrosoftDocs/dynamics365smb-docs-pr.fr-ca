...
## <a name="setting-up-accounts-for-salespeople"></a>Configuration des comptes pour les représentants
Vous devez créer des comptes d'utilisateur dans [!INCLUDE[crm_md](includes/crm_md.md)] pour les représentants depuis [!INCLUDE[d365fin](includes/d365fin_md.md)]. Pour simplifier les choses, le Centre d'administration Microsoft 365 propose un modèle Excel à utiliser. Sur la page **Utilisateurs actifs**, sélectionnez **Plus**, puis **Importer plusieurs utilisateurs**. Sélectionnez **Télécharger un fichier CSV avec des en-têtes uniquement**, puis saisissez les informations pour les représentants. En guise d'exemple, sélectionnez **Télécharger un fichier CSV avec des en-têtes et des exemples d'informations d'utilisateur**. Après la saisie des informations concernant les utilisateurs, la prochaine étape du processus d'importation consiste à attribuer les licences d'utilisateur au plan Dynamics 365 Customer Engagement.  

Après l'importation des utilisateurs et l'attribution de licences pour Dynamics 365 Customer Engagement, vous devez affecter les utilisateurs au rôle **Représentant** dans [!INCLUDE[crm_md](includes/crm_md.md)].
...
|Configuration du report|Global|||Écrire|
...
|Report|Global|||Créer, Lire, Ajouter à|
...
Vous pouvez permettre aux commerciaux de visualiser les niveaux d'inventaire des articles vendus en leur accordant les autorisations décrites dans le tableau suivant.
