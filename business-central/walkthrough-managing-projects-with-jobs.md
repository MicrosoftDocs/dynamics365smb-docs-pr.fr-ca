...
### <a name="setting-up-a-project"></a>Configuration d'un projet
...
### <a name="to-create-a-project-journal-batch"></a>Pour créer un lot journal projet
...
## <a name="setting-up-a-project-1"></a>Configuration d'un projet
...
## <a name="copying-projects"></a>Copie de projets
