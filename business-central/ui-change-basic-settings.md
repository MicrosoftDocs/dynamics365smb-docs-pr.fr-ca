...
Le nom de la compagnie est toujours affiché dans le coin supérieur gauche. Cela fonctionne comme une action que vous pouvez choisir pour revenir au centre de rôles. Vous pouvez changer ce nom sur la page **Informations compagnie**.
