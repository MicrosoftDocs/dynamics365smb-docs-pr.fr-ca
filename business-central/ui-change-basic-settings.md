...
> [!TIP]  
>   Pour afficher un nom différent pour votre compagnie dans l'application (par exemple sur la page d'accueil Tableau de bord), définissez le champ **Nom** sur la page **Informations compagnie** ou le champ **Nom d'affichage** sur la page **Compagnies**.  
