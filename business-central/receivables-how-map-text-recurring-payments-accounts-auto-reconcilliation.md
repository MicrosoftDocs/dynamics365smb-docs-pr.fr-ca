...
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation"></a>Mapper le texte des paiements récurrents sur les comptes pour un rapprochement automatique
...
## <a name="example-text-to-account-mapping-for-bank-fees"></a>Exemple : Text-to-Account mappage pour les frais bancaires
