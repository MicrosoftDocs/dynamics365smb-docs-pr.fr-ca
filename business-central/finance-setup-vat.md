...
3. Une fois la configuration assistée terminée, visitez la page **Configuration report TVA** et vérifiez si vous devez renseigner d'autres champs en fonction des exigences locales de votre version de [!INCLUDE [prodshort](includes/prodshort.md)]. Pour plus d'informations, voir [Fonctionnalité locale dans Business Central](about-localization.md).  
