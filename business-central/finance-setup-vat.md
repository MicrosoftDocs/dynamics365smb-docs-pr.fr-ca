...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Configurer des méthodes de calcul et de report de la taxe sur la valeur ajoutée
...
### <a name="check-the-vat-posting-setup" />Vérifier la configuration du report TVA
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Limitation des délais de report et de modification de la date de TVA
...
#### <a name="to-limit-posting-based-on-vat-return-period" />Pour limiter le report en fonction de la période de déclaration de TVA
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Pour limiter le report en fonction de la période Autoriser de/à
...
## <a name="set-up-vat-business-posting-groups" />Configurer des groupes de report marché TVA
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Regrouper des groupes de report TVA dans les configurations report de taxe
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Affecter des groupes de report TVA à des comptes, clients, fournisseurs, articles et ressources
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />Pour affecter une clause TVA à une configuration report TVA
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Créer une configuration report TVA pour traiter la TVA à l'importation
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Utiliser des frais inversés TVA pour les échanges entre pays/régions de l’UE
...
## <a name="vat-rounding-for-documents" />Arrondissement TVA pour les documents
