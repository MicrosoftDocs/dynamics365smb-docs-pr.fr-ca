...
Vous configurez la gestion du marketing et des contacts à partir de la fenêtre **Paramètres marketing**. Pour ouvrir la fenêtre **Configuration marketing**, choisissez l'icône ![Ampoule qui ouvre la fonction Tell Me](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Configuration marketing**, puis sélectionnez le lien associé.
