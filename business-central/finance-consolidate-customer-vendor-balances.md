...
## <a name="link-an-existing-customer-and-vendor-company-through-a-contact"></a>Lier une compagnie client et fournisseur existante via un contact
...
1. Créez un client ou un fournisseur. Pour plus d'informations, voir [Enregistrer de nouveaux clients](sales-how-register-new-customers.md).
...
Sur la page **Journal paiement**, utilisez l’action **Soldes client/fournisseur nets** pour consolider les soldes client/fournisseur en un seul montant net. L’action crée, mais ne publie pas, les lignes du journal des paiements qui contiennent les soldes nets.
