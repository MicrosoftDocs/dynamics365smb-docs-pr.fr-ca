...
ms.author: bholtorf
---
# <a name="consolidate-balances-for-a-company-that-is-a-customer-and-a-vendor" />Consolider les soldes d’une compagnie qui est à la fois un client et un fournisseur
...
## <a name="link-an-existing-customer-and-vendor-company-thorough-a-contact" />Lier une compagnie client et fournisseur existante via un contact
...
## <a name="to-consolidate-the-customer-and-vendor-balances-for-a-contact-company" />Pour consolider les soldes client et fournisseur pour une compagnie contact
