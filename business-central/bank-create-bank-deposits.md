...
### <a name="number-series-and-lump-sum-deposits" />séries de numéros et dépôts forfaitaires
...
### <a name="general-journal-templates-for-bank-deposits" />Modèles journal général pour les dépôts bancaires
...
## <a name="finding-posted-bank-deposits" />Recherche de dépôts bancaires reportés
...
## <a name="reversing-a-posted-bank-deposit" />Inversion d’un dépôt bancaire reporté
