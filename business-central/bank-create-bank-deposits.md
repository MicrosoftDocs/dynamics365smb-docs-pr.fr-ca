...
### <a name="number-series-and-lump-sum-deposits"></a><a name="number-series-and-lump-sum-deposits"></a>séries de numéros et dépôts forfaitaires
...
### <a name="general-journal-templates-for-bank-deposits"></a><a name="general-journal-templates-for-bank-deposits"></a>Modèles journal général pour les dépôts bancaires
...
## <a name="finding-posted-bank-deposits"></a><a name="finding-posted-bank-deposits"></a>Recherche de dépôts bancaires reportés
...
## <a name="reversing-a-posted-bank-deposit"></a><a name="reversing-a-posted-bank-deposit"></a>Inversion d’un dépôt bancaire reporté
