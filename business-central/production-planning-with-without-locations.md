...
ms.author: edupont
---
# <a name="planning-with-or-without-locations"></a><a name="planning-with-or-without-locations"></a>Planification avec/sans emplacement
...
## <a name="demand-at-location"></a><a name="demand-at-location"></a>Demande à l'emplacement
...
## <a name="demand-at-blank-location"></a><a name="demand-at-blank-location"></a>Demande dans un « emplacement vide »
...
#### <a name="case-11-demand-is-at-west-location"></a><a name="case-11-demand-is-at-west-location"></a>Situation 1.1 : la demande concerne un emplacement *OUEST*
...
#### <a name="case-12-demand-is-at-east-location"></a><a name="case-12-demand-is-at-east-location"></a>Situation 1.2 : la demande concerne un emplacement *EST*

L'article est planifié en fonction des paramètres de planification de la fiche article.

#### <a name="case-13-demand-is-at-north-location"></a><a name="case-13-demand-is-at-north-location"></a>Situation 1.3 : la demande concerne un emplacement *NORD*
...
#### <a name="case-14-demand-is-at-blank-location"></a><a name="case-14-demand-is-at-blank-location"></a>Situation 1.4 : la demande concerne un emplacement *VIDE*
...
#### <a name="case-21-demand-is-at-west-location"></a><a name="case-21-demand-is-at-west-location"></a>Situation 2.1 : la demande concerne un emplacement *OUEST*

L’article est planifié comme suit : Stratégie réapprovisionnement = *Lot pour Lot* (l’*ordre* conserve la valeur *Ordre*), Inclure inventaire = *Oui*. Tous les autres paramètres de planification ont la valeur Vide.

#### <a name="case-22-demand-is-at-east-location"></a><a name="case-22-demand-is-at-east-location"></a>Situation 2.2 : la demande concerne un emplacement *EST*
...
#### <a name="case-31-demand-is-at-west-location"></a><a name="case-31-demand-is-at-west-location"></a>Situation 3.1 : la demande concerne un emplacement *OUEST*

L’article est planifié comme suit : Stratégie réapprovisionnement = *Lot pour Lot* (l’*ordre* conserve la valeur *Ordre*), Inclure inventaire = *Oui*. Tous les autres paramètres de planification ont la valeur Vide.

#### <a name="case-32-demand-is-at-east-location"></a><a name="case-32-demand-is-at-east-location"></a>Situation 3.2 : la demande concerne un emplacement *EST*

L'article est planifié en fonction des paramètres de planification de la fiche article.  

#### <a name="case-33-demand-is-at-blank-location"></a><a name="case-33-demand-is-at-blank-location"></a>Situation 3.3 : la demande concerne un emplacement *VIDE*
...
#### <a name="case-41-demand-is-at-east-location"></a><a name="case-41-demand-is-at-east-location"></a>Situation 4.1 : la demande concerne un emplacement *EST*

L’article est planifié comme suit : Stratégie réapprovisionnement = *Lot pour Lot* (l’*ordre* conserve la valeur *Ordre*), Inclure inventaire = *Oui*. Tous les autres paramètres de planification ont la valeur Vide.

#### <a name="case-42-demand-is-at-blank-location"></a><a name="case-42-demand-is-at-blank-location"></a>Situation 4.2 : la demande concerne un emplacement *VIDE*
