...
ms.author: edupont
---
# <a name="planning-with-or-without-locations" />Planification avec/sans emplacement
...
## <a name="demand-at-location" />Demande à l'emplacement
...
## <a name="demand-at-blank-location" />Demande dans un « emplacement vide »
