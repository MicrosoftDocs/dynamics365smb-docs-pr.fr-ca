...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Pour créer des notes de crédit service contrat
...
6. Sur les lignes note de crédit, entrez les informations relatives aux articles retournés ou retirés, ou à la réduction qui est envoyée. Vous pouvez également utiliser le traitement en lot **Obtenir écr. contrat prépayé**.  
 ...
 Pour créer automatiquement une note de crédit lorsque les lignes du contrat sont retirées d'un contrat de service, sur la page **Contrat de Service**, sur le raccourci **Détails de la facture**, sélectionnez la case à cocher **Notes de crédit automatiques**.  

 Pour créer manuellement une note de crédit lorsque les lignes du contrat sont retirées d'un contrat de service, sur la page **Contrat de Service**, choisissez l'action **Note de crédit**.  
...
>   
>  Si le contrat est détaillé et prépayé, et que vous avez reporté des factures pour le contrat, vous pouvez créer une note de crédit pour ce contrat. Choisissez l'action **Créer note de crédit**. Cela n'est pas nécessaire si la case à cocher **Avoirs automatiques** sur le raccourci **Détails facture** est sélectionnée. Dans ce cas une note de crédit est créée automatiquement lorsque vous supprimez une ligne contrat.
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Pour ajouter un escompte contrat pour des devis contrats de service
...
> [!Tip]  
>  Pour ajouter des escomptes contrat directement à un contrat service, exécutez la procédure décrite sur la page **Contrat de service**.  
...
7. Cliquez sur le bouton **OK** pour modifier le client et le code de livraison des contrats de service.  
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Pour reporter des écritures contrat prépayé
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Modification de l'état d'un contrat de service
...
4. Dans le champ **Code motif annulation**, choisissez le code motif adéquat. Pour ajouter des codes motif, cliquez sur l'action **Avancé**.  
     ...
     Si le champ **Utiliser motif annulation contrat** est coché sur la page **Configuration de la gestion des services**, vous devez indiquer un code motif annulation lorsque vous annulez des contrats.  
