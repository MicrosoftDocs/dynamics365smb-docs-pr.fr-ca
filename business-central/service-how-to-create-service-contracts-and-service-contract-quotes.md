...
## <a name="to-create-contract-service-credit-memos" />Pour créer des notes de crédit service contrat
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Pour ajouter un escompte contrat pour des devis contrats de service
...
## <a name="to-post-prepaid-contract-entries" />Pour reporter des écritures contrat prépayé
...
## <a name="changing-the-service-contract-status" />Modification de l'état d'un contrat de service
