...
4. Dans le champ **N° client**, entrez le numéro du client du contrat de service.  
    ...
    > [!NOTE]  
    >  Vous pouvez comparer l'avoir avec le document validé initialement dans la fenêtre **Factures service enreg.**. Choisissez l'icône ![Ampoule qui ouvre la fonction Tell Me](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Factures service reportées**, puis sélectionnez le lien associé.  
