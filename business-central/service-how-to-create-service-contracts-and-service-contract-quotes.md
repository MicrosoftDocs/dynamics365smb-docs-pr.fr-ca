...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Pour créer des notes de crédit service contrat
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Pour ajouter un escompte contrat pour des devis contrats de service
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Pour reporter des écritures contrat prépayé
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Modification de l'état d'un contrat de service
