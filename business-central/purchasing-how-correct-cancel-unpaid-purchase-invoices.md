...
## <a name="to-correct-a-posted-purchase-invoice" />Pour corriger une facture achat reportée
...
## <a name="to-cancel-a-posted-purchase-invoice" />Pour annuler une facture achat reportée
...
### <a name="partial-invoice-posting-also-supported" />Report de facture partiel également pris en charge
