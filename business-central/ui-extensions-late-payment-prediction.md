...
L'extension Prévision de retard de paiement contient un modèle prédictif formé à l'aide de données représentant un éventail de PME. Lorsque vous commencez à reporter des factures et à recevoir des paiements, [!INCLUDE[prod_short](includes/prod_short.md)] évalue si le modèle standard correspond à votre flux d’activité. 
