...
> [!TIP]
> Vous pouvez également rapprocher des comptes bancaires sur la page **Journal rapprochement paiement** lorsque vous traitez les paiements. Les écritures de compte bancaire ouvertes associées aux écritures client ou fournisseur affectées sont fermées lorsque vous sélectionnez l’action **Reporter les paiements et rapprocher les comptes bancaires**. Cela rapproche automatiquement le compte bancaire pour les paiements que vous reportez avec le journal. Pour plus d'informations, reportez-vous à [Lettrage automatique des paiements et rapprochement des comptes bancaires](receivables-apply-payments-auto-reconcile-bank-accounts.md).
...
3. Cliquez sur le bouton **OK**.
    ...
    Toutes les lignes de relevé bancaire et les écritures de compte bancaire qui peuvent être rapprochées deviennent vertes, et la case **Affecté** est cochée.
