...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Effet des modes évaluation coût sur l'évaluation des augmentations d'inventaire
...
### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Effet des modes évaluation coût sur l'évaluation des diminutions d'inventaire
