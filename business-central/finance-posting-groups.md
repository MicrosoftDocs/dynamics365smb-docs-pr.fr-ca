...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Configuration des groupes de report
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a><a name="general-posting-groups"></a>Groupes de report généraux
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Groupes de report spécifiques
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Groupes de report TVA
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Copie de lignes configuration report
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Configurer des groupes de report en déplacement
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Résolution des erreurs de groupe de report
