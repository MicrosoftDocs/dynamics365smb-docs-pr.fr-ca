...
### <a name="allow-substitute-customer-or-vendor-posting-groups-on-documents"></a>Autorisation de groupes de report client ou fournisseur de remplacement sur les documents
...
## <a name="copy-posting-setup-lines"></a>Copie de lignes configuration report
