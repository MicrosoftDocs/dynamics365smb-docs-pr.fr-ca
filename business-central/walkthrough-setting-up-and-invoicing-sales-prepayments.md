...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Procédure pas à pas : configuration et facturation de paiements anticipés vente
...
### <a name="to-set-up-number-series-for-prepayments" />Pour configurer des séries de numéros pour les paiements anticipés
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Pour bloquer les livraisons pour un paiement anticipé impayé
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Pour affecter des pourcentages de paiement anticipé par défaut aux clients et aux articles
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Pour spécifier un compte pour les paiements anticipés vente dans la configuration de report générale
...
## <a name="create-an-order-that-requires-a-prepayment" />Création d’une commande nécessitant un paiement anticipé
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Pour créer un document de vente avec paiement anticipé
...
## <a name="create-a-prepayment-invoice" />Créer une facture paiement anticipé
...
### <a name="to-create-a-prepayment-invoice" />Pour créer une facture paiement anticipé
...
## <a name="create-an-additional-prepayment-invoice" />Créer une facture paiement anticipé supplémentaire
...
### <a name="to-create-an-additional-prepayment-invoice" />Pour créer une facture paiement anticipé supplémentaire
...
## <a name="apply-the-prepayments" />Affecter les paiements anticipés
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Pour affecter un paiement aux factures paiement anticipé
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically" />Mettre à jour automatiquement l'état des commandes prépayées et des factures
