---
title: Configurer et facturer des paiements anticipés vente
...
---
# Procédure pas à pas : Configurer et facturer des paiements anticipés vente
...
### Pour configurer des séries de numéros pour les paiements anticipés
...
3. Vérifiez que la série de numéros des factures paiement anticipé reportées dans le champ **N° factures paiement anticipé reportées** est identique à celle des factures vente reportées (**N° facture reportée**) et que la série de numéros des notes de crédit pour paiement anticipé reporté (**N° notes de crédit pour paiement anticipé reportées**) est identique à celle des notes de crédit reportées (**N° note de crédit reportée**).  

### Pour bloquer les livraisons pour un paiement anticipé impayé
...
### Pour spécifier un compte pour les paiements anticipés vente dans la configuration de report générale
...
### Pour créer un document de vente avec paiement anticipé
...
## Créer une facture paiement anticipé
...
2. Sur la ligne de l’article **1896-S**, dans le champ **Quantité**, entrez **2**.  
    ...
    Dans l’action **Ordre**, choisissez **Statistiques**. Le champ **Montant paiement anticipé HT** affiche à présent **768,04** et le champ **Montant fact. paiement anticipé HT** indique **417,76**. Ces valeurs indiquent qu’il existe un montant de paiement anticipé supplémentaire qui n’a pas encore été facturé.  
...
## Affecter les paiements anticipés
...
### Pour affecter un paiement aux factures paiement anticipé
