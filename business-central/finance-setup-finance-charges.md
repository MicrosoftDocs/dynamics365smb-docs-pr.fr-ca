...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Configurer les modalités de frais financiers
...
## <a name="finance-charge-terms" />Modalités de frais financiers
...
### <a name="to-set-up-finance-charge-terms" />Pour configurer des modalités de frais financiers
