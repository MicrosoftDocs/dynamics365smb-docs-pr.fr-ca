...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Configuration de la fonction arrondissement facture
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Configurer des comptes GL afin d'autoriser les différences d'arrondissement dans les factures
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Pour configurer des comptes du grand livre afin d'autoriser les différences d'arrondissement dans les factures
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Configuration de règles d'arrondissement pour les devises étrangères et locales
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Pour configurer les règles d'arrondissement pour les devises étrangères
...
### <a name="to-set-up-rounding-for-your-local-currency" />Pour configurer les règles d'arrondissement pour les devises locales
...
## <a name="activate-the-invoice-rounding-function" />Activer la fonction d'arrondissement de factures
