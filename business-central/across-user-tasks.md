...
---
# <a name="defining-user-tasks"></a>Définition de tâches utilisateur
...
Par exemple, vous pouvez créer une tâche pour vous-même, pour afficher toutes les factures vente reportées. Dans ce cas, vous liez la tâche à la page 143, Factures vente reportées.  

![Exemple d'une tâche d'utilisateur](media/across-user-tasks/sample-user-task.png "Exemple d'une tâche d'utilisateur")

> [!TIP]  
>  Utilisez la recherche dans le champ **Page**, puis utilisez le champ **Page ou rapport pour la recherche** pour trouver la page que vous souhaitez. Pour plus d'informations, voir [Recherche d'une page ou d'un rapport](ui-search.md).  
