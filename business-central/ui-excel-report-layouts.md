...
#### <a name="approach--export-the-layout-from-the-report-layouts-page" />Approche 1 : Exporter la présentation à partir de la page **Présentations de rapport**
...
#### <a name="approach--download-the-layout-from-the-reports-request-page" />Approche 2 : Téléchargez la présentation à partir de la page de demande du rapport
...
## <a name="task--add-the-excel-layout-to-the-report" />Tâche 2: Ajouter la présentation Excel au rapport
