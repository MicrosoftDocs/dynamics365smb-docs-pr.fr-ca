...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-" />Utiliser les rapports Power BI dans [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="upload-reports" /><a name="upload"></a>Télécharger des rapports
