...
En plus de configurer vos contacts, vous devez configurer les rapport établis avec vos contacts, tels que les clients potentiels, les banques, les consultants et les prestataires de services. Pour plus d'informations, voir [Configuration des relations d'affaires sur des compagnies contact](marketing-business-relations.md).

## <a name="setting-up-industry-groups-for-contact-companies"></a>Configuration des secteurs d'activité pour des compagnies contact
...
## <a name="setting-up-web-sources-for-contact-companies"></a>Configuration de sources Web pour des compagnies contact
