...
> [!NOTE]
> Cela s'applique uniquement aux contacts de type **Compagnie**.
...
2. Sélectionnez l'action **Compagnie**, puis l'action **Secteurs d'activité**. La page **Secteurs d'activité contact** s'affiche.
...
Vous pouvez utiliser des sources Web avec vos compagnies contact afin d'identifier, par exemple, des moteurs de recherche et des sites Web que vous souhaitez utiliser pour rechercher des informations relatives aux contacts. Lorsque vous affectez des sources Web, vous spécifiez le moteur de recherche et les mots recherchés que l'application utilisera pour rechercher les informations demandées.

> [!NOTE]
> Cela s'applique uniquement aux contacts de type **Compagnie**.

Lorsque vous affectez des sources Web, vous spécifiez le moteur de recherche et les mots recherchés que l'application utilisera pour trouver les informations demandées.

1. Ouvrez la fiche contact appropriée.
2. Sélectionnez l'action **Compagnie**, puis l'action **Sources Web**. La page **Recherche contact Web** s'affiche.
...
1. Ouvrez la fiche contact appropriée.
2. Sélectionnez l'action **Compagnie**, puis l'action **Relations d'affaires**.
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a><a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a>Copie automatique des informations spécifiques des compagnies contact vers les personnes contact
Une partie des données relatives aux compagnies contact sont identiques aux données sur les personnes contact qui travaillent dans ces compagnies, comme l'adresse. Sur le raccourci **Héritage** de la page **Configuration marketing**, vous pouvez définir les champs de la fiche contact d'une compagnie à copier vers la fiche contact d'une personne chaque fois que vous créez une personne contact pour la compagnie contact.

Lorsque vous modifiez l'un des champs dans la fiche compagnie contact, les mêmes champs de la fiche personne contact sont mis à jour, sauf si vous avez modifié ce champ manuellement.
