...
ms.author: edupont
---
# <a name="setup-best-practices-supply-planning"></a><a name="setup-best-practices-supply-planning"></a>Pratiques de configuration recommandées : planification de l'approvisionnement
