...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Supprimer et affecter à nouveau des écritures article
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Pour supprimer une affectation article en utilisant le journal affectation
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Pour affecter à nouveau une affectation article en utilisant le journal affectation
