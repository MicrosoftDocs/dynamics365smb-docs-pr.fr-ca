...
## <a name="to-record-inventory-picks"></a>Pour enregistrer les prélèvements inventaire
...
## <a name="handling-assemble-to-order-items-with-inventory-picks"></a>Traitement des articles à assembler pour commande dans les prélèvements inventaire
