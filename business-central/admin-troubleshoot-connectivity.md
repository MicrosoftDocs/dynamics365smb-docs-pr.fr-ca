...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Résoudre les problèmes de connectivité pour Business Central
...
## <a name="start-the-connectivity-check" />Lancer le contrôle de connectivité
...
## <a name="basic-internet-connectivity" />Connectivité Internet principale
...
## <a name="cdn-content-delivery-network-resources-loading" />Chargement des ressources CDN (réseau de diffusion de contenu)
...
## <a name="user-authentication" />Authentification de l’utilisateur
...
## <a name="business-central-environments-discovery" />Découverte des environnements Business Central
...
## <a name="application-service-connectivity" />Connectivité des services d’application
...
## <a name="web-server-connectivity" />Connectivité du serveur web
...
## <a name="service-health-status" />État d’intégrité du service
