...
Un rôle est affecté à tous les employés de votre compagnie ayant accès à [!INCLUDE[d365fin](includes/d365fin_md.md)], qui leur permet d'accéder à un *Tableau de bord*.
