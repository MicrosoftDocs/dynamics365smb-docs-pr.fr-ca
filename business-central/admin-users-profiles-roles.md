...
1. Choisissez l'icône ![Page ou rapport pour la recherche](media/ui-search/search_small.png "Icône Page ou rapport pour la recherche"), entrez **Profils (Rôles)**, puis sélectionnez le lien associé.  
...
2. Renseignez les champs **Code profil** et **Nom d'affichage**, puis cliquez sur le bouton **OK**.
...
3. Dans le champ **Code profil**, sélectionnez le profil approprié.
