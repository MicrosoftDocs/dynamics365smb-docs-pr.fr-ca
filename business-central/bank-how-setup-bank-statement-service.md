...
> [!NOTE]  
> Si vous utilisez la configuration assistée Configurer la compagnie, certaines étapes des procédures suivantes s'effectuent automatiquement lorsque vous accédez à la configuration de compte bancaire de la compagnie. Pour plus d'informations, reportez-vous à [Mise en route](product-get-started.md).
