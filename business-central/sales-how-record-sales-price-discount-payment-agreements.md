...
# <a name="record-special-sales-prices-and-discounts" />Enregistrer les prix de vente spéciaux et les escomptes
...
## <a name="sales-invoice-discounts-and-service-charges" />Escomptes facture vente et frais forfaitaires
...
### <a name="calculating-invoice-discounts-on-sales" />Calcul d’escomptes facture pour des ventes
