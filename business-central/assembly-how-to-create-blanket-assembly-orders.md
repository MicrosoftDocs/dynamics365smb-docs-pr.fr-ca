...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Pour créer un ordre d'assemblage permanent pour un article à assembler pour commande
