...
## <a name="transferring-general-ledger-entries-to-cost-entries"></a>Transfert des écritures GL vers les écritures de coûts
...
1.  Choisissez l'icône ![Ampoule qui ouvre la fonction Tell Me](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Configuration de la comptabilité analytique**, puis sélectionnez le lien associé.  
