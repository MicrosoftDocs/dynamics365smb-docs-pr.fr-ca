...
2. Définir des zones pour l’article afin de contrôler l’endroit où il est rangé 
    ...
    |Article|Code d'emplacement|Code de zone|Corrigé|Unité de mesure|
    |----------|----------|---------|---|------|  
...
5. Enregistrer le rangement entrepôt
    ...
    - Une ligne de placement qui déplace un autre SAC dans d'autres zones fixes (W-05-0002). En effet, une zone fixe unique ne peut pas contenir la quantité totale de réception.
...
6. Définir des zones de prélèvement pour l’article pour contrôler l’emplacement où il est prélevé 
