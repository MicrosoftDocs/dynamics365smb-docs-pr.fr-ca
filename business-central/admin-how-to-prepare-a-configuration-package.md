...
1. Activez la case à cocher **Table promue** pour indiquer une table qui est souvent utilisée lors du processus de configuration par un client typique, par exemple, la table **Compte du grand livre**. Lorsqu’une table a cette désignation, un client pourra facilement filtrer sa feuille pour afficher uniquement la liste des tables promues qui nécessitent une attention particulière.  
...
> [!NOTE]  
>  Vous pouvez également créer un colis directement, puis ajouter des tables au colis. Pour plus d’informations, consultez la section « Pour créer un package configuration ».
