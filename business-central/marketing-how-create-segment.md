...
3. Dans la section **Général**, dans le champ **N°**, saisissez le numéro du segment.
    ...
    Sinon, si vous avez configuré une série de numéros pour les segments sur la page **Configuration marketing**, vous pouvez sélectionner <kbd>Entrée</kbd> pour sélectionner le prochain numéro de segment disponible.
