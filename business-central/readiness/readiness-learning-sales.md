...
| [Programme Fournisseur de solutions en nuage – Vente de solutions en nuage à la demande](/partner-center/csp-overview)  | Le programme CSP (Cloud Solution Provider, Fournisseur de solutions en nuage) vous aide à dépasser votre modèle de revente de licences pour vous impliquer davantage dans les activités de vos clients.   | Site Web      |                       |
