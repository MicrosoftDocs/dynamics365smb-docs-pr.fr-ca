...
ms.reviewer: jswymer
---
# <a name="view-and-edit-in-excel-from-business-central"></a>Affichage et édition dans Excel depuis Business Central
...
### <a name="work-across-environments-and-companies"></a>Travailler dans plusieurs environnements et compagnies

Vous pouvez changer la compagnie en cours d’utilisation. Pour changer de compagnie, sélectionnez l’icône **Options** ![Options de complément Excel.](media/cogwheel.png "Options du module complémentaire Excel") dans le volet Complément Excel, puis sélectionnez la compagnie dans le champ **Compagnie**.  
