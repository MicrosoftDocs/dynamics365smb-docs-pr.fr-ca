...
[!INCLUDE[prod_short](includes/prod_short.md)] vous permet désormais de gérer les interactions commerciales avec vos clients et fournisseurs, directement dans Microsoft Outlook. Avec les compléments Outlook de [!INCLUDE[prod_short](includes/prod_short.md)], vous pouvez afficher des informations financières associées à des clients et des fournisseurs, ainsi que créer et envoyer des documents financiers, comme des devis et des factures.  

## <a name="getting-the-add-in"></a>Obtention du complément
Vous pouvez aisément démarrer avec le complément [!INCLUDE[prod_short](includes/prod_short.md)] pour Outlook. Dans le guide de configuration assistée **Configurer votre boîte de réception professionnelle** dans Outlook, vous pouvez configurer la connexion pour vous-même ou pour votre organisation si votre organisation utilise Microsoft 365. Spécifiez simplement votre nom d’utilisateur et mot de passe Microsoft 365, si vous êtes invité, et dites-nous si vous souhaitez recevoir un exemple de courriel. Les compléments [!INCLUDE[prod_short](includes/prod_short.md)] sont alors automatiquement ajoutés à votre Outlook. Pour plus d'informations, voir [Configuration minimale requise pour Outlook](product-requirements.md#outlook).  

Ensuite, lorsque vous ouvrez Outlook, vous voyez un courriel dans *Admin Dynamics 365 Business Central*. Les nouveaux compléments sont ajoutés au ruban Outlook, et dans le navigateur, les compléments [!INCLUDE[prod_short](includes/prod_short.md)] apparaissent au-dessus ou au dessous du corps du message. Les compléments sont mis à jour régulièrement, et vous êtes informé qu'une nouvelle version est prête dans Outlook.  
...
Si vous travaillez avec plusieurs compagnies [!INCLUDE[prod_short](includes/prod_short.md)], vous pouvez facilement basculer d'une compagnie à l'autre dans Outlook. Dans la barre d'actions du complément, choisissez **Plus d'actions** pour afficher l'option permettant de passer d'une compagnie à l'autre.  

<!--TEMP-->
> [!NOTE]
> Le passage d'une compagnie à l'autre nécessite [!INCLUDE[prod_short](includes/prod_short.md)] 2019 Release Wave 2 ou version ultérieure, comme annoncé dans le [plan de versions](/dynamics365-release-plan/2019wave2/dynamics365-business-central/switch-between-companies-business-inbox-outlook).

Certaines compagnies utilisant Microsoft 365 n’autorisent pas leurs utilisateurs à déployer des compléments. Ainsi vous devez vous assurer que vous disposez d’un abonnement Microsoft 365 comprenant la messagerie et qui vous permet de déployer des compléments. Si vous souhaitez tout de même essayer le complément, vous pouvez [essayer gratuitement Microsoft 365](https://www.microsoft.com/microsoft-365/try).  
...
Une fois les données saisies, vous pouvez reporter le devis. Vous pouvez ensuite l'envoyer par courriel. [!INCLUDE[prod_short](includes/prod_short.md)] génère un fichier .PDF avec le devis et le joint au message électronique que vous rédigez dans le complément.  
...
Le complément Liens de document de [!INCLUDE[prod_short](includes/prod_short.md)] vous permet d'accéder rapidement aux documents mentionnés dans les e-mails. Le complément est disponible pour un courriel si un numéro de document est identifié dans le corps du message. Ouvrir le complément vous permet d'accéder rapidement à ce document.  
