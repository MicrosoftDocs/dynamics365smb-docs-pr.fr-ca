...
Vous pouvez aisément démarrer avec le complément [!INCLUDE[d365fin](includes/d365fin_md.md)] pour Outlook. Dans le guide de configuration assistée **Configurer votre boîte de réception professionnelle** dans Outlook, vous pouvez configurer la connexion pour vous-même ou pour votre organisation si votre organisation utilise Microsoft 365. Spécifiez simplement votre nom d’utilisateur et mot de passe Microsoft 365, si vous êtes invité, et dites-nous si vous souhaitez recevoir un exemple de courriel. Les compléments [!INCLUDE[d365fin](includes/d365fin_md.md)] sont alors automatiquement ajoutés à votre Outlook. Pour plus d'informations, voir [Configuration minimale requise pour Outlook](product-requirements.md#outlook).  

Ensuite, lorsque vous ouvrez Outlook, vous voyez un courriel dans *Admin Dynamics 365 Business Central* . Les nouveaux compléments sont ajoutés au ruban Outlook, et dans le navigateur, les compléments [!INCLUDE[prodshort](includes/prodshort.md)] apparaissent au-dessus ou au dessous du corps du message. Les compléments sont mis à jour régulièrement, et vous êtes informé qu'une nouvelle version est prête dans Outlook.  
...
Si vous travaillez avec plusieurs compagnies [!INCLUDE[prodshort](includes/prodshort.md)], vous pouvez facilement basculer d'une compagnie à l'autre dans Outlook. Dans la barre d'actions du complément, choisissez **Plus d'actions** pour afficher l'option permettant de passer d'une compagnie à l'autre.  

<!--TEMP-->
> [!NOTE]
> Le passage d'une compagnie à l'autre nécessite [!INCLUDE[prodshort](includes/prodshort.md)] 2019 Release Wave 2 ou version ultérieure, comme annoncé dans le [plan de versions](/dynamics365-release-plan/2019wave2/dynamics365-business-central/switch-between-companies-business-inbox-outlook).
