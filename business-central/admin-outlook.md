...
> [!TIP]
> Si vous utilisez le nouvel Outlook dans un navigateur, les compléments [!INCLUDE [prodshort](includes/prodshort.md)] peuvent être cachés sous **Plus d'actions**.

Si vous travaillez avec plusieurs compagnies [!INCLUDE [prodshort](includes/prodshort.md)], vous pouvez facilement basculer d'une compagnie à l'autre dans Outlook.
