...
## <a name="to-set-up-unrealized-sales-tax"></a><a name="to-set-up-unrealized-sales-tax"></a>Pour configurer la taxe de vente non réalisée
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions"></a><a name="to-set-up-unrealized-tax-for-jurisdictions"></a>Pour configurer la taxe non réalisée pour les juridictions
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a><a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a>Pour configurer des ajustements pour les escomptes de paiement dans un groupe de report de taxe
...
## <a name="to-set-up-maximum-tax-correction-amounts"></a><a name="to-set-up-maximum-tax-correction-amounts"></a>Pour configurer des montants de correction de taxe maximum
