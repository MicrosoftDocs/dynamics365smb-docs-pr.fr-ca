...
## <a name="to-set-up-unrealized-sales-tax" />Pour configurer la taxe de vente non réalisée
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions" />Pour configurer la taxe non réalisée pour les juridictions
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group" />Pour configurer des ajustements pour les escomptes de paiement dans un groupe de report de taxe
...
## <a name="to-set-up-maximum-tax-correction-amounts" />Pour configurer des montants de correction de taxe maximum
