...
## <a name="to-set-up-use-tax-for-a-purchase-order"></a><a name="to-set-up-use-tax-for-a-purchase-order"></a><a name="to-set-up-use-tax-for-a-purchase-order"></a>Pour configurer la taxe de service pour un bon de commande
...
## <a name="to-set-up-use-tax-details"></a><a name="to-set-up-use-tax-details"></a><a name="to-set-up-use-tax-details"></a>Pour configurer les détails de la taxe de service
...
## <a name="to-set-up-purchase-tax-for-a-company"></a><a name="to-set-up-purchase-tax-for-a-company"></a><a name="to-set-up-purchase-tax-for-a-company"></a>Pour configurer la taxe d'achat pour une compagnie
...
## <a name="to-set-up-purchase-tax-for-a-location"></a><a name="to-set-up-purchase-tax-for-a-location"></a><a name="to-set-up-purchase-tax-for-a-location"></a>Pour configurer la taxe d'achat pour un emplacement
...
## <a name="to-set-up-purchase-tax-for-non-recoverable-tax"></a><a name="to-set-up-purchase-tax-for-non-recoverable-tax"></a><a name="to-set-up-purchase-tax-for-non-recoverable-tax"></a>Pour configurer la taxe d'achat pour une taxe non recouvrable
1.  Choisissez l'icône d'![ampoule qui ouvre la fonction Tell Me.](../../../media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") , entrez **Détails fiscaux**, puis sélectionnez le lien associé.  
2.  Sur la page **Détails fiscaux**, sélectionnez l'action **Nouveau**.  
