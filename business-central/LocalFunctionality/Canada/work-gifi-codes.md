...
ms.author: edupont
---
# <a name="work-with-gifi-codes-in-the-canadian-version" />Utiliser les codes IGRF dans la version canadienne
...
## <a name="to-set-up-gifi-codes" />Pour configurer des codes IGRF
...
## <a name="to-associate-gifi-codes-with-gl-accounts" />Pour associer des codes IGRF avec des comptes généraux
...
## <a name="to-view-account-balances-using-the-gifi-code-report" />Pour afficher les soldes de compte à l'aide du rapport de code IGRF
...
## <a name="to-export-balance-information-using-gifi-codes" />Pour exporter les informations de solde à l'aide de codes IGRF
