...
1.  Choisissez l'icône ![Page ou rapport pour la recherche](../../media/ui-search/search_small.png "Icône Page ou rapport pour la recherche"), entrez **Configuration ventes et à recevoir**, puis sélectionnez le lien associé.  
...
4.  Choisissez l'icône ![Page ou rapport pour la recherche](../../media/ui-search/search_small.png "Icône Page ou rapport pour la recherche"), entrez **Configuration achats et à payer**, puis sélectionnez le lien associé.  
