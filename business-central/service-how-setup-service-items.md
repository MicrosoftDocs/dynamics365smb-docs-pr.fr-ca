...
Vous pouvez configurer des tablettes de service qui identifient l'emplacement de stockage de vos articles de service. Vous pouvez affecter des tablettes service à des articles de service dans les fenêtres **Commande service** et **Feuille article de service**.  

1. Choisissez l'icône ![Ampoule qui ouvre la fonction Tell Me](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Tablettes service**, puis sélectionnez le lien associé.
