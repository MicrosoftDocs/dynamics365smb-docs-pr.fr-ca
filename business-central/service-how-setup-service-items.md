...
ms.author: edupont
---
# <a name="set-up-service-items-and-service-item-components" />Configurer les articles de service et les composantes article de service
...
## <a name="to-set-up-a-service-shelf" />Pour configurer une tablette service
