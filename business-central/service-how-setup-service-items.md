...
ms.author: edupont
---
# <a name="set-up-service-items-and-service-item-components"></a><a name="set-up-service-items-and-service-item-components"></a><a name="set-up-service-items-and-service-item-components"></a>Configurer les articles de service et les composantes article de service
...
## <a name="to-set-up-a-service-shelf"></a><a name="to-set-up-a-service-shelf"></a><a name="to-set-up-a-service-shelf"></a>Pour configurer une tablette service
