...
description: 'Pour comprendre comment le stockage et la report d’écriture de dimension sont conçus, il est important de comprendre la structure de tableau.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Pour comprendre comment les écritures dimension sont stockées et reportées, il est important de comprendre la structure de la table.  
...
|N° champ|Nom de champ|Type de données|Commentaires|  
|---------------|----------------|---------------|-------------|  
