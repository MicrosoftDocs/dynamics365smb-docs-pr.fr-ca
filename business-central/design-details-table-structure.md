...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Table 83, Ligne journal article
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Table 349, Valeur de dimension
En plus des autres champs de dimension dans la table, les champs suivants sont importants.  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Tables qui contiennent le champ Code ensemble de dimensions
