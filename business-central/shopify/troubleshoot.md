...
### <a name="the-gen-bus-posting-group-cannot-be-zero-or-empty-there-must-be-a-value-in-the-customer-field"></a>Le champ *Groupe de report marché* ne peut pas être nul ou vide ; il doit y avoir une valeur dans le champ client
