...
- Pensez à activer l'option *Afficher le lien de connexion dans l’en-tête de la boutique en ligne et payer* dans la section **Comptes dans la boutique en ligne et paiement** des paramètres [**Comptes clients**](https://www.shopify.com/admin/settings/customer_accounts) de votre **Admin Shopify**.
