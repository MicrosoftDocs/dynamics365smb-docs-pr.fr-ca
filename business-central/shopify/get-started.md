...
description: Premières étapes lors de une configuration de la connexion entre Business Central et Shopify.
ms.date: 04/30/2024
ms.topic: article
...
1. Localisez l’application [Dynamics 365 Business Central](https://apps.shopify.com/dynamics-365-business-central) sur [AppStore Shopify](https://apps.shopify.com/).
...
4. Dans le champ **URL Shopify**, saisissez l’URL de la boutique en ligne à laquelle vous souhaitez vous connecter. Utilisez le format suivant : `https://{shop}.myshopify.com/`.
   ...
   > [!TIP]
   > Vous pouvez copier l’URL depuis Shopify Admin, comme `https://admin.shopify.com/store/{shop}`, et le connecteur la convertira au format requis.
...
- Assurez-vous de saisir la bonne URL dans le champ **Shopify URL** . Vous pouvez créer l’URL en combinant le code magasin à partir de l’URL d’administrateur. Par exemple, `admin.shopify.com/store/{shop}` et `.myshopify.com` pour obtenir `https://{shop}.myshopify.com/`.
...
- [Synchroniser les articles et l'inventaire](synchronize-items.md)
...
- **Créer automatiquement des documents de vente** pour ne pas créer de documents de vente ni de factures vente.
