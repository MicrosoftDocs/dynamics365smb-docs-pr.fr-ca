...
|L’inventaire est stocké dans| Dépend des magasins Shopify. Si le champ **Par défaut** est activé pour **Services d’exécution Business Central**, l’inventaire est stocké et livré à partir de **Services d’exécution Business Central** ; sinon l’emplacement principal Shopify ou plusieurs emplacements sont utilisés.
| Aucun affichage.|
