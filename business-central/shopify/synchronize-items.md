...
|Codes taxe|**Code groupe fiscal**. Uniquement pertinent pour les taxes de vente. Pour plus d’informations, voir [Configurer les taxes](setup-taxes.md). |Aucun affichage.|
