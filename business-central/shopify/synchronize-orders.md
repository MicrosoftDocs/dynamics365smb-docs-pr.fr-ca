...
# <a name="synchronize-and-fulfill-sales-orders" />Synchroniser et exécuter les documents de vente
...
### <a name="shipment-method-mapping" />Mappage des méthodes de livraison
...
### <a name="location-mapping" />Cartographie des emplacements
...
### <a name="shipping-agents-and-tracking-url" />Agents de livraison et URL de suivi
