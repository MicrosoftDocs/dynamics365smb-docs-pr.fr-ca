...
Si la commande Shopify exige une exécution, le **document de vente** est créé pour les commandes Shopify exécutées. Par exemple, pour celles qui ne contiennent que des cartes cadeaux, la **Facture vente** est créée.
