...
- Fonctionnalités B2B, y compris les compagnies, les listes de prix des compagnies, les modalités de paiement
  - Il est actuellement possible d’importer des commandes créées via B2B. Si plusieurs acheteurs sont liés à la compagnie, vous ne devez pas activer la création automatique de clients, mais lier manuellement chaque acheteur Shopify à un client respectif.
  - Vous devrez conserver les listes de prix de la compagnie dans Shopify.
- Marchés
