...
### <a name="option-2-reconcile-incoming-transfers-to-bank-account-against-interim-account-representing-money-at-the-payment-provider" />Option 2 : rapprocher les virements entrants sur le compte bancaire par rapport au compte provisoire représentant l’argent chez le fournisseur de service de paiement
