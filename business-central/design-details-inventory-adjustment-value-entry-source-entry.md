...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Date de report sur l’écriture valeur d’ajustement par rapport à l’écriture source
