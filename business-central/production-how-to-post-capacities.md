...
ms.author: edupont
---
# <a name="post-capacities" />Reporter des capacités
...
## <a name="to-post-capacities" />Pour reporter les capacités
...
## <a name="to-view-work-center-ledger-entries" />Pour afficher les écritures de l'atelier
