...
2. Dans le champ **Client**, entrez le nom d'un client existant.
    ...
    4. Une nouvelle fiche client affiche des informations sur le modèle client sélectionné. Renseignez les champs restants. Pour plus d'informations, voir [Enregistrer de nouveaux clients](sales-how-register-new-customers.md).  
...
7. Si vous souhaitez accorder un escompte sur la ligne vente, saisissez un pourcentage dans le champ **% escompte ligne**. La valeur du champ **Montant ligne** est mise à jour en conséquence.  
...
9. Dans le champ **Montant d’escompte de la facture**, vous pouvez entrer un montant qui doit être déduit de la valeur indiquée dans le champ **Total TTC**.
