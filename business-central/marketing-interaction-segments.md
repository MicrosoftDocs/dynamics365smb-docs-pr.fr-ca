...
ms.author: jswymer
---
# <a name="manage-interactions-for-segments"></a><a name="manage-interactions-for-segments"></a>Gérer les interactions pour les segments
...
## <a name="segmenting"></a><a name="segmenting"></a>Segmentation
...
## <a name="interactions"></a><a name="interactions"></a>Interactions
...
## <a name="logging"></a><a name="logging"></a>Journalisation
Sur la page **Segment**, lorsque vous cliquez sur **Journaliser**, l'application enregistre les interactions sur la page **Écriture journal interaction** et journalise le segment. Une fois le segment journalisé, il n'apparaît plus que sur la page **Segments journalisés**.
