...
### <a name="look-up-a-business-contact-when-composing-an-email" />Rechercher un contact professionnel lors de la rédaction d’un courriel
...
### <a name="view-and-change-the-contact-details-or-switch-company" />Afficher et modifier les coordonnées ou changer de compagnie
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Afficher un document à partir d’un courriel à l’aide du complément Affichage de document
