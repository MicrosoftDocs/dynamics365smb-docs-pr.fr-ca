...
4. Dans le dossier [!INCLUDE[prod_short](includes/prod_short.md)], il crée un autre dossier portant le même nom que la compagnie dans laquelle vous travaillez. Si vous travaillez dans plusieurs compagnies, un dossier est créé pour la compagnie dans laquelle vous travaillez lorsque vous utilisez les actions **Ouvrir dans OneDrive** et **Partager**. 
