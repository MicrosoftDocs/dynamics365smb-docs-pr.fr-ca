...
description: Découvrez comment enregistrer les transactions avec des compagnies d’autres pays de l’UE à l’aide du système de rapports Intrastat.
author: altotovi
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Utiliser les rapports Intrastat
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Remplir un rapport Intrastat
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Modifier le rapport Intrastat
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Valider les lignes Intrastat
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a><a name="intrastat-rules"></a>Règles Intrastat
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Génération de rapports sur les immobilisations
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>États du rapport Intrastat
