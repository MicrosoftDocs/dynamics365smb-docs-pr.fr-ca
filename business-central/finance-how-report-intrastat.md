...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Utiliser les rapports Intrastat
...
## <a name="fill-in-the-intrastat-report" />Remplir un rapport Intrastat
...
## <a name="modify-the-intrastat-report" />Modifier le rapport Intrastat
...
## <a name="validate-intrastat-lines" />Valider les lignes Intrastat
...
## <a name="intrastat-rules" />Règles Intrastat
...
### <a name="fixed-assets-reporting" />Génération de rapports sur les immobilisations
...
### <a name="intrastat-report-statuses" />États du rapport Intrastat
