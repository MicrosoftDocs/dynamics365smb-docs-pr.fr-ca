...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Détails de conception : report du coût prévu
...
## <a name="prerequisites-for-posting-expected-costs" />Conditions préalables au report des coûts prévus
