...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Détails de conception : comptes du grand livre
...
## <a name="from-the-capacity-ledger" />À partir du grand livre de capacité
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Calcul du montant à reporter dans le grand livre
