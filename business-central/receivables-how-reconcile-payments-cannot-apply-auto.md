...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Rapprocher les paiements qui ne peuvent pas être affectés automatiquement
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Pour rapprocher les paiements qui ne peuvent pas être affectés automatiquement
