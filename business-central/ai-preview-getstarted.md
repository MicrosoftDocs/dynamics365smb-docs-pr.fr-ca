...
- L’autre méthode consiste à utiliser la page **Statut des avis de confidentialité** dans Business Central et à accepter l’intégration **Azure OpenAI** pour tous. utilisateurs. Pour en savoir plus, rendez-vous sur [Consentement aux termes et conditions](enable-ai.md#consent-to-or-reject-preview-and-privacy-terms-and-conditions-for-all-users).
