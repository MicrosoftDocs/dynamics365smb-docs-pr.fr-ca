...
## <a name="create-a-purchase-order-with-non-deductible-vat" />Créer un bon de commande avec TVA non déductible
...
## <a name="adjust-rounded-vat-amounts-before-document-posting" />Ajuster les montants de TVA arrondis avant le report du document
