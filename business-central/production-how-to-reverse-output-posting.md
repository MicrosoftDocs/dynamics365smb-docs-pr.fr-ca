...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Inverser un report de production
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Pour inverser un report de production
