...
# <a name="cash-flow-overview"></a><a name="cash-flow-overview"></a><a name="cash-flow-overview"></a>Aperçu de trésorerie
...
## <a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a>Définition du terme Trésorerie
...
## <a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a>Utilisation de la trésorerie
...
## <a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a>Réalisation d’une prévision de la trésorerie
