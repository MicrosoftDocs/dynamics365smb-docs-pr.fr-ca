...
6.  Sur la page **Chaînage** choisissez l'action **Afficher**.  
     ...
     Le document de vente pour cinq vélos cyclotourisme à livrer au client portant le numéro 10 000 le 05/02/2021 s’affiche.  
...
## <a name="creating-a-net-change-plan"></a>Création d’un planning par écart
 ...
 Le système de planification calcule le meilleur moyen de couvrir la demande de ces deux produits identiques, par exemple consolider certains bons de commande et bons de production, replanifier d’autres commandes et en créer de nouvelles, s’il y a lieu.  
