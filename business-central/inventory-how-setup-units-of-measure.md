...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Configuration d'unités de mesure
...
## <a name="to-set-up-units-of-measure" />Pour configurer des unités de mesure
...
## <a name="to-set-up-multiple-item-units-of-measure" />Pour configurer plusieurs unités de mesure article
...
## <a name="to-set-up-unit-of-measure-translations" />Pour configurer des traductions d'unités de mesure
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Pour entrer un code unité de mesure par défaut pour des transactions de ventes et d'achat
