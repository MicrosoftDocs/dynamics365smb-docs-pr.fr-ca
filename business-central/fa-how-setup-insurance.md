...
## <a name="to-set-up-insurance-journal-templates" />Pour configurer des modèles journal assurance
...
## <a name="to-set-up-insurance-journal-batches" />Pour définir des lots journal assurance
