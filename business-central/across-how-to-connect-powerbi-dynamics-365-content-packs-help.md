...
Il est facile d'obtenir des informations exploitables de vos données Microsoft [!INCLUDE[d365fin_long_md](includes/d365fin_long_md.md)] grâce à Power BI et aux packs de contenu Microsoft [!INCLUDE[d365fin_long_md](includes/d365fin_long_md.md)]. Power BI extrait vos données, puis génère un tableau de bord prêt à l'emploi et des rapports basés sur ces données.
...
[Finances](finance.md)  
[Configuration de la génération de rapports pour [!INCLUDE[d365fin](includes/d365fin_md.md)] dans Power BI](across-how-use-financials-data-source-powerbi.md)  
