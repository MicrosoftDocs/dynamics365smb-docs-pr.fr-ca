...
## <a name="cross-dock-bins-and-zones"></a><a name="cross-dock-bins-and-zones"></a>Zones et zones de transbordement
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a><a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a>Pour afficher des articles transbordés dans une feuille prélèvement ou livraison
