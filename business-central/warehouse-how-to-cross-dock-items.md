...
## <a name="cross-dock-bins-and-zones" />Zones et zones de transbordement
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Pour afficher des articles transbordés dans une feuille prélèvement ou livraison
