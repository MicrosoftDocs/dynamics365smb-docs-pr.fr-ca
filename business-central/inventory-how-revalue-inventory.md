...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a>Réévaluer l'inventaire
Pour réévaluer ou amortir un article ou une écriture article spécifique, vous devez utiliser le journal réévaluation.

## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Pour réévaluer l'inventaire
