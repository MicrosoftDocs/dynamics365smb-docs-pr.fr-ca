...
* Saisissez les informations sur les pages suivantes :
   ...
   * La page **Journal des encaissements** . Pour plus d’informations, voir [Pour remplir et valider un journal des encaissements](#to-fill-and-post-a-cash-receipt-journal).
...
* Grâce à l'action **Définir Code référence** d'une écriture client. Pour plus d’informations, voir [Pour imputer un paiement à une seule écriture comptable client](#to-apply-a-payment-to-a-single-customer-ledger-entry).
...
6. Utilisez le champ **N° doc. externe** pour stocker un identificateur, tel que le numéro de chèque du client.
   ...
   > [!NOTE]
   > Par défaut, le champ N° du document externe est masqué. Si c’est le cas et que vous souhaitez l’utiliser, vous pouvez utiliser la personnalisation pour l’ajouter. Pour plus d’informations, voir [Personnaliser votre espace de travail](ui-personalization-user.md).
...
9. Pour valider la candidature en même temps que vous validez le journal, remplissez les champs suivants :
   ...
   2. Dans le champ **N° compte de contrepartie**, sélectionnez le compte caisse pour les paiements en espèces ou le compte bancaire approprié pour d'autres paiements.
...
5. Cliquez sur le bouton **OK**. La page **Avis de crédit de vente** affiche désormais l’entrée que vous avez sélectionnée dans le **Document applicable. Tapez** et **S’applique au doc. N°** champs. Et le montant de la note de crédit à reporter, escomptes de paiement éventuels déduits.
