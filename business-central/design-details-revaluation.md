...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation" />Déterminer si une sortie d'inventaire est liée à la réévaluation
...
## <a name="wip-inventory-revaluation" />Réévaluation de l'inventaire TEC
