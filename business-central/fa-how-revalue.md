...
## <a name="to-post-other-acquisition-costs"></a>Pour reporter les coûts d'acquisition supplémentaires
...
### <a name="example---posting-other-acquisition-costs"></a>Exemple - Reporter des coûts d'acquisition supplémentaires
