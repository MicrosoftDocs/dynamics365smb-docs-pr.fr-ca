...
Plus les informations de mappage que vous faites dans le journal de rapprochement des paiements sont optimales, plus les transactions sont reportées automatiquement et plus le rapprochement bancaire périodique devient facile.
