...
ms.author: edupont
---
# <a name="setup-best-practices-planning-parameters"></a><a name="setup-best-practices-planning-parameters"></a>Pratiques de configuration recommandées : paramètres de planification
