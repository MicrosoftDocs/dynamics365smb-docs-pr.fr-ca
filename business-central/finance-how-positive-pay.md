---
title: Exporter des fichiers Positive Pay
...
4. Dans le champ  **Date limite de téléchargement**, spécifiez une date avant laquelle les paiements ne sont pas inclus dans le fichier exporté.
