---
title: Modifier les propositions Planification dans une vue graphique
description: Une activité de planification traditionnelle consiste à ajouter ou à modifier les lignes feuille planification pour modifier les commandes d’approvisionnement proposées avant de les valider en exécutant la fonction Traiter message d’action.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
