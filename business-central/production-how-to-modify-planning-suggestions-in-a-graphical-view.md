...
ms.locfileid: "3919223"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="4ec61-104">Modifier les propositions de planification dans une vue graphique</span><span class="sxs-lookup"><span data-stu-id="4ec61-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="4ec61-105">Une activité de planification courante est d'ajouter ou de modifier les lignes feuille planning pour modifier les commandes approvisionnement proposées avant de les valider en exécutant la fonction **Traiter messages d'action** .</span><span class="sxs-lookup"><span data-stu-id="4ec61-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="4ec61-106">Plutôt que d'utiliser la vue planification, vous pouvez utiliser une vue graphique.</span><span class="sxs-lookup"><span data-stu-id="4ec61-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="4ec61-107">Cependant, ceci n'est actuellement pas pris en charge dans [!INCLUDE[prodshort](includes/prodshort.md)].</span><span class="sxs-lookup"><span data-stu-id="4ec61-107">However, this is currently not supported in [!INCLUDE[prodshort](includes/prodshort.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="4ec61-108">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="4ec61-108">See Also</span></span>

[<span data-ttu-id="4ec61-109">Planification</span><span class="sxs-lookup"><span data-stu-id="4ec61-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="4ec61-110">Paramétrage de la production</span><span class="sxs-lookup"><span data-stu-id="4ec61-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="4ec61-111">Production</span><span class="sxs-lookup"><span data-stu-id="4ec61-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="4ec61-112">Stock</span><span class="sxs-lookup"><span data-stu-id="4ec61-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="4ec61-113">Procédure d'achat</span><span class="sxs-lookup"><span data-stu-id="4ec61-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="4ec61-114">Détails de conception : planification de l'approvisionnement</span><span class="sxs-lookup"><span data-stu-id="4ec61-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="4ec61-115">Configurer des recommandations : planification de l'approvisionnement</span><span class="sxs-lookup"><span data-stu-id="4ec61-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="4ec61-116">[Utilisation de [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="4ec61-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>
