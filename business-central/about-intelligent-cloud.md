...
> ![Informations sur le nuage intelligent](media/across-intelligent-cloud/intelligentcloudinsights.png "Affiche la page Informations sur le nuage intelligent dans Business Central")

La page se connecte également à Power BI pour encore plus d'informations.

## <a name="viewing-intelligent-cloud-insights-on-premises"></a>Affichage des informations sur le nuage intelligent localement
