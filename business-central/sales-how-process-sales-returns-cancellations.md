...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Pour créer une note de crédit vente à partir d'une facture vente reportée
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Pour créer une note de crédit vente en copiant une facture vente reportée
