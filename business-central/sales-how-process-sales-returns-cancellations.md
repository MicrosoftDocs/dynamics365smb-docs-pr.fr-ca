...
---
# <a name="process-sales-returns-or-cancellations"></a>Traitement des retours ou annulations de ventes
...
6.  Si une ligne expédition incorrecte a été sélectionnée ou si vous voulez recommencer, supprimez simplement les lignes de la note de crédit, puis exécutez de nouveau la fonction **Extraire lignes réception retour**.  
