---
title: Procédure pour reporter des commandes service
...
4. Sélectionnez l'action **Valider**. Si vous souhaitez imprimer et reporter la note de crédit simultanément, choisissez plutôt l’action **Reporter et imprimer**.  
...
6. Pour reporter simultanément plusieurs notes de crédits service. exécutez le traitement en lot **Reporter en lot les notes crédit service**. Ceci peut être avantageux si vous avez beaucoup de notes de crédit à reporter.  
...
>    * Elle a été reportée dans la zone Projets, ce qui signifie qu’aucune écriture comptable projet n’est liée à cette consommation.  
