...
Pour les rapports et les objets XMLport, vous pouvez définir des filtres comme sur des listes pour délimiter les données à inclure dans le rapport ou le XMLport, mais vous ne pouvez pas trier et rechercher.
