...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Définition de filtres dans les rapports, les traitements en lot et les objets XMLport
