...
3. La valeur des champs **Montant remise ligne**, **remise ligne** et **Marge** est mise à jour par rapport à la nouvelle valeur du champ **Montant ligne** de la manière suivante :   
    * Montant escompte ligne = Valeur ligne - Montant ligne.  
    * % escompte ligne = Montant escompte ligne / Valeur ligne * 100.  
    * Profit = Montant ligne - Coût ligne.  
...
|Article|Ligne Coût|Valeur de ligne|% escompte ligne|Montant escompte ligne|Montant ligne|Bénéfice|  
|----------|---------------|----------------|---------------------|--------------------------|-----------------|------------|  
...
|Article 2|20.00|23.00|Aucun|0.00|55.10|3.00|  
...
|Article 3|24.00|27.00|11.37|3.07|23.93|-0,07|  -   % escompte ligne = Montant escompte ligne / Valeur ligne * 100  
...
### <a name="distribution-based-on-profit"></a>Distribution selon profit
Si vous modifiez le montant annuel du contrat service ou du devis contrat, vous voudrez peut-être répartir la différence entre ses nouveaux montants annuels et ses montants annuels calculés dans les lignes contrat. La distribution basée sur le profit est l'une des méthodes automatiques qui peut vous aider à répartir la différence nouveaux montants annuels et montants calculés entre les montants ligne des lignes contrat. Cette distribution se fera proportionnellement à leurs actions de profit dans le contrat total ou au profit du devis contrat. La liste suivante, qui répertorie les étapes de la procédure de répartition pour chaque ligne contrat, décrit les grands principes de cette méthode :  
