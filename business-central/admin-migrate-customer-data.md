...
description: Vous pouvez migrer les données client existantes d’un système existant vers Business Central à l’aide de RapidStart Services ou tout simplement les saisir directement dans la compagnie.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
