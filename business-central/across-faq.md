...
Un client dérivé de Microsoft Dynamics NAV était installé dans les premières versions de [!INCLUDE[prodshort](includes/prodshort.md)]. À partir de la version 2019 Release Wave 2, ce composante hérité, appelé « client Windows », ne sera plus disponible pour [!INCLUDE[prodshort](includes/prodshort.md)]. Pour plus d'informations, voir [FAQ sur le client Windows et Business Central](/dynamics365/business-central/dev-itpro/faq-win-cli).
