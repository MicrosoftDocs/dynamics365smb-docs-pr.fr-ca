...
[!INCLUDE[prod_short](includes/prod_short.md)] en ligne exige que vous utilisiez une adresse de courriel professionnelle ou scolaire pour votre inscription. [!INCLUDE[prod_short](includes/prod_short.md)] en ligne ne prend pas en charge les adresses de courriel fournies par les services de messagerie publics ni les opérateurs de télécommunications. Cela comprend outlook.com, hotmail.com, gmail.com, et d'autres.  
...
## <a name="what-are-the-service-level-agreements-for-the-cloud"></a>Quels sont les ententes de niveau de service pour le nuage?
