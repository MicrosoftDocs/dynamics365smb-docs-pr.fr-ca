...
## <a name="what-email-address-can-i-use-with-prod_short"></a><a name="email"></a>Quelle adresse de courriel puis-je utiliser avec [!INCLUDE[prod_short](includes/prod_short.md)] ?
