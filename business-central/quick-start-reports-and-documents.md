---
title: Démarrage rapide de la production de rapports et de documents de base
...
# <a name="basic-reports-and-documents-output-quick-start"></a>Démarrage rapide de la production de rapports et de documents de base
...
Une fois l’image affichée dans le champ **Photo**, vous pouvez fermer la page **Informations sur la société** .
