...
## <a name="run-reports" />Exécuter des rapports
...
## <a name="save-reports-as-pdf-excel-or-word-documents" />Enregistrer des rapports sous la forme de documents PDF, Excel ou Word
...
### <a name="change-report-and-document-layouts" />Modifier les présentations de rapport et de document
