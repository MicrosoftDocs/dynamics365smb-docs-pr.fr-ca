...
## De quelle version de Business Central ai-je besoin pour profiter du chat ?
...
## Copilot ne semble jamais ouvrir le dossier ou la page que j’ai demandé. Qu’est-ce que je fais mal ?
...
## Les réponses que je reçois de Copilot varient même si je pose la même question. Est-ce un bug ?

Copilot peut parfois répondre de différentes manières. Les réponses ne sont pas nécessairement identiques.

## Quand dois-je utiliser la fonction Copier sur les messages de chat ?
...
## Copilot trouve-t-il des données dans d’autres compagnies ou environnements?
...
## Le volet de discussion Copilot ne s’affiche pas. Que puis-je faire ?
...
## Copilot renvoie des réponses incorrectes aux totaux et autres calculs
