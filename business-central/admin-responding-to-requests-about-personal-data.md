...
Certains types de données personnelles font partie d’un compte Microsoft 365, et seuls les administrateurs peuvent exporter les données. Le processus de gestion des demandes de sujets de données diffère selon le type d'abonné [!INCLUDE[prod_short](includes/prod_short.md)].
