...
## <a name="to-create-a-sales-order-for-drop-shipment" />Pour créer un document de vente pour des livraisons directes
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />Pour créer le bon de commande pour livraison directe
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Pour créer plusieurs bons de commande pour des livraisons directes
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />Pour afficher le bon de commande associé à partir du document de vente
...
## <a name="to-post-a-drop-shipment" />Pour reporter une livraison directe
