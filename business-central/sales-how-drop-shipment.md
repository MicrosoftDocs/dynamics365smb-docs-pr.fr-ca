...
2. Sur la ligne commande vente pour l'article envoyé, cochez la case **Livraison directe**. Sinon, dans le champ **Code achat**, sélectionnez un code achat dont le champ **Livraison directe** est sélectionné.
