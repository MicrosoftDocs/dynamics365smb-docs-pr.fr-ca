...
---
# <a name="work-with-dimensions" />Utiliser des dimensions
...
## <a name="analyzing-by-dimensions" />Analyse par dimensions
...
## <a name="setting-up-dimensions" />Configuration de dimensions
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts" />Pour configurer des dimensions par défaut pour les clients, les fournisseurs et d'autres comptes
...
### <a name="to-set-up-default-dimension-priorities" />Pour configurer des priorités de dimensions par défaut
...
### <a name="to-set-up-dimension-combinations" />Pour configurer des combinaisons de dimensions
...
### <a name="to-set-up-global-and-shortcut-dimensions" />Pour configurer des dimensions principales et des raccourcis de dimension
...
#### <a name="to-change-global-dimensions" />Pour modifier les dimensions principales
...
### <a name="example-of-dimension-setup" />Exemple de configuration de dimension
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times" />Affichage d’un aperçu des dimensions utilisées plusieurs fois
...
## <a name="use-dimensions" />Utiliser des dimensions
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages" />Pour afficher les dimensions principales dans les pages écriture
