...
description: Utilisez les dimensions pour classer des écritures par catégorie, comme par service ou projet, afin de plus facilement suivre et analyser les données pour vous aider à prendre les bonnes décisions commerciales.
author: edupont04
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
