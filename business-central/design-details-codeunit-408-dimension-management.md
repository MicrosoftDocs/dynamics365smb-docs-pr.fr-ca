...
---
# <a name="design-details-codeunit-408-dimension-management"></a>Détails de conception : Codeunit 408 Gestion des dimensions
Codeunit 408 Gestion des dimensions est une bibliothèque de fonctions qui gère les tâches courantes qui sont liées aux dimensions, tels que copier d'une table à une autre ou d'un document à un autre. Cette rubrique répertorie les fonctions modifiées dans Microsoft Dynamics NAV 2013 R2 et spécifie ce qui doit être effectué sur les fonctions. La plupart des fonctions sont supprimées parce qu'il n'y a pas besoin de copier entre les tables dimension.  

## <a name="modified-functions"></a>Fonctions modifiées  

|Nom de fonction|Description de modification|  
|-------------------|------------------------------|  
|CheckDimSetIDComb|Nouvelle fonction qui remplace les autres fonctions de contrôle et prend un Code d'ensemble de dimensions dans un argument au lieu d'une table dimension.|  
|CheckDimSetIDComb<br /><br /> CheckDocDimComb<br /><br /> CheckServContractDimComb<br /><br /> CheckDimBuffer<br /><br /> CheckDimComb<br /><br /> CheckDimValueComb|Supprimer. L'ensemble de l'utilisation doit être changé en CheckDimSetIDComb.|  
|GetDefaultDim|Modifiez pour renvoyer un Code d'ensemble de dimensions entier au lieu d'un ensemble d'enregistrements.|  
