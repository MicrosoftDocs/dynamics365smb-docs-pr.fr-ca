...
ms.author: edupont
---
# <a name="manage-employee-absence" />Gérer les absences des employés
...
## <a name="to-register-employee-absence" />Pour enregistrer les absences des employés
...
## <a name="to-view-an-individual-employees-absence" />Pour visualiser les absences d'un employé
...
## <a name="to-view-an-employees-absence-by-categories" />Pour afficher les absences d'un employé par catégorie
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Employés**, puis sélectionnez le lien connexe.
...
## <a name="to-view-all-employee-absences-by-category" />Pour afficher toutes les absences des employés par catégorie
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Saisie des absences**, puis sélectionnez le lien connexe.
...
## <a name="to-view-all-employee-absences-by-period" />Pour afficher toutes les absences des employés par période
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Saisie des absences**, puis sélectionnez le lien connexe.
