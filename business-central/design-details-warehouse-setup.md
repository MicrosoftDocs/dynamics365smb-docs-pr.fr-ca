...
## <a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a>Zone et contenu de la zone
...
## <a name="bin-ranking"></a><a name="bin-ranking"></a>Priorité zone
...
## <a name="class"></a><a name="class"></a>Catégorie
