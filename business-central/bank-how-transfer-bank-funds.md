...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Pour reporter un transfert entre comptes bancaires avec le même code devise
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Pour reporter des transferts entre comptes bancaires dotés de codes devise différents
