...
# <a name="define-an-invoice-posting-policy-for-users" />Définir une politique de report des factures pour les utilisateurs
...
## <a name="to-specify-a-posting-policy" />Pour préciser une politique de report
