...
# <a name="define-an-invoice-posting-policy-for-users"></a><a name="define-an-invoice-posting-policy-for-users"></a>Définir une politique de report des factures pour les utilisateurs
...
## <a name="to-specify-a-posting-policy"></a><a name="to-specify-a-posting-policy"></a>Pour préciser une politique de report
