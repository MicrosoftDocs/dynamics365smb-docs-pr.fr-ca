...
> [!Note]
> Généralement, la taille de fichier maximale pour les pièces jointes est de 150 Mo. Cependant, la limite peut être inférieure pour certaines fonctionnalités. 

## <a name="to-attach-a-file-to-a-sales-order"></a>Pour joindre un fichier à un document de vente.
La procédure suivante se base sur un document de vente. Les étapes sont similaires pour tous les autres documents achat et vente et pour toutes les fiches.
