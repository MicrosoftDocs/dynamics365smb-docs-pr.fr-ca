...
ms.author: edupont
---
# <a name="setup-best-practices-global-planning-setup"></a><a name="setup-best-practices-global-planning-setup"></a>Pratiques de configuration recommandées : configuration globale de la planification
