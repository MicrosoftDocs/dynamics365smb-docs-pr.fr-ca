...
# <a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a>Gestion de l’intégration de Microsoft Teams à [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a>Dans Microsoft Teams
...
### <a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a>Gestion de l’application [!INCLUDE [prod_short](includes/prod_short.md)] (facultatif)
...
## <a name="in-"></a><a name="in-"></a>Dans [!INCLUDE [prod_short](includes/prod_short.md)]

### <a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a>Configuration minimale requise
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a>Installation de l’application Business Central à l’aide du déploiement centralisé
...
## <a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a>Gestion de la confidentialité et de la conformité
...
### <a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a>Comprendre où les fiches [!INCLUDE [prod_short](includes/prod_short.md)] sont stockées
...
### <a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a>Restriction du partage des fiches
...
### <a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a>Répondre aux demandes de données
...
## <a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a>Afficher ou masquer les données d’enregistrement sur les fiches
