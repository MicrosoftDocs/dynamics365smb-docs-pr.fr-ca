...
---
# <a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a>Utiliser des files d'attente des travaux pour programmer des tâches
...
## <a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a>Surveiller l’état ou les erreurs dans la file d’attente des travaux
...
### <a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a>Pour visualiser l'état de tous les travaux
...
## <a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a>Afficher les tâches programmées
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a>Exemples de ce que vous pouvez programmer à l’aide des écritures de la file d’attente des travaux

### <a name="schedule-reports"></a><a name="schedule-reports"></a><a name="schedule-reports"></a>Programmer des rapports
...
### <a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a>Programmer la synchronisation entre [!INCLUDE[prod_short](includes/prod_short.md)] et [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a>Programmer le moment de report des commande vente et des bons de commande
