...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Procédure pas à pas : Mise en place d’une promotion de vente
...
## <a name="setting-up-a-campaign" />Configuration d'une promotion
...
### <a name="to-set-up-a-campaign" />Pour configurer une promotion
...
## <a name="linking-a-segment-to-a-campaign" />Association d'un segment à une promotion
...
### <a name="to-link-a-segment-to-the-campaign" />Pour associer un segment à une promotion
...
## <a name="sending-letters-and-email-messages-to-contacts" />Envoi de lettres et de courriels à des contacts
...
## <a name="registering-campaign-responses" />Enregistrement des réponses de promotion
...
### <a name="to-register-campaign-responses" />Pour enregistrer les réponses de la promotion
