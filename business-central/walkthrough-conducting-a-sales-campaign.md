...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign"></a><a name="walkthrough-conducting-a-sales-campaign"></a>Procédure pas à pas : Mise en place d’une promotion de vente
...
## <a name="setting-up-a-campaign"></a><a name="setting-up-a-campaign"></a>Configuration d'une promotion
...
### <a name="to-set-up-a-campaign"></a><a name="to-set-up-a-campaign"></a>Pour configurer une promotion
...
## <a name="linking-a-segment-to-a-campaign"></a><a name="linking-a-segment-to-a-campaign"></a>Association d'un segment à une promotion
...
### <a name="to-link-a-segment-to-the-campaign"></a><a name="to-link-a-segment-to-the-campaign"></a>Pour associer un segment à une promotion
...
## <a name="sending-letters-and-email-messages-to-contacts"></a><a name="sending-letters-and-email-messages-to-contacts"></a>Envoi de lettres et de courriels à des contacts
...
## <a name="registering-campaign-responses"></a><a name="registering-campaign-responses"></a>Enregistrement des réponses de promotion
...
### <a name="to-register-campaign-responses"></a><a name="to-register-campaign-responses"></a>Pour enregistrer les réponses de la promotion
