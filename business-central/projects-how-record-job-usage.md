...
> [!TIP]
> Dans les sections suivantes, nous utilisons le terme *enregistrer l'utilisation* pour couvrir deux tâches : enregistrer les lignes planification projet et facturer le client en conséquence.
...
8. Répétez les phases 3 à 7 pour enregistrer l'utilisation supplémentaire.  
9. Pour passer en revue une facture vente validée associée, cliquez sur **Avoirs/Factures vente** .  

    S'il existe plusieurs factures pour ce projet, vous devez choisir la facture appropriée sur la page **Factures projet** , puis choisissez l'action **Ouvrir la facture vente/la note de crédit** .  
