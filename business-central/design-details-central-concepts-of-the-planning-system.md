...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Emplacements/priorité de niveau transfert
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Prévisions de demande et commandes permanentes
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Planification commande
