...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Comptabiliser, ajuster et reclasser l'inventaire avec les journaux
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Pour calculer l’inventaire prévu dans les configurations d’entrepôt de base
...
### <a name="to-print-the-report-to-be-used-when-counting" />Pour imprimer le rapport à utiliser lors du comptage
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Pour saisir et reporter l'inventaire réel comptabilisé dans les configurations d'entrepôt de base
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Pour calculer l'inventaire prévu dans les configurations d'entrepôt avancées
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Pour saisir et reporter l'inventaire réel comptabilisé dans les configurations d'entrepôt avancées
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Pour ajuster les quantités de zone dans les configurations d'entrepôt avancées
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Pour synchroniser les écritures entrepôt ajustées avec les écritures article associées
