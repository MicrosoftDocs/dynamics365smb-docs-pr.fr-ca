...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Dimensions sur des écritures client et fournisseur
...
#### <a name="dimensions-on-bank-account-entries" />Dimensions sur des écritures compte bancaire
...
### <a name="effect-on-gl-accounts" />Effet sur les comptes du grand livre
...
##### <a name="dimensions-on-gl-account-entries" />Dimensions sur des écritures compte du grand livre
