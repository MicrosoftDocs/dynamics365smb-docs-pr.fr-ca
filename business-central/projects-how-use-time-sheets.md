...
## <a name="copy-job-planning-lines-to-a-time-sheet"></a>Copier des lignes planification projet dans une feuille de temps
...
2. Ouvrez une feuille de temps à partir de la liste.  
    ...
    > [!NOTE]  
    > Vous ne pouvez rouvrir que les lignes dont le statut est **Approuvé**. Vous ne pouvez pas rouvrir les lignes dont l'état est **Rejeté** ou qui ont été reportées.  
...
## <a name="post-time-sheet-lines-in-a-job-journal"></a>Reporter des lignes feuille de temps dans un journal projet
