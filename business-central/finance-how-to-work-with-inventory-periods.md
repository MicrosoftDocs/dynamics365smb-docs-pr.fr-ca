...
ms.author: edupont
---
# <a name="work-with-inventory-periods" />Utiliser les périodes d'inventaire
...
## <a name="to-create-an-inventory-period" />Pour créer une période d'inventaire
...
## <a name="closing-inventory-periods" />Fermeture de périodes d'inventaire
...
### <a name="to-close-an-inventory-period" />Pour fermer une période d'inventaire
...
### <a name="to-reopen-an-inventory-period" />Pour rouvrir une période d'inventaire
1. Sélectionnez l’icône ![Ampoule qui ouvre la fonction Tell Me.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Périodes d’inventaire**, puis choisissez le lien associé.  
