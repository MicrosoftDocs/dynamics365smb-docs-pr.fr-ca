...
|Ctrl+Origine<br />(Fn+Ctrl+Flèche gauche)|Sélectionnez la première ligne de la liste ; le focus passe au premier champ actionnable de la ligne|Accéder à la vignette de la première ligne de la liste||
...
|Page Upbr />(Fn+Flèche haut)|Accédez à la page précédente du rapport.|
