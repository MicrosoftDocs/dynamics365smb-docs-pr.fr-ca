...
|----------------|-----------|  
|Alt+Q<br />(Ctrl+Alt+Q)|Ouvrez la zone **Dites-moi ce que vous voulez faire** qui peut vous aider à rechercher une page, un rapport, une action sur la page actuelle, ou un article dans la documentation.|
...
|Échap|Fermer la page actuelle ou la liste déroulante.|
...
|Accueil<br />(Fn+flèche gauche)|Accéder au premier champ de la ligne.|Accéder à la première vignette de la ligne.||
|Fin<br />(Fn+flèche droite)|Accéder au dernier champ de la ligne.|Accéder à la dernière vignette de la ligne.||
|Page précédente<br />(Fn + flèche vers le haut)|Fait défiler pour afficher l'ensemble de lignes au-dessus des lignes actuelles de la vue. |Fait défiler pour afficher l'ensemble de vignettes au-dessus des vignettes actuelles de la vue. ||
...
|Appuyez sur les touches suivantes<br />(dans macOS)|Pour procéder dans une vue de liste |Pour procéder dans une vue en mosaïque |Remarques|
|-----------------|-------|-------|-------|
|Ctrl+Origine<br />(Fn+Ctrl+Flèche gauche)|Sélectionnez la première ligne de la liste ; le focus passe au premier champ de la ligne.|Accéder à la première vignette de la première ligne. ||
...
|Ctrl+V<br />(Cmd+V)|Collez les lignes sélectionnées du Presse-papiers dans la page actuelle ou le document externe, comme Microsoft Excel ou un courriel Outlook.|Non applicable.|Vous pouvez uniquement effectuer ces opérations dans les listes modifiables.|
...
|Ctrl+Origine|Ouvrir le calendrier s'il est fermé.|
|Ctrl+Origine<br />(Cmd+Accueil)|Accéder au mois actuel, le jour actuel.|
...
|Échap|Fermer le calendrier sans sélection, conserver la date actuelle.|
...
|Ctrl+Origine<br />(Cmd+Accueil)|Accédez à la première page du rapport.|
|Ctrl+Fin<br />(Cmd+Accueil)|Accédez à la dernière page du rapport.|
