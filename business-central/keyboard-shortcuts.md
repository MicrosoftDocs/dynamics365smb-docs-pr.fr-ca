...
## <a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="reportpreviewshortcuts"></a>Raccourcis clavier dans l'aperçu de rapports
...
|<kbd>Ctrl</kbd>+<kbd>Fin</kbd><br /><br />(<kbd>Cmd</kbd>+<kbd>Début</kbd>)|Accédez à la dernière page du rapport.|
...
|<kbd>Page suivante</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>Flèche vers le haut</kbd>)|Accédez à la page suivante du rapport.|
