...
## Créer et lier un enregistrement document entrant à partir d'une écriture fournisseur
...
## Pour supprimer la connexion d'un enregistrement document entrant à un document reporté
