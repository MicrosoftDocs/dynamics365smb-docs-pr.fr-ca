...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" />Créer et lier un enregistrement document entrant à partir d'une écriture fournisseur
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />Pour supprimer la connexion d'un enregistrement document entrant à un document reporté
