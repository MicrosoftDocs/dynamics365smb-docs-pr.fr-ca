...
---
# <a name="available-fonts" /><a name="available-fonts"></a>Polices disponibles
...
## <a name="document-fonts" /><a name="document-fonts"></a>Polices de document
...
## <a name="fonts-for-checks" /><a name="fonts-for-checks"></a>Polices pour chèques
...
## <a name="fonts-for-barcodes" /><a name="fonts-for-barcodes"></a>Polices pour codes à barres
