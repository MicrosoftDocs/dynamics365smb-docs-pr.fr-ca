...
ms.locfileid: "8654823"
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Polices disponibles
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Polices de document

Les polices suivantes sont installées et disponibles pour une utilisation dans les présentation de rapport Word et RDLC :
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Polices pour chèques
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Polices pour codes à barres
