...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Affecter un modèle
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Utiliser des modèles Word avec le courriel
