...
Les modèles Microsoft Word peuvent faciliter la communication de masse par documents papier ou courriels avec des entités telles que les contacts, les clients et les fournisseurs. Par exemple, vous pouvez créer :

* Des brochures pour avertir les clients d’une promotion de vente;
...
1. Choisissez une ou plusieurs entités à utiliser comme source des données. Par exemple, si vous souhaitez créer une brochure pour une promotion de vente, vous choisirez probablement l’entité Client comme source.
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a><a name="apply-a-template"></a>Affecter un modèle
...
Vous pouvez utiliser l’action **Affecter des modèles Word** pour affecter les modèles à une ou plusieurs entités du même type, comme un client, directement dans le contexte de cette page pour l’entité. Par exemple, les pages **Client** ou **Fournisseur**.

## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Utiliser des modèles Word avec le courriel
