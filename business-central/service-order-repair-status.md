...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Configurer les états des commandes service et des réparations
...
## <a name="to-set-up-service-status-priorities" />Pour configurer les priorités état service
...
## <a name="to-set-up-a-repair-status" />Pour configurer un état réparation
