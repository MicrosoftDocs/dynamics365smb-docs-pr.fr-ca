...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Détails de conception : report d'un ordre d'assemblage
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Séquence de report
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Ajustement du coût
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Dates de report
