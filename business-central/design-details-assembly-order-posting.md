...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting" />Détails de conception : report d'un ordre d'assemblage
...
## <a name="posting-sequence" />Séquence de report
...
## <a name="cost-adjustment" />Ajustement du coût
...
### <a name="posting-dates" />Dates de report
