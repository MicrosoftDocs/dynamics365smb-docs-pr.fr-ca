...
3. Dans le champ **N°**, saisissez le numéro du modèle de contrat.  
     ...
     Si vous avez configuré une série de numéros pour les modèles contrat sur la page **Configuration Gestion des services**, vous pouvez appuyer sur la touche Entrée pour que le programme saisisse le numéro modèle contrat suivant. Renseignez les autres champs, si nécessaire.  
