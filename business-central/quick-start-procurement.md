...
## <a name="create-new-purchase-orders" />Créer des bons de commande
...
### <a name="to-create-a-purchase-order" />Pour créer un bon de commande
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Procédure : créer et reporter une facture achat
