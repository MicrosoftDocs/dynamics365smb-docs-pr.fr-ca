...
description: Vous pouvez configurer une nouvelle compagnie dans Business Central avec RapidStart Services pour améliorer la productivité en automatisant et en simplifiant les tâches récurrentes.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.locfileid: "8518321"
---
# <a name="set-up-a-company-with-rapidstart-services"></a>Configurer une compagnie avec RapidStart Services
...
|Se préparer à réutiliser les configurations de la compagnie dans d’autres compagnies (dans le contenu pour développeurs et administrateurs).|[Créer des packages configuration de compagnie personnalisés](/dynamics365/business-central/dev-itpro/administration/set-up-standard-company-configuration-packages)|
