...
## <a name="load-inventory-profiles" />Charger les profils d’inventaire
...
### <a name="component-need-is-loaded-according-to-production-order-changes" />Le besoin composante est chargé en fonction des modifications du bon de production
...
### <a name="forecast-demand-is-reduced-by-sales-orders" />La prévision de demande est réduite par les documents de vente
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders" />La demande de commande permanente est réduite par les documents de vente
...
### <a name="create-the-planning-line-suggested-action" />Création de la ligne planification (action suggérée)
