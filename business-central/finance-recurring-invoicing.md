...
## <a name="register-revenue-with-a-recurring-general-journal" />Enregistrer les revenus avec un journal général récurrent
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal" />Créer plusieurs factures à partir d'une journal projet récurrent
...
### <a name="blanket-sales-orders" />Commandes permanentes ventes
