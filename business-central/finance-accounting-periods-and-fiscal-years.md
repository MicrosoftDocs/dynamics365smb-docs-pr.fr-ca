...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Utiliser des périodes comptables et des exercices financiers
...
## <a name="creating-a-new-fiscal-year" />Création d'un exercice financier
...
## <a name="closing-a-fiscal-year" />Fermeture d’un exercice financier
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Report d’écritures dans un exercice financier fermé
