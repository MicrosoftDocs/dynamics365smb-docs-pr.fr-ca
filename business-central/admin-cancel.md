...
Si vous avez ajouté des données à votre version d'évaluation gratuite de [!INCLUDE[d365fin](includes/d365fin_md.md)] et que vous souhaitez recommencer à zéro, vous pouvez créer une compagnie avant de réinitialiser la première compagnie. Si vous ouvrez la fenêtre **Compagnies**, vous pouvez créer une copie de votre compagnie actuelle, vous déconnecter et vous connecter à votre nouvelle compagnie, puis réinitialiser la compagnie d'origine.  
> [!NOTE]  
