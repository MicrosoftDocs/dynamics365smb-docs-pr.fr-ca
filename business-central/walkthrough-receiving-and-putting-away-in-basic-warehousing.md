...
### <a name="to-set-up-the-location" />Pour configurer l'emplacement
...
## <a name="create-the-purchase-order" />Créer le bon de commande

Les bons de commande sont le type de document source entrant le plus répandu.  

### <a name="to-create-the-purchase-order" />Pour créer le bon de commande
