...
## <a name="to-calculate-a-work-center-calendar" />Pour calculer un calendrier d'atelier
...
## <a name="to-record-work-center-absence" />Pour enregistrer les absences de l'atelier
