...
|-------------------------------------------|-----|-------------------------|--------------|
|Représentant/Acheteur|Utilisateur|[!INCLUDE[d365fin](includes/cds_long_md.md)] -> [!INCLUDE[d365fin](includes/d365fin_md.md)]|Filtre contact Sales : l'**État** est **Non**, l'**Utilisateur sous licence** est **Oui**, le Mode utilisateur de l'intégration est **Non**|
...
|Fournisseur|Compte|[!INCLUDE[d365fin](includes/d365fin_md.md)] -> [!INCLUDE[crm_md](includes/crm_md.md)] et [!INCLUDE[crm_md](includes/crm_md.md)] -> [!INCLUDE[d365fin](includes/d365fin_md.md)]|Filtre compte Sales : le **Type de relation** est **Fournisseur** et l'**État** est **Actif**.|
