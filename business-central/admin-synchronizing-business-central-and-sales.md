...
|Documents de vente|Les en-têtes de document de vente libérés sont synchronisés avec le document de vente. Pour qu'une commande puisse être synchronisée, il est préférable de synchroniser toutes les autres entités pouvant participer à la commande, depuis les représentants aux listes de prix. La valeur Code représentant de l'en-tête de commande définit le propriétaire de l'entité couplée dans Sales.|  
