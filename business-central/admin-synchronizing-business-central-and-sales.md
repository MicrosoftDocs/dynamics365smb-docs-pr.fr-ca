...
| Contact | Contact | [!INCLUDE[prod_short](includes/prod_short.md)] -> [!INCLUDE[prod_short](includes/cds_long_md.md)] et [!INCLUDE[prod_short](includes/cds_long_md.md)] -> [!INCLUDE[prod_short](includes/prod_short.md)] | Filtre contact [!INCLUDE[prod_short](includes/prod_short.md)] : le champ **Type** est défini sur **Personne** et le contact est affecté à une compagnie. Filtre contact [!INCLUDE[prod_short](includes/cds_long_md.md)] : le contact est affecté à une compagnie et le type de client parent est **Compte** |
