...
## <a name="to-set-up-a-component-list-for-a-main-asset" />Pour configurer une liste de composantes pour une immobilisation principale
...
## <a name="to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal" />Pour reporter manuellement une acquisition immobilisation avec le journal GL immobilisation
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />Pour annuler le report du coût d'une acquisition pour une immobilisation
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />Pour reporter la valeur résiduelle ainsi que le coût d'acquisition
