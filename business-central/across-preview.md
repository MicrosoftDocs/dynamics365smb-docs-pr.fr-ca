...
### <a name="set-up-your-company-in-prod_short"></a>Configurer votre compagnie dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
Si vous avez ajouté des données à votre essai gratuit [!INCLUDE[prod_short](includes/prod_short.md)], vous pouvez toujours recommencer avec une nouvelle expérience. Créez simplement une compagnie d'évaluation, puis supprimez la compagnie d'origine. Ouvrez la page **Compagnies** et choisissez l’action **Nouveau** pour démarrer le guide de configuration assistée **Créer une compagnie**. Le guide peut vous aider à configurer une nouvelle compagnie d'évaluation avec des exemples de données. Vous pouvez également créer une copie de votre compagnie actuelle, vous déconnecter, puis vous connecter à votre nouvelle compagnie.  
