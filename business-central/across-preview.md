...
Si vous voulez essayer [!INCLUDE [prodshort](includes/prodshort.md)] avec vos propres données, vous pouvez opter pour une version d'évaluation gratuite de 30 jours avec une compagnie vide afin de pouvoir importer vos données.  
