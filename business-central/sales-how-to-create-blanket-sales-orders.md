...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Utiliser des commandes permanentes ventes ou des commandes permanentes achats
...
## <a name="to-create-a-blanket-sales-order" />Pour créer une commande permanente ventes
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Pour créer un document de vente à partir d'une commande permanente ventes
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Pour visualiser l'état d'une commande permanente ventes
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Pour afficher des lignes commande permanente ventes reportées et non reportées
