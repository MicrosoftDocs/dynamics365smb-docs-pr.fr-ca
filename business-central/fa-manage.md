...
| Surveillez les coûts d'entretien. | [Surveiller les coûts d’entretien](fa-how-maintain.md#monitor-maintenance-costs)|
...
1. Exécuter un rapport qui calcule l'amortissement périodique.
