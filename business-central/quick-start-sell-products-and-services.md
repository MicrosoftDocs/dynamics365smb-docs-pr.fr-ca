...
## <a name="create-a-sales-order"></a><a name="create-a-sales-order"></a>Créer un document de vente
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Pour créer un document de vente
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Pour créer et reporter une facture vente
