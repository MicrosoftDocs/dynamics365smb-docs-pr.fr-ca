...
---
# <a name="create-new-companies-in-includeprodshortincludesprodshortmd" />Créer des compagnies dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="copy-a-company" />Copier une compagnie
...
## <a name="set-up-the-company" />Configurer la compagnie
...
## <a name="companies-and-environments" />Compagnies et environnements
...
## <a name="changing-a-companys-name" />Changer le nom d’une compagnie
