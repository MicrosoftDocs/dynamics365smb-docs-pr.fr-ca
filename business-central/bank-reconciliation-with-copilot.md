...
## <a name="post-unmatched-bank-transaction-amounts-to-suggested-gl-accounts"></a>Reporter les montants de transactions bancaires sans correspondance vers les comptes GL suggérés
