...
## <a name="handling-sales-order-data" />Gestion des données de documents de vente
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Gestion des factures vente reportées, des paiements client et des statistiques
