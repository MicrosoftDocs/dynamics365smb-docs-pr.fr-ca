...
## <a name="couple-records"></a>Enregistrements couplage
...
## <a name="fully-synchronize-records"></a>Synchronisation complète des enregistrements
...
## <a name="handle-sales-order-data"></a>Gestion des données de documents de vente
...
## <a name="handle-sales-quotes-data"></a>Gestion des données de devis
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Gestion des factures vente reportées, des paiements client et des statistiques
...
## <a name="handle-sales-prices"></a>Gestion des prix de vente
> [!NOTE]
