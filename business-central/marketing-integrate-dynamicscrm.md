...
Quand vous choisissez **Traitement** dans [!INCLUDE[d365fin](includes/d365fin_md.md)] pour un devis dans un état **Conclu** , un document de vente est créé dans [!INCLUDE[d365fin](includes/d365fin_md.md)] uniquement si un document de vente correspondant est soumis dans [!INCLUDE[crm_md](includes/crm_md.md)]. Sinon, le devis n’est publié que dans [!INCLUDE[d365fin](includes/d365fin_md.md)]. Si un document de vente correspondant est envoyé dans [!INCLUDE[crm_md](includes/crm_md.md)] plus tard, et qu’un document de vente en est créé, le **N° devis** est mis à jour sur le document de vente et le devis est archivé.
