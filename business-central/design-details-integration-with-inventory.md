...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Détails de conception : intégration avec l'inventaire
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Ajustements d’entrepôt dans le grand livre article
