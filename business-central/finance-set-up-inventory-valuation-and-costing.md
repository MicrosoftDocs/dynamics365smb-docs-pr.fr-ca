...
> [!TIP]
> Pour une introduction à l'évaluation des coûts dans [!INCLUDE [prodshort](includes/prodshort.md)], voir [À propos de l’évaluation des coûts de l'inventaire](finance-learn-about-costing.md).
