...
## <a name="fill-in-and-send-an-intercompany-sales-order"></a>Renseigner et envoyer un document de vente intercompagnie
...
## <a name="fill-in-and-post-an-intercompany-journal"></a>Renseigner et reporter un journal intercompagnie
