...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Créer des factures ou des notes de crédit de service
...
## <a name="to-post-an-invoice-from-a-service-order" />Pour reporter une facture à partir d'une commande service
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />Pour créer une facture qui combine les lignes livraison reportées d'une ou de plusieurs commandes service
...
## <a name="to-create-a-service-credit-memo" />Pour créer une note de crédit service
