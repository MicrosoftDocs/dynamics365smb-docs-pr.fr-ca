...
ms.locfileid: "9201996"
---
# <a name="privacy-notices-status-in-prod_long"></a>État des déclarations de confidentialité dans [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="privacy-notices-status-page"></a>Page État des déclarations de confidentialité
