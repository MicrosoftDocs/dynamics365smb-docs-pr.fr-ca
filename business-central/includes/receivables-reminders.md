...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Pour créer automatiquement un rappel
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Pour créer un rappel manuellement
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Pour remplacer les textes rappel
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Pour émettre un rappel
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Pour annuler un rappel émis
