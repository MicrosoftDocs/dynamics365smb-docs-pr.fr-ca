...
ms.locfileid: "8367333"
---
## <a name="sign-up"></a>S’inscrire

### <a name="which-email-address-i-should-use-to-sign-up"></a>Quelle adresse de courriel dois-je utiliser pour m’inscrire?
...
### <a name="i-didnt-receive-the-trial-details-email-after-signing-up-what-should-i-do"></a>Je n’ai pas reçu le courriel avec les détails de l’essai après m’être inscrit, que dois-je faire?
