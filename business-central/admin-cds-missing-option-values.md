...
> [!IMPORTANT]  
> Vous devez utiliser les mêmes valeurs code option de [!INCLUDE[d365fin](includes/cds_long_md.md)] lorsque vous étendez l'énumération [!INCLUDE[d365fin](includes/d365fin_md.md)]. Sinon, la synchronisation échoue.
