...
4. L’approvisionnement suivant **Sb** de 2 (une autre commande) est déjà placé dans la chronologie.  
...
#### <a name="situation-before-a-sales-decrease"></a>Situation avant une sortie de vente
...
1. L’approvisionnement **A**, inventaire prévisionnel initial, est inférieur au point de réapprovisionnement.  
2. Un approvisionnement programmé en aval est créé (**C**).  

     (Quantité = inventaire maximum – niveau d'inventaire prévu)  
3. L'approvisionnement **A** est fermé par la demande **B** qui n'est pas totalement couverte.  
...
7. L’inventaire prévu est vérifié. Le point de commande n’est pas franchi.  
