...
# <a name="troubleshooting-and-correcting-dimensions" />Dépannage et correction des dimensions
...
## <a name="troubleshooting-dimensions-errors" />Dépannage des erreurs liées aux dimensions
...
## <a name="changing-dimension-assignments-after-posting" />Modification des attributions de dimension après le report
...
### <a name="setting-up-dimension-corrections" />Configuration des corrections de dimensions
...
### <a name="correcting-a-dimension" />Correction d’une dimension
...
### <a name="validating-dimension-corrections" />Validation des corrections de dimensions
...
### <a name="dimension-corrections-on-large-data-sets" />Corrections de dimensions sur des jeux de données volumineux
...
### <a name="use-analysis-views-with-dimension-corrections" />Utiliser des vues d’analyse avec des corrections de dimensions
...
### <a name="viewing-historical-dimension-corrections" />Affichage des corrections de dimensions historiques
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Utiliser la comptabilité analytique avec les écritures GL corrigées
