...
2. Dans le champ **Fournisseur**, entrez le nom d'un fournisseur existant.
    ...
    5. Renseignez les autres champs de la fiche fournisseur. Pour plus d'informations, voir [Enregistrer de nouveaux fournisseurs](purchasing-how-register-new-vendors.md).  
...
5. Dans le champ **Quantité**, indiquez le nombre d'articles à acheter.
    ...
    > [!NOTE]  
    > Pour les articles de type **Service** ou les lignes de type **Ressource**, la quantité est une unité de mesure de temps, telle que les heures, comme indiqué dans le champ **Code unité de mesure** de la ligne.
