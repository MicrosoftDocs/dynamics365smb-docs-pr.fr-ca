...
description: Décrit comment acheter des ressources ou des articles en inventaire ou hors inventaire en créant et en reportant des factures ou commandes achat.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Vous pouvez facilement corriger ou annuler une facture achat reportée avant de payer le fournisseur. Par exemple, si vous souhaitez corriger une coquille, ou si vous souhaitez modifier l’achat assez tôt dans le processus de commande. En savoir plus, [Corriger ou annuler des factures achat impayées](purchasing-how-correct-cancel-unpaid-purchase-invoices.md) Pour inverser un achat pour des articles ou services sur une facture achat reportée pour laquelle le paiement est traité, créez une note de crédit achat. En savoir plus, [Traiter les retours ou annulations d’achats](purchasing-how-process-purchase-returns-cancellations.md)
...
## <a name="purchasing-noninventory-items"></a>Acheter des articles hors stock
...
3. Dans le champ **Qté à recevoir**, indiquez la quantité reçue.
   ...
   > [!NOTE]
   > Si la quantité reçue est supérieure à la quantité du bon de commande, et que le fournisseur a été configuré pour autoriser les sur-réceptions, utilisez le champ **Sur-réception** pour gérer la quantité excédentaire. Pour en savoir plus, consultez la section [Pour réceptionner plus d’articles que vous commandés](purchasing-how-record-purchases.md#receive-more-items-than-you-ordered).
...
## <a name="receive-more-items-than-you-ordered"></a>Réceptionner plus d’articles que commandés
...
1. Sur un bon de commande ou un document réception entrepôt où la quantité reçue est supérieure à celle commandée, saisissez la quantité reçue dans le champ **Qté à recevoir**.
