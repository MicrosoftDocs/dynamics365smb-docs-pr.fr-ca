...
### <a name="create-a-and-post-purchase-invoice" />Créer et reporter une facture achat
...
## <a name="posted-invoices" />Factures reportées
...
## <a name="purchasing-non-inventory-items" />Achat d'articles hors inventaire
...
## <a name="when-to-use-purchase-orders" />Quand utiliser les bons de commande
...
## <a name="receive-items-with-a-purchase-order" />Pour réceptionner des articles avec un bon de commande
...
## <a name="posting-purchases" />Report des achats
