...
# <a name="company-information-quick-start" />Démarrage rapide de Informations compagnie
...
## <a name="to-set-up-company-information" />Pour configurer les informations sur la compagnie
