...
Si vous utilisez un comptable externe pour gérer votre comptabilité et vos rapports financiers, vous pouvez l'inviter à votre [!INCLUDE[d365fin](includes/d365fin_md.md)] afin qu'il puisse travailler avec vous et utiliser vos données fiscales.
