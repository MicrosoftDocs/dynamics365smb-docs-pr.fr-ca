...
Cela a pour effet d'importer dans la compagnie le compte utilisateur que vous avez créé dans le portail Azure. Pour plus d'informations, voir [Pour ajouter un utilisateur dans Business Central](ui-how-users-permissions.md#to-add-a-user-in-business-central).  
