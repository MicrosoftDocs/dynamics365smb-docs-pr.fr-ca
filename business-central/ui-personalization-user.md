...
> [!NOTE]
> Vous ne pouvez pas personnaliser la barre d'actions qui apparaît dans les parties de la page (par exemple, la partie des lignes de vente sur la page **Document de vente**).
