...
Un *groupe d'actions* désigne un élément qui se développe pour afficher d'autres actions ou groupes. Par exemple, sur la page **Documents de vente**, l'action **Fonctions** qui apparaît lorsque vous choisissez l'action **Actions** est un groupe d'actions.
