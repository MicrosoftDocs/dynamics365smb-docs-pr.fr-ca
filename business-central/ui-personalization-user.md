...
|Ajoutez une nouvelle action à une page ou à un rapport sur votre tableau de bord.|Sur la page cible, la page de demande de rapport ou la fenêtre Tell Me, choisissez l'icône de signet.|[En savoir plus sur la mise en signet des pages et des rapports](ui-bookmarks.md)|
...
- Les modifications que vous apportez s’appliquent à tous vos tableaux de bord. Par exemple, si vous modifiez la liste Clients lorsque le tableau de bord est défini sur Gestionnaire d’activité, vous voyez également la modification sur la page **Clients** lorsque le tableau de bord est défini sur Préparateur de documents de vente.
