...
3. Choisissez l’action **Association**, **Article**, puis **Substitutions** pour ouvrir la page Saisie de substitution d’articles.  
...
Lorsque la quantité d’articles requis, comme pour une ligne vente, dépasse la quantité disponible en inventaire, un message apparaît pour vous informer que des articles de substitution sont disponibles.
