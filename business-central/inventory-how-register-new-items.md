...
### <a name="items-used-in-production-orders" />Articles utilisés dans les bons de production
...
## <a name="set-up-item-substitutions" />Configuration de substitutions d'articles
...
### <a name="to-make-an-item-substitution" />Pour créer une substitution d'articles
...
## <a name="manage-inventory-in-warehouses" />Gérer l'inventaire des entrepôts
