...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Pour créer un rangement inventaire à partir du document source
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Pour créer plusieurs rangements inventaire avec un traitement en lot
...
### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Pour demander un rangement inventaire en libérant le document d'source
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Pour créer un rangement inventaire sur la base du document source
...
## <a name="to-record-the-inventory-put-away" />Pour enregistrer les rangements inventaire
