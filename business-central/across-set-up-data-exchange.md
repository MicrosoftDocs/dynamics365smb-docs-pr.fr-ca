...
|Configurez l’exportation des données pour la déclaration Intrastat dans [!INCLUDE[prod_short](includes/prod_short.md)].|[Paramétrer les rapports Intrastat](finance-how-setup-report-intrastat.md)|
