...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Configurer un indicateur coloré sur les piles pour la compagnie ou les utilisateurs individuels
