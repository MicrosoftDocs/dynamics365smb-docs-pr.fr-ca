...
## <a name="create-a-purchase-quote"></a><a name="create-a-purchase-quote"></a>Créer un devis
...
## <a name="convert-a-purchase-quote-to-a-purchase-order"></a><a name="convert-a-purchase-quote-to-a-purchase-order"></a>Convertir un devis en bon de commande
