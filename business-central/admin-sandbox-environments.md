...
## <a name="designer"></a><a name="designer"></a><a name="designer"></a>Générateur
...
Pour plus d’informations, voir [Utiliser Designer](/dynamics365/business-central/dev-itpro/developer/devenv-inclient-designer) dans le contenu dédié à l’équipe Administration et aux développeurs (en anglais uniquement).  
