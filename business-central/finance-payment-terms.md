...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Configurer des modalités de paiement
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Pour configurer des modalités de paiement
