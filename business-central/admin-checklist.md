...
ms.author: edupont
---
# <a name="onboard-users-with-checklists" />Utilisateurs intégrés avec des listes de vérification
...
## <a name="to-add-an-item-to-the-checklist" />Pour ajouter un article à la liste de vérification
