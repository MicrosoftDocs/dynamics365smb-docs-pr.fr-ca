...
---
# <a name="transfer-inventory-between-locations" />Transfert d'inventaire entre des emplacements
...
## <a name="item-reclassification-journals" />Journaux reclassement article
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Reporter plusieurs ordres transfert dans un lot
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Programmer une entrée dans la file d’attente des travaux pour reporter plusieurs documents dans un lot
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Pour transférer des articles avec le journal reclassement article
...
## <a name="undo-a-transfer-shipment" />Annuler une livraison transfert
