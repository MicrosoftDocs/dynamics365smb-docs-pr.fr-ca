...
---
# <a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a>Transfert d'inventaire entre des emplacements
...
## <a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a>Journaux reclassement article
...
### <a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a>Reporter plusieurs ordres transfert dans un lot
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a>Programmer une entrée dans la file d’attente des travaux pour reporter plusieurs documents dans un lot
...
## <a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a>Pour transférer des articles avec le journal reclassement article
...
## <a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a>Annuler une livraison transfert
