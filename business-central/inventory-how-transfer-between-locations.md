...
---
# <a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a>Transfert d'inventaire entre des emplacements
...
## <a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a>Journaux reclassement article
...
3. Il existe plusieurs façons de remplir les lignes :
    ...
    |Automatiquement     | * Choisissez l’action **Extraire contenu zone** pour sélectionner des éléments existants dans une zone spécifique.<br><br>* Choisissez l’action **Extraire lignes réception** pour sélectionner les éléments qui viennent d’arriver dans l’emplacement provenance transfert.        |
...
### <a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a>Reporter plusieurs ordres transfert dans un lot
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a>Programmer une entrée dans la file d’attente des travaux pour reporter plusieurs documents dans un lot
...
La procédure suivante décrit comment définir le rapport **TPL ordres de transfert** pour un report automatique des ordres transfert direct lancés à 16 h 00 les jours de semaine. Cette heure n’est qu’un exemple. Les étapes sont similaires pour les autres documents.  
...
4. Dans le champ **Code objet à exécuter**, sélectionnez **5707, TPL ordres de transfert**.
5. Activez la case à cocher **Page requête rapport**.
6. Sur la page de demande **TPL ordres de transfert**, choisissez l’option **Livrer**, filtrez sur **Transfert direct**, puis sélectionnez **OK**.
...
## <a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a>Pour transférer des articles avec le journal reclassement article
...
## <a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a>Annuler une livraison transfert
...
* La valeur du champ **Quantité livrée** est diminuée de la quantité que vous avez annulée.
* La valeur du champ **Quantité à livrer** est accrue de la quantité que vous avez annulée.
