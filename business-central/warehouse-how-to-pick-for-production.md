...
## <a name="inventory-picks" />Prélèvements inventaire
...
## <a name="inventory-movements" />Mouvements d’inventaire
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Pour créer un mouvement d’inventaire à partir du document source
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Pour créer plusieurs prélèvements ou mouvements d’inventaire avec un traitement en lot
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Pour créer des prélèvements ou des mouvements d’inventaire en deux étapes
...
## <a name="to-record-the-inventory-pick" />Pour enregistrer le prélèvement inventaire
...
## <a name="to-record-the-inventory-movement" />Pour enregistrer le mouvement d’inventaire
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Consommer les composantes pour la production dans une configuration d’entrepôt de base
