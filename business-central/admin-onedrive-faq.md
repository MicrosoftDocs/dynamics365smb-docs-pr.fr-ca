...
[!INCLUDE[prod_short](includes/prod_short.md)] ne fournit pas de sélecteur de fichiers nuage. Vous devez télécharger le fichier de OneDrive sur votre appareil, puis le charger dans [!INCLUDE[prod_short](includes/prod_short.md)]. 
