...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />État commande service et état réparation
...
## <a name="specifying-service-order-status-for-repair-status" />Spécification de l'état commande service pour l'état réparation
...
## <a name="assigning-priority-to-service-order-status" />Affectation de priorité à des états commande service
