...
|Configurer et personnaliser les articles de service et les groupes de service. Cela implique de définir les compétences requises par un service et les directives dépannage.| [Créer des articles de service](service-how-to-create-service-items.md)|  
...
|Comprendre la relation entre l'état d'une réparation et l'effet sur les ressources affectées, et vice versa.|[Description de l'état d'affectation et de l'état réparation](service-allocation-status-and-repair-status.md)|  
