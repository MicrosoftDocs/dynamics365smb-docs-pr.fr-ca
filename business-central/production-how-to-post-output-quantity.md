...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Reporter en lot la production et les temps d’exécution
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Pour reporter les quantités produites et/ou enregistrer le temps d’exécution pour une ou plusieurs lignes bon de production
