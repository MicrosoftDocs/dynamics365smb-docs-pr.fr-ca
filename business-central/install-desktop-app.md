---
title: Obtention de Business Central sur votre bureau
...
- Si vous disposez de plusieurs environnements [!INCLUDE [prod_short](includes/prod_short.md)] (Online uniquement), vous pouvez installer l’application séparément pour chaque environnement.
...
3. Une fois l’application installée, choisissez **Ouvrir**, puis connectez-vous à [!INCLUDE [prod_short](includes/prod_short.md)].
