...
---
# <a name="set-up-customer-discount-groups" />Configurer des groupes escomptes client
...
## <a name="create-sales-line-discounts-for-a-customer-group" />Créer des escomptes ligne vente pour un groupe de clients
...
## <a name="assign-a-customer-to-a-discount-group" />Affecter un client à un groupe d'escomptes
