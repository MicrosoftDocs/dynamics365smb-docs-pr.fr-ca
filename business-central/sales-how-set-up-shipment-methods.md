...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Configurer les méthodes de livraison
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>Pour configurer une méthode de livraison
