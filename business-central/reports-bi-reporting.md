...
ms.locfileid: "8144889"
---
# <a name="business-intelligence-and-reporting-overview"></a>Vue d’ensemble de Business Intelligence et de la génération de rapports
...
| Pour | Voir |
| --- | --- |
| Apprenez à utiliser des rapports standard (marquer, exécuter, imprimer, programmer et modifier la mise en page). | [Utiliser les rapports dans le travail quotidien](reports-use-reports.md) |
