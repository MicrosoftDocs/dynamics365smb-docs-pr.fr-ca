...
|**Pour**|**Voir**|  
|------------|-------------|  
|Comprenez les mécanismes dans le moteur d’évaluation, comme le mode d’évaluation et l’ajustement des coûts, et pour quels principes de compatibilité ils sont conçus.|[Détails de conception : évaluation du coût de l’inventaire](design-details-inventory-costing.md)|  
