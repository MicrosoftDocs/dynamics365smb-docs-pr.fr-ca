...
4. Vous pouvez ajouter une nouvelle alerte en cliquant sur le signe **(+)** en haut de la liste.
    ...
    - Décrire l’alerte.
        ...
        |pièces jointes  | Sélectionnez le bouton **Télécharger**, puis accédez à un fichier pour l'ajouter comme pièce jointe. Après avoir sélectionné le fichier, il est chargé et s’affiche en tant que fichier lié. Vous pouvez ajouter jusqu'à trois fichiers d'une taille de 5 Mo chacun. Pour supprimer les fichiers joints, sélectionnez **Supprimer** sous le titre du fichier. Les pièces jointes doivent être des documents disponibles publiquement. Ils ne peuvent pas être confidentiels ou spécifiques à un client/partenaire.|
