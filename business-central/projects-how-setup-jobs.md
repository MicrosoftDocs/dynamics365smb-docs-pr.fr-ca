...
ms.author: edupont
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Configurer des projets, des prix et des groupes de report projet
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />Pour paramétrer les prix pour des ressources, des articles et des comptes GL pour des projets
