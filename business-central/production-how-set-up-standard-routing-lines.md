...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Configurer des lignes itinéraire standard

L'utilisation de tâches standard simplifie la création et l'entretien des itinéraires. Elles vous permettent d'associer rapidement des informations supplémentaires aux opérations récurrentes.
...
Lorsque vous imprimez la feuille d'itinéraire, vous pouvez choisir d'inclure les éléments de la tâche standard que vous avez ajoutée aux lignes itinéraire.
