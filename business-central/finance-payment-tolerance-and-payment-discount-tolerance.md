...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances" />Utilisation des tolérances de règlement et des tolérances d'escompte de paiement
...
## <a name="applying-payment-tolerance-to-multiple-documents" />Application de la tolérance de règlement à plusieurs documents
...
## <a name="to-set-up-tolerances" />Pour configurer les tolérances
...
## <a name="to-enable-or-disable-payment-tolerance-warnings" />Pour activer ou désactiver les alertes de tolérance de règlement
...
## <a name="to-block-payment-tolerance-for-customers" />Pour bloquer la tolérance de règlement pour des clients
...
## <a name="example-1---tolerance-calculations-for-a-single-document" />Exemple 1 - Calculs de la tolérance pour un seul document
...
## <a name="example-2---tolerance-calculations-for-multiple-documents" />Exemple 2 - Calculs de la tolérance pour plusieurs documents
