...
| Accédez à plusieurs compagnies à partir d′une seule page. | Accédez rapidement à n′importe quelle compagnie Business Central de votre organisation. | [Hub Entreprise](ui-extensions-company-hub.md) |
...
| **Exigence commerciale** | **Comment Business Central la prend en charge** | **En savoir plus** |
|-------------------------|-------------------------|-------------------------|
| Consolidez les données financières des sites. | Consolidez les états financiers des sites, qu′ils exécutent Business Central ou une autre application, en une seule entité commerciale (compagnie). | [Consolidation des données financières de plusieurs compagnies](finance-consolidated-company-reporting.md) |
| Intégrez les structures comptables. | Transférez les données de consolidation de différentes structures comptables vers les vôtres. Format de fichier intégré pour F&O (disponible avec la deuxième vague de publication 2020) | [Importation des données métier à partir d'autres systèmes financiers](across-import-data-configuration-packages.md)<br></br>[Préparer les comptes GL pour la consolidation](finance-consolidated-company-reporting-setup.md#glacc) |
...
| **Exigence commerciale** | **Comment Business Central la prend en charge** | **En savoir plus** |
|-------------------------|-------------------------|-------------------------|
| Partagez des informations avec les sites sans support informatique étendu. | Créez des KPI et des tableaux de bord Business Intelligence dans Power BI basés sur vos données. | [Se connecter à Power BI depuis Business Central local](across-working-with-business-central-in-powerbi.md) |
| Développez des rapports financiers personnalisés. | Générez des rapports financiers basés sur des paramètres. | [Veille économique](bi.md) |
| Alignez-vous sur les faits. | Générez, visualisez et partagez des rapports avec les parties prenantes internes et externes. | [Rapports financiers ](finance-reports.md) |
...
| Reportez et importez des documents XML. | Les codeunits peuvent être exposés en tant qu′actions indépendantes pour prendre en charge le report et l′ingestion de documents XML. Pour traiter des documents XML, des XMLports peuvent être appliqués. Les actions indépendantes sont également capables de générer un document XML ou JSON. | [Objets XMLport](/dynamics365/business-central/dev-itpro/developer/devenv-xmlport-object) |
| Facilitez l'entretien grâce à l′échange de données électroniques. | Une solution d′échange de données électroniques peut être ajoutée pour servir de couche d′intégration entre le siège social et les sites. | [Data Exchange Framework](across-about-the-data-exchange-framework.md) |
...
| **Exigence commerciale** | **Comment Business Central la prend en charge** | **En savoir plus** |
|-------------------------|-------------------------|-------------------------|
| Traitez les transactions inter-divisions comme des transactions de vente et d′achat normales. | Utilisez les reports intercompagnies pour créer des documents de vente et d′achat et des écritures pour des flux de travail entiers et pour plusieurs compagnies à la fois afin d′éliminer la saisie de données en double. | [Gestion des transactions intercompagnies](intercompany-manage.md) |
...
| **Exigence commerciale** | **Comment Business Central la prend en charge** | **En savoir plus** |
|-------------------------|-------------------------|-------------------------|
| Générez automatiquement des alertes par courriel. | Configurez des alertes dans Power Automate qui envoient des courriels pour vous informer des conditions métier critiques sur les sites ou chez les partenaires de la chaîne d′approvisionnement. | [Business Central et Power BI](admin-powerbi.md) |
