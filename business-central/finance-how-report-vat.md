...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>À propos du rapport Liste des ventes UE
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Soumettre un rapport Liste des ventes UE

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>À propos du rapport Retour TVA
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Pour configurer les rapports TVA dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Pour préparer et soumettre un rapport TVA
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>États du retour TVA
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Envoi manuel des rapports TVA
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a>Relevé de TVA
