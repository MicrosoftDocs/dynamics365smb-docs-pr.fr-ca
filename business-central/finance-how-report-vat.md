...
## <a name="to-set-up-vat-reports-in-"></a>Pour configurer les rapports TVA dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="vat-return-statuses"></a>États du retour TVA
