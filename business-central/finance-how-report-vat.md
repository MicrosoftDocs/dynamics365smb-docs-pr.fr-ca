...
Dans les deux cas, la TVA est calculée sur la base de la configuration du report TVA et des groupes de report TVA que vous avez définis. [!INCLUDE[prod_short](includes/prod_short.md)] affiche les écritures de TVA en fonction de leur **Date TVA**.
