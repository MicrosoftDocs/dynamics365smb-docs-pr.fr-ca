...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Pour créer une note de crédit achat à partir d'une facture achat reportée
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Pour créer une note de crédit achat en copiant une facture achat reportée
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Pour créer un retour achat à partir d'un ou de plusieurs documents achat reportés
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Pour créer une bon de commande de remplacement à partir d'un retour commande achat
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Pour supprimer des retours achat ouverts après le report de livraisons retour groupées
