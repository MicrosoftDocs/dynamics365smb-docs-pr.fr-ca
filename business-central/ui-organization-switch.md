...
# <a name="switching-to-another-company-or-environment" />Passer à une autre compagnie ou un autre environnement
...
## <a name="about-companies-and-environments" />À propos des compagnies et environnements
...
## <a name="features-for-switching-company-or-environment" />Fonctionnalités pour basculer d’une compagnie à une autre ou d’un environnement à un autre
...
## <a name="use-the-company-switcher" />Utiliser le sélecteur de compagnie
