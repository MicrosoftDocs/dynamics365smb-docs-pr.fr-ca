...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names"></a><a name="set-up-vat-statement-templates-and-vat-statement-names"></a>Configurer des modèles de relevé fiscal et des noms de relevé fiscal
...
## <a name="to-define-a-vat-statement"></a><a name="to-define-a-vat-statement"></a>Pour définir un relevé fiscal
...
## <a name="to-preview-the-vat-statement"></a><a name="to-preview-the-vat-statement"></a>Afficher le relevé fiscal
