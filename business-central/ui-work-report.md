...
## <a name="SavedSettings"></a>Utiliser des valeurs par défaut – paramètres prédéfinis
...
## <a name="ScheduleReport"></a> Programmer un rapport pour une exécution ultérieure ou périodique
...
## <a name="PrintReport"></a>Imprimer un rapport
...
### Imprimer des rapports en thaïlandais
