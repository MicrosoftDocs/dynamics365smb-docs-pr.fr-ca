...
---
# <a name="run-and-print-reports-in-business-central"></a>Exécuter et imprimer des rapports
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Utilisation des valeurs par défaut – paramètres prédéfinis
...
## <a name="specify-the-data-to-include-in-a-report"></a>Définition des données à inclure dans un rapport
...
## <a name="preview-a-report"></a>Affichage de l'aperçu d'un rapport
...
## <a name="save-a-report-to-a-file"></a>Enregistrement d’un rapport dans un fichier
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Planification d’un rapport pour une exécution ultérieure ou périodique
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Impression d’un rapport
...
### <a name="print-reports-in-thai"></a>Impression de rapports en thaïlandais
