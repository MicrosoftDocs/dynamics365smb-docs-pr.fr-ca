...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Exécuter et imprimer des rapports
...
## <a name="specifying-the-data-to-include-in-a-report" />Définition des données à inclure dans un rapport
...
## <a name="previewing-a-report" />Affichage de l'aperçu d'un rapport
...
## <a name="saving-a-report-to-a-file" />Enregistrement d’un rapport dans un fichier
...
### <a name="manage-scheduled-recurring-reports" />Gérer les rapports récurrents programmés
...
### <a name="printing-reports-in-thai" />Impression de rapports en thaïlandais
...
## <a name="switching-the-report-layout" />Modifier la présentation du rapport
