...
Pour ouvrir la fenêtre **Configuration du modèle d'interaction**, choisissez l'icône ![Ampoule qui ouvre la fonction Tell Me](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Configuration du modèle d'interaction**, puis sélectionnez le lien associé.
