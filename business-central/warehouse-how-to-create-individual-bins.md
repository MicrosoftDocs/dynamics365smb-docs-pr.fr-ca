...
ms.author: edupont
---
# <a name="create-bins" />Créer zones
...
## <a name="to-create-a-bin-from-the-location-card" />Pour créer une zone à partir de la fiche emplacement
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Pour créer séparément des zones dans la feuille de création de zones
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Pour créer des zones automatiquement dans la feuille de création de zones
