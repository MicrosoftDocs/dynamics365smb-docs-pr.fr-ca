...
## <a name="lot-size-on-routing-lines" />Taille de lot sur les lignes itinéraire
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Tailles de lot pour les articles et les unités de stock
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Taille de lot pour les articles et les unités de stock
