...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Taille de lot sur les lignes itinéraire
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Tailles de lot pour les articles et les unités de stock
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Taille de lot pour les articles et les unités de stock
