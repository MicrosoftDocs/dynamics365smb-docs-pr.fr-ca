...
## <a name="default-synchronization-job-queue-entries"></a><a name="default-synchronization-job-queue-entries"></a>Écritures de file d’attente des travaux de synchronisation par défaut
