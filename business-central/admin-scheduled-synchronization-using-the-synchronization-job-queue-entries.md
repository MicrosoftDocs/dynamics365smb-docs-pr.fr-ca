...
|Projet de synchronisation FACTVENTEVALIDEES-FACT - Dynamics 365 for Sales|Permet de synchroniser les factures [!INCLUDE[crm_md](includes/crm_md.md)] avec les factures vente [!INCLUDE[d365fin](includes/d365fin_md.md)] reportées.|De [!INCLUDE[crm_md](includes/crm_md.md)] vers [!INCLUDE[d365fin](includes/d365fin_md.md)]|FACTURES - FACTURES VENTE REPORTÉES|
