...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Déterminer la quantité en inventaire à convertir de l'article d'origine vers le nouvel article
...
### <a name="transfer-the-inventory-to-the-new-item" />Transférer l'inventaire vers le nouvel article
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Gérer les quantités d'inventaire affectées à la demande
