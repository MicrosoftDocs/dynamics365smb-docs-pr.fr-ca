...
## <a name="creatinge-contact-companies"></a>Création de compagnies contact
...
Avant de créer un contact, vous pouvez vérifier les paramètres sur la page **Configuration du marketing**. Pour plus d'informations, voir [Paramétrage de la Gestion des relations](marketing-setup-marketing.md).

### <a name="to-create-a-company-contact-from-scratch"></a>Pour créer un contact compagnie à partir de zéro
