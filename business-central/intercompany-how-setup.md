...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Mapper le plan comptable intercompagnie au plan comptable de votre compagnie
...
## <a name="set-up-intercompany-dimensions" />Configurer des dimensions intercompagnies
...
### <a name="import-or-export-intercompany-dimensions" />Importer ou exporter les dimensions intercompagnies
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Mapper les dimensions intercompagnies aux dimensions de votre compagnie
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Configurer les modèles et lots de journal intercompagnies
...
## <a name="set-up-a-company-for-intercompany-transactions" />Configurer une compagnie pour les transactions intercompagnies
...
## <a name="set-up-intercompany-partners" />Paramétrer les partenaires intercompagnies
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Configurer les paramètres intercompagnies en tant que clients et fournisseurs
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Configurer des compte GL par défaut des partenaires intercompagnies
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Accepter automatiquement les transactions des partenaires intercompagnies
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Spécifier les comptes bancaires à utiliser pour les partenaires intercompagnies
