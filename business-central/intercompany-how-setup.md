...
ms.author: edupont
---
# Configurer le report des transactions intercompagnies
...
La 1re vague de lancement 2022 a introduit une nouvelle page **Configuration intercompagnie** qui permet d’accélérer le traitement des transactions de vos partenaires intercompagnies. La page permet de spécifier si cette compagnie crée automatiquement des lignes journal basées sur les reports d’un partenaire intercompagnie à partir de la page **Journal général IC**. Les lignes journal sont créées pour vous, mais ne sont pas reportées. Vous pouvez utiliser les champs suivants sur la nouvelle page Configuration intersociétés pour spécifier où créer les transactions de journal intersociétés reçues :
...
## Pour configurer une compagnie pour les transactions intercompagnies
...
## Pour paramétrer les partenaires intercompagnies
...
Si le plan comptable de votre compagnie définit le plan comptable intercompagnie de vos compagnies partenaires, suivez la procédure décrite dans [Pour configurer la définition du plan comptable intercompagnie](intercompany-how-setup.md#to-set-up-the-intercompany-chart-of-accounts).  
...
### Pour associer le plan comptable intercompagnies au plan comptable de votre compagnie  
...
## Pour configurer des dimensions intercompagnies
...
### Pour définir les dimensions intercompagnies
...
### Pour importer les dimensions intercompagnies  
...
### Pour associer les dimensions intercompagnies aux dimensions de votre compagnie
