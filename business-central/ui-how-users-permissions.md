...
|Mettez à jour l’utilisateur en fonction des informations dans Microsoft 365 : Province, Nom complet, Courriel du contact, Courriel d’authentification.<!--<br /><br />Codeunit "Azure AD   Graph User".UpdateUserFromAzureGraph-->|**X**|**X**|**X**|**X**||**X**|
