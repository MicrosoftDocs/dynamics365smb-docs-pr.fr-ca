...
|Mettez à jour l’utilisateur en fonction des informations dans Microsoft 365 : État, Nom complet, Courriel du contact, Adresse de courriel d’authentification.<!--<br /><br />Codeunit "Azure AD   Graph User".UpdateUserFromAzureGraph-->|**X**|**X**|**X**|**X**||**X**|
