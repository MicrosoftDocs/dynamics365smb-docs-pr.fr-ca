...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Procédure pas à pas : Configuration et utilisation d'un flux d'approbation achat
...
### <a name="set-up-approval-users"></a>Configuration des utilisateurs approbation
...
### <a name="set-up-notifications"></a>Configuration des notifications
...
## <a name="create-the-approval-workflow"></a>Création d’un flux de travail d’approbation
