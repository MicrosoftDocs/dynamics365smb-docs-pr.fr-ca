...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Pour créer et activer un flux de travail d'approbation des bons de commande
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Pour demander l'approbation d'un bon de commande en tant qu'Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />Pour approuver le bon de commande en tant que Sean
