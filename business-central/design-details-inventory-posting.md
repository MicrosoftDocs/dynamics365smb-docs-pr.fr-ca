...
ms.author: edupont
---
# <a name="design-details-inventory-posting" />Détails de conception : report inventaire
...
## <a name="assembly-and-production-posting" />Report d'assemblage et de production
