...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Détails de conception : report inventaire
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Écritures article (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Écritures affectation article (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Écritures article (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Écritures affectation article (2)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Écritures de grand livre (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Liens écritures dans le grand livre – Table liens grand livre article (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Report d'assemblage et de production
