...
> [!IMPORTANT]
> Cet article décrit les fonctionnalités qui seront disponibles dans la 2e vague de la version 2022. Tant que cette version n’est pas disponible, vous ne pouvez pas utiliser un flux Power Automate pour être alerté lorsqu’une entité dans Dataverse est modifiée.
