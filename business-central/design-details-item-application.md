...
ms.author: edupont
---
# <a name="design-details-item-application" />Détails de conception : affectation article
...
## <a name="inventory-increase" />Augmentation d'inventaire
...
## <a name="inventory-decrease" />Diminution d'inventaire
...
## <a name="fixed-application" />Affectation fixe
...
### <a name="example--fixed-application-in-purchase-return" />Exemple – affectation fixe dans le retour achat
...
### <a name="example--fixed-application-with-average-cost" />Exemple – affectation fixe avec le coût moyen
...
### <a name="example--fixed-application-in-sales-return" />Exemple – affectation fixe dans le retour vente
...
## <a name="reapplication" />Nouvelle affectation
