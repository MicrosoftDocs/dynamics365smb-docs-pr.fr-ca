...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Détails de conception : affectation article
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Augmentation d'inventaire
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Diminution d'inventaire
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Affectation fixe
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Exemple – affectation fixe dans le retour achat
...
2. Dans la séquence 2, l'utilisateur reporte un achat à un coût de 20,00 $.  
3. Dans la séquence 3, l'utilisateur valide un retour achat. L'utilisateur effectue une affectation fixe au second achat en saisissant le numéro d'écriture article dans le champ **Écr. article à affecter** sur la ligne retour achat.  
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Exemple – affectation fixe avec le coût moyen
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Exemple – affectation fixe dans le retour vente
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Nouvelle affectation
