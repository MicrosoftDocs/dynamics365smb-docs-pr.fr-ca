---
title: Utilisation de l’extension Prévision des ventes et de l'inventaire pour gérer l'inventaire | Microsoft Docs
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts"></a>Créer et utiliser votre propre service web prévisionnel pour les prévisions de l'inventaire et les ventes prévues
