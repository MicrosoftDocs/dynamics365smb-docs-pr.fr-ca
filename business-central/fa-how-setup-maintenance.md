...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Configurer l'entretien d'une immobilisation
...
## <a name="to-set-up-general-maintenance-information" />Pour configurer les informations générales d'entretien
...
## <a name="to-set-up-maintenance-codes" />Pour configurer des codes entretien
...
## <a name="to-set-up-maintenance-expense-accounts" />Pour configurer des comptes frais d'entretien
