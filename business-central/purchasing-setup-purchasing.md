...
## <a name="purchases-and-payables-setup"></a><a name="purchases-and-payables-setup"></a>Configuration achats
...
### <a name="number-series-settings"></a><a name="number-series-settings"></a>Paramètres de séries de numéros
