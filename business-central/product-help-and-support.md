...
description: 'Découvrez comment obtenir de l’aide et du support pour Business Central, notamment une discussion avec Copilot, des conseils sur le produit, le volet d’aide, la page Aide et support, la documentation produit et les forums communautaires.'
author: brentholtorf
ms.author: bholtorf
...
## <a name="chat-with-copilot"></a>Conversation instantanée avec Copilot

[!INCLUDE [online_only](includes/online_only.md)]

Conversation instantanée avec Copilot est un outil basé sur l’IA qui répond aux questions et recherche des données commerciales liées à Business Central. Il est disponible pour vous à partir de n’importe quelle page en sélectionnant l’icône ![Affiche l’icône pour discuter avec Copilot](media/chat-copilot-icon.png) **Copilot** dans le coin supérieur droit. [En savoir plus sur la discussion instantanée avec Copilot](chat-with-copilot.md).

### <a name="help-with-fields"></a>Aide avec les champs

Copilot vous aide à comprendre le but et l’utilisation typique des champs individuels. Lorsque vous choisissez **Demander à Copilot** dans une info-bulle pour un champ, le chat s’ouvre avec une invite d’explication pour le nom du champ et Copilot fournit des informations à ce sujet. Copilot renvoie aux articles référencés, il vous est donc facile de vérifier la description.
...
- Utilisez le raccourci clavier <kbd>Ctrl</kbd>+<kbd>F1</kbd> où que vous soyez dans Business Central.
...
Nous discutons des nouvelles fonctionnalités sur le [blog de Dynamics 365](https://www.microsoft.com/en-us/dynamics-365/blog/business-leader/product/dynamics-365-business-central/), notamment les considérations particulières.  
...
> [!NOTE]
> Avec [!INCLUDE[prod_short](includes/prod_short.md)] en ligne, la section **Signaler un problème** n’est disponible que si vous avez payé un abonnement [!INCLUDE[prod_short](includes/prod_short.md)]. Si vous vous êtes inscrit pour une évaluation et que vous n’avez pas encore acheté [!INCLUDE[prod_short](includes/prod_short.md)], vous n’avez pas de partenaire revendeur, et vous ne pouvez pas contacter l’équipe de support technique Microsoft. Vous pouvez rechercher un partenaire [!INCLUDE[prod_short](includes/prod_short.md)] sur la page [Je recherche un fournisseur de solution](https://go.microsoft.com/fwlink/?linkid=2038145). Pour plus d’informations, voir [Comment trouver un partenaire revendeur ?](/dynamics365/business-central/across-faq#how-do-i-find-a-reselling-partner).  
>
...
Pour alerter votre partenaire en cas de problème, choisissez le lien pour envoyer un courriel ou ouvrir son site de support dans un nouvel onglet de navigateur. Vous pouvez ensuite ajouter les informations techniques sur votre abonné Microsoft Entra à partir de la section **Dépannage** et toute autre information que vous trouvez pertinente.  
...
### <a name="find-other-content"></a>Trouver un autre contenu
...
- Utiliser le champ **Rechercher** dans le coin supérieur droit du site web
  ...
  De cette façon, vous pouvez rechercher n'importe quel terme. Le site recherche alors tout le contenu pour ce terme ou cette expression. Recherchez *facture* à nouveau et faites défiler la liste des centaines d'articles dans le contenu [!INCLUDE [prod_short](includes/prod_short.md)] qui utilise ce mot quelque part dans le texte.  
...
### <a name="navigate-to-other-parts-of-the-site"></a>Naviguer vers d’autres parties du site
