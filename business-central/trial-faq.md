...
L'essai comprend des exemples de données. Si vous voulez essayer Business Central avec vos propres données, vous pouvez opter pour un essai gratuit de 30 jours avec une compagnie vide. Pour plus d'informations, voir [[!INCLUDE[prod_long](includes/prod_long.md)]Essais et abonnements](across-preview.md).  
