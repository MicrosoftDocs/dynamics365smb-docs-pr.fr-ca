...
1.  Choisissez l'icône ![Page ou rapport pour la recherche](media/ui-search/search_small.png "icône Page ou rapport pour la recherche"), entrez **Rangements entrepôt**, **Prélèvements entrepôt** ou **Mouvement entrepôt**, puis sélectionnez le lien associé.

    Les trois fenêtres affichent les affectations pour l'ensemble des emplacements entrepôt.  

2. Triez les articles par emplacement. Vous pouvez maintenant visualiser les instructions qui vous ont été affectées.  
