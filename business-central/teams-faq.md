...
### <a name="does-the-app-work-with-multiple-companies-and-environments" />L’application fonctionne-t-elle avec plusieurs compagnies et environnements?
...
### <a name="can-i-switch-companies-within-a-tab" />Puis-je changer de compagnie dans un onglet?
...
### <a name="do-search-results-include-companies-and-persons" />Les résultats de recherche incluent-ils des compagnies et des personnes?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company" />Comment puis-je rechercher des contacts stockés dans une autre compagnie?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to" />Comment savoir à quelle compagnie appartient une carte dans Teams?
...
### <a name="does-share-to-teams-send-a-compact-card" />Est-ce que Partager avec Teams envoie une fiche compacte?
