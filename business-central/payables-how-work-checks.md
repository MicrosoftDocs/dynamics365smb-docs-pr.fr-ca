...
---
# <a name="make-check-payments"></a>Exécution des paiements par chèque
...
- **Manuel** : sélectionnez cette option si vous avez créé un chèque manuellement et que vous souhaitez créer une écriture comptable chèque correspondante de ce montant. En utilisant cette option, vous ne pouvez pas imprimer le chèque.
...
## <a name="to-cancel-printed-checks-that-arent-posted"></a>Pour les chèques imprimés Annuler qui ne sont pas enregistrés
