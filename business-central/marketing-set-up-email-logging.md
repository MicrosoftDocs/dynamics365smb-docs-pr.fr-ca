...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Suivre les échanges de courriels entre les représentants et les contacts
...
### <a name="allow-other-users-to-see-logged-emails" />Autoriser les autres utilisateurs à voir les courriels enregistrés
...
## <a name="set-up-includeprodshortincludesprodshortmd-to-log-email-messages" />Configurer [!INCLUDE[prod_short](includes/prod_short.md)] pour enregistrer les courriels
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />Affichage des échanges de courriels dans le journal des interactions
