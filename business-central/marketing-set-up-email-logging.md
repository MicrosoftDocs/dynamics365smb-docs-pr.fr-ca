...
## <a name="setting-up-prod_short-to-log-email-messages"></a>Configuration de [!INCLUDE[prod_short](includes/prod_short.md)] pour enregistrer les courriels
