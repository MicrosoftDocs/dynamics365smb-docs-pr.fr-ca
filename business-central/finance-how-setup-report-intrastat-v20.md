...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Configurer et enregistrer un rapport Intrastat
...
### <a name="to-set-up-intrastat-templates-and-batches" />Pour configurer des modèles et des lots Intrastat
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Pour configurer les champs de la déclaration Intrastat obligatoires
...
## <a name="to-report-intrastat" />Pour soumettre un rapport Intrastat
...
### <a name="to-modify-intrastat-journals-lines" />Pour modifier les lignes des journaux Intrastat
...
### <a name="report-intrastat-on-a-form-or-a-file" />Rapport Intrastat sur un formulaire ou un fichier
...
### <a name="report-intrastat-in-a-file" />Rapport Intrastat dans un fichier
...
## <a name="reorganize-intrastat-journals" />Réorganiser les journaux Intrastat
