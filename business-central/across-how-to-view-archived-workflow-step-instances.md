...
ms.author: edupont
---
# <a name="view-archived-workflow-step-instances" />Afficher des instances d'étape de workflow archivées
...
## <a name="to-view-archived-workflow-step-instances" />Pour afficher des instances d'étape de workflow archivées
