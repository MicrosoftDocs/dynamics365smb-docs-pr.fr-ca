...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Pour configurer le mandat de prélèvement qui représente l'entente client
...
## <a name="posting-sepa-direct-debit-payment-receipts" />Report des réceptions règlement de prélèvement SEPA
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Pour reporter une réception de paiement de prélèvement à partir de la page Recouvrement prélèvement
