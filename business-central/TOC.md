...
#### [Procédure pas à pas : calculer les travaux en cours pour un projet](walkthrough-calculating-work-in-process-for-a-job.md)
#### [Procédure pas à pas : prélèvement et livraison dans les configurations d’entrepôt de base](walkthrough-picking-and-shipping-in-basic-warehousing.md)
...
##### [Créer un itinéraire](contoso-coffee/manufacturing/create-new-routing.md)
...
#### Détails de conception : évaluation des coûts de l’inventaire
...
#### [Définir la disposition utilisée par un rapport](ui-set-report-layout.md)
...
##### [Créer et modifier des dispositions de rapport personnalisées](ui-how-create-custom-report-layout.md)
...
#### Affecter des paiements automatiquement et rapprocher des comptes bancaires
...
#### [Consolider les soldes d’une compagnie à la fois cliente et fournisseur](finance-consolidate-customer-vendor-balances.md)
...
#### [Transférer et reporter des écritures de coûts](finance-transfer-and-post-cost-entries.md)
...
### Gérer les coûts de l’inventaire
#### [Vue d’ensemble du coût de l’inventaire](finance-manage-inventory-costs.md)
#### [À propos des coûts de l’inventaire](finance-learn-about-costing.md)
#### [Utilisation des frais annexes pour comptabiliser les coûts commerciaux supplémentaires](payables-how-assign-item-charges.md)
...
#### [Détails de conception : coûts de l’inventaire](design-details-inventory-costing.md)
...
#### [Fermer les écritures article ouvertes qui résultent d’une affectation fixe dans le journal d’articles](finance-how-to-close-open-item-ledger-entries-resulting-from-fixed-application-in-the-item-journal.md)
#### Générer des rapports sur les coûts et effectuer des rapprochements avec le grand livre
...
#### [Ajuster et rapprocher le coût de l’inventaire avec le grand livre avec la file d’attente des projets](finance-adjust-reconcile-inventory-cost-job-queue.md)

### Gestion de la trésorerie
#### [Vue d’ensemble de la trésorerie](finance-cash-flow-overview.md)
#### [Analyser les trésoreries dans votre compagnie](finance-analyze-cash-flow.md)
#### [Procédure pas-à-pas : utiliser des rapports financiers pour créer des prévisions de la trésorerie](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)
...
#### [Aperçu des tâches de fermeture des périodes comptables](year-how-complete-period-end-processes.md)
...
#### [Vue d’ensemble des dimensions](finance-dimensions.md)
#### [Dépanner et corriger des dimensions](finance-troubleshooting-correcting-dimensions.md)
...
##### [Configuration de groupe de report](finance-posting-groups.md#tax-posting-groups)
...
#### [Envoyer des rapports TVA aux autorités fiscales](finance-how-report-vat.md)
...
#### [Rapports comptabilité client intégrés](receivables-reports.md)
...
### Analyses de l’inventaire 
#### [Présentation des analyses de l’inventaire](inventory-analytics-overview.md)
#### [Analyse ad hoc des données inventaire](ad-hoc-analysis-inventory.md)
...
### [Utiliser des journaux pour comptabiliser, ajuster et reclasser l’inventaire](inventory-how-count-adjust-reclassify.md)
...
### [Enregistrer l’utilisation pour le projet](projects-how-record-job-usage.md)
...
### [Exécution d’une planification complète, d’une MPS ou d’une MRP](production-how-to-run-mps-and-mrp.md)
...
#### [Ranger des articles avec les rangements inventaire](warehouse-how-to-put-items-away-with-inventory-put-aways.md)
...
##### [Faire l’inventaire et l′ajuster à l’aide de documents](inventory-how-count-inventory-with-documents.md)
##### [Faire, ajuster et reclasser l’inventaire](inventory-how-count-adjust-reclassify.md)
...
### [Synchroniser des articles et l’inventaire avec Shopify](shopify/synchronize-items.md)
### [Synchroniser les clients et les compagnies avec Shopify](shopify/synchronize-customers.md)
### [Synchroniser et remplir les documents de vente avec Shopify](shopify/synchronize-orders.md)
...
### [Automatiser la synchronisation Shopify à l’aide de la file d’attente des projets](shopify/background.md)
...
##### [Imprimer des rapports de rapprochement de compte bancaire](LocalFunctionality/Australia/how-to-print-bank-account-reconciliation-reports.md)
...
##### [Imprimer des rapports de bilan](LocalFunctionality/Australia/how-to-print-balance-sheet-reports.md)
...
#### Banque et paiements
##### [Imprimer des rapports contenant les listes de paiements fournisseur](LocalFunctionality/Austria/how-to-print-vendor-payments-list-reports.md)
#### Achats
...
##### [Rapports Intrastat belges](LocalFunctionality/Belgium/belgian-intrastat-reporting.md)
...
##### [Transférer et reporter automatiquement des relevés CODA](LocalFunctionality/Belgium/how-to-automatically-transfer-and-post-coda-statements.md)
...
##### [Désigner des modèles journal comme obligatoires](LocalFunctionality/Belgium/specify-journal-template-mandatory.md)
##### [Échelonnements dans les rapports du grand livre des ventes et des achats](LocalFunctionality/Belgium/how-to-use-deferrals.md)
...
#### Général
##### [Imprimer des rapports de dépannage](LocalFunctionality/Canada/how-to-print-troubleshooting-reports.md)
...
#### Finances de base  
##### [Report de correction (Red Storno)](LocalFunctionality/Czech/how-to-use-corrections-posting.md)
##### [Informations statutaires sur la compagnie](LocalFunctionality/Czech/statutory-company-information.md)
...
##### [Fonctionnalité de tableaux d’analyse](LocalFunctionality/Czech/how-to-use-accounting-schedule-feature.md)
...
##### [Relevé fiscal](LocalFunctionality/Czech/vat-statement.md)
##### [Relevé fiscal supplémentaire](LocalFunctionality/Czech/supplementary-vat-statement.md)
...
##### [Configurer et reporter des frais inversés](LocalFunctionality/Czech/how-to-setup-and-post-reverse-charge.md)
##### [Rapport de contrôle de la TVA](LocalFunctionality/Czech/vat-control-report.md)
##### [Rapports TVA](LocalFunctionality/Czech/vat-reports-cz.md)
##### [Correction TVA en devise locale](LocalFunctionality/Czech/how-to-setup-vat-correction-local-currency.md)
##### [Intrastat](LocalFunctionality/Czech/intrastat.md)
##### [Intrastat pour le tchèque (extension)](LocalFunctionality/Czech/ui-extensions-intrastat-localization-cz.md)
#### Immobilisations
...
#### Inventaire
##### [Arrondir la comptabilité dans l’inventaire](LocalFunctionality/Czech/how-to-setup-round-account-in-inventory.md)
##### [Améliorations du rapprochement du grand livre inventaire](LocalFunctionality/Czech/how-to-use-inventory-gl-reconciliation-enhancements.md)
...
##### [Document sur les opérations d’inventaire](LocalFunctionality/Czech/how-to-use-inventory-operations-document.md)
##### [Groupes de report dans les ordres de transfert](LocalFunctionality/Czech/how-to-use-posting-groups-in-transfer-orders.md)
#### Général
##### [Contrôle utilisateur étendu](LocalFunctionality/Czech/general.md)
##### [Contrôle des modifications du groupe de report](LocalFunctionality/Czech/check-of-posting-group-changing.md)
...
##### [Modèles de mouvement d’inventaire](LocalFunctionality/Czech/inventory-movement-templates.md)
...
##### [Groupe de report marché par défaut dans la fabrication](LocalFunctionality/Czech/how-to-setup-default-bus-post-group-manufacturing.md)
##### [Groupe de report marché par défaut dans les ordres d’assemblage](LocalFunctionality/Czech/how-to-setup-default-bus-post-group-assembly-orders.md)
##### [Création automatique et mise à jour de dimensions](LocalFunctionality/Czech/how-to-setup-automatic-creation-and-update-dimensions.md)
##### [Ajout de champs dans les écritures articles](LocalFunctionality/Czech/how-to-use-add-fields-item-entries.md)
##### [Groupe de report de production générale dans l’unité de stock](LocalFunctionality/Czech/how-to-setup-gen-prod-posting-group-from-sku.md)
##### [Ignorer la mise à jour pour l’unité de stock au moment du report](LocalFunctionality/Czech/how-to-setup-skip-update-sku-on-posting.md)
...
##### [Affecter des écritures du grand livre](LocalFunctionality/France/how-to-apply-general-ledger-entries.md)
...
#### Banque et paiements
##### [Imprimer des rapports contenant les listes de paiements fournisseur](LocalFunctionality/Germany/how-to-print-vendor-payments-list-reports.md)
#### Finances de base
...
##### [Affecter des codes de rappel de livraison à des fournisseurs](LocalFunctionality/Germany/how-to-assign-delivery-reminder-codes-to-vendors.md)
...
###### [TPS sur Kerala Flood Cess](LocalFunctionality/India/GST-and-Kerala-Flood-Cess-on-Sales.md)
...
##### TPS TDS/TCS
###### [Vue d’ensemble de TPS TDS TCS](LocalFunctionality/India/GST-TDS-TCS-Overview.md)
...
##### Distribution du service de la saisie de la TPS
###### [Vue d’ensemble de la distribution du service de la saisie de la TPS](LocalFunctionality/India/GST-Input-Service-Distribution-Overview.md)
...
###### [Transaction de la distribution du service de la saisie de la TPS](LocalFunctionality/India/GST-Input-Service-Distribution-Transaction.md)
#### TDS
...
##### [Scénario de paiement 3 - Paiement étranger ($ en devise étrangère)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
...
##### [Entrer et reporter les journaux de trésorerie et opérations bancaires ou les journaux de virement](LocalFunctionality/Netherlands/how-to-enter-and-post-cash-and-bank-or-giro-journals.md)
...
##### [Calculer la taxe sur les biens et services pour les paiements anticipés](LocalFunctionality/NewZealand/how-to-calculate-goods-and-services-tax-on-prepayments.md)
##### [Imprimer des rapports de règlement de la taxe sur les biens et services](LocalFunctionality/NewZealand/how-to-print-goods-and-service-tax-settlement-reports.md)
#### Banque et paiements
...
##### [Imprimer des rapports de bordereau de versement](LocalFunctionality/NewZealand/how-to-print-deposit-slip-reports.md)
##### [Imprimer des rapports de rapprochement de compte bancaire](LocalFunctionality/NewZealand/how-to-print-bank-account-reconciliation-reports.md)
#### Finances de base
##### [Calcul des montants de la distribution](LocalFunctionality/NewZealand/calculating-distribution-amounts.md)
##### [Imprimer des rapports de bilan](LocalFunctionality/NewZealand/how-to-print-balance-sheet-reports.md)
##### [Imprimer des états des résultats](LocalFunctionality/NewZealand/how-to-print-income-statements.md)
#### Général
...
##### [Rapports TVA norvégiens](LocalFunctionality/Norway/norwegian-vat-reporting.md)
...
##### [Imprimer un rapport sur le rapprochement TVA](LocalFunctionality/Norway/how-to-print-a-vat-reconciliation-report.md)
#### Banque et paiements
...
##### [Configurer des ententes de remise](LocalFunctionality/Norway/how-to-set-up-remittance-agreements.md)  
...
##### [Importer et reporter des paiements OCR](LocalFunctionality/Norway/how-to-import-and-post-ocr-payments.md)
##### [Imprimer un rapport de test sur le journal OCR](LocalFunctionality/Norway/how-to-print-the-ocr-journal-test-report.md)  
#### Finances de base
##### [Affecter des écritures du grand livre dans des périodes fermées](LocalFunctionality/Norway/how-to-apply-general-ledger-entries-in-closed-periods.md)  
#### Général
...
##### [Configurer des groupes récurrents](LocalFunctionality/Norway/how-to-set-up-recurring-groups.md)  
##### [Configurer des commandes récurrentes](LocalFunctionality/Norway/how-to-set-up-recurring-orders.md)
...
#### Finances de base
##### [Vue d’ensemble des rapports financiers](LocalFunctionality/Russia/account-schedules-overview.md)
##### [Importer et exporter des rapports financiers](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
##### [Définir une extension de rapport financier](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
##### [Définir une constante de rapport financier](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
##### [Utiliser des rapports financiers](LocalFunctionality/Russia/How-to-Work-with-Account-Schedules.md)
##### [Correspondance du grand livre](LocalFunctionality/Russia/general-ledger-correspondence.md)
...
##### [Configurer des paiements anticipés client](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Configurer des paiements anticipés fournisseur](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
##### [Reporter des paiements anticipés fournisseur et client](LocalFunctionality/Russia/prepayments-vendor-and-customers.md)
##### [Différences de paiement anticipé](LocalFunctionality/Russia/prepayment-differences-invoices-prepayment-differences.md)
##### [Configurer des ententes client et fournisseur](LocalFunctionality/Russia/how-to-set-up-customer-and-vendor-agreements.md)
#### Immobilisations
...
##### [Afficher les entrées reportées sur des frais d’immobilisation](LocalFunctionality/Russia/How-to-View-Posted-Entries-on-a-Fixed-Asset-Charge.md)
...
##### [Préparer et reporter des écritures TVA](LocalFunctionality/Russia/How-to-Prepare-VAT-Entries-for-Posting.md)  
##### [Relevé de TVA](LocalFunctionality/Russia/Settlement-VAT.md)  
...
##### [TVA par paiement anticipé client](LocalFunctionality/Russia/VAT-by-Customer-prepayments.md)  
...
#### Inventaire
##### [Inventaire dans la version russe](LocalFunctionality/Russia/Inventory.md)
##### [Configurer l’inventaire](LocalFunctionality/Russia/Inventory-Setup.md)
...
##### [Rotation du grand livre articles](LocalFunctionality/Russia/Item-General-Ledger-Turnover.md)
##### [Créer le rapport sur les marchandises TORG-29](LocalFunctionality/Russia/How-to-Create-the-TORG-29-Goods-Report.md)
...
#### TVA
##### [Rapports TVA](LocalFunctionality/Spain/vat-reports.md)
##### [Rapport 340](LocalFunctionality/Spain/report-340.md)  
##### [Créer un rapport 340](LocalFunctionality/Spain/how-to-create-report-340.md)  
##### [Rapport 347](LocalFunctionality/Spain/report-347.md)  
##### [Créer un rapport 347](LocalFunctionality/Spain/how-to-create-report-347.md)  
##### [Rapport 349](LocalFunctionality/Spain/report-349.md)  
##### [Créer un rapport 349](LocalFunctionality/Spain/how-to-create-report-349.md)  
##### [Configurer des rapports 340 pour les petites entreprises](LocalFunctionality/Spain/how-to-set-up-340-reports-for-small-businesses.md)
##### [Configurer SII pour les rapports TVA](LocalFunctionality/Spain/sii-setup.md)
##### [Créer des modèles pour des relevés fiscaux télématiques au format de fichier texte](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-text-file-format.md)
##### [Créer des modèles pour des relevés fiscaux télématiques au format de fichier XML](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-xml-file-format.md)
##### [Exporter des relevés fiscaux au format XML](LocalFunctionality/Spain/how-to-export-vat-statements-in-xml-format.md)  
##### [Exporter des relevés fiscaux au format texte](LocalFunctionality/Spain/how-to-export-vat-statements-in-text-format.md)
...
##### [SII – Types Facture et Note de crédit dans des documents vente et achat](LocalFunctionality/Spain/SII-invoice-types-sales-purchase-documents.md)
#### Finances de base
##### [Configurer et fermer les soldes d’état des résultats](LocalFunctionality/Spain/how-to-set-up-and-close-income-statement-balances.md)
##### [Décaler et valider des plans comptables](LocalFunctionality/Spain/how-to-indent-and-validate-chart-of-accounts.md)
##### [Ignorer des escomptes dans les comptes du grand livre](LocalFunctionality/Spain/how-to-ignore-discounts-in-general-ledger-accounts.md)
##### [Exporter des rapports financiers au format ASC](LocalFunctionality/Spain/how-to-export-account-schedules-to-asc-format.md)
##### [Imprimer des rapports de livre comptable](LocalFunctionality/Spain/how-to-print-account-book-reports.md)
...
##### [Imprimer et reporter toutes les transactions pour une période](LocalFunctionality/Spain/how-to-post-and-print-all-transactions-for-a-period.md)
#### Général
##### [Factures de correction](LocalFunctionality/Spain/corrective-invoices.md)
...
##### [Configurer des groupes de report de compte automatique](LocalFunctionality/Sweden/how-to-set-up-automatic-account-posting-groups.md)
...
##### [Imprimer des rapports de bilan et d’état des résultats](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  

### Suisse
#### [Fonctionnalité locale dans la version suisse](LocalFunctionality/Switzerland/switzerland-local-functionality.md)
#### TVA
##### [Créer et imprimer un relevé fiscal suisse](LocalFunctionality/Switzerland/how-to-create-and-print-a-swiss-vat-statement.md)
##### [Imprimer des relevés fiscaux suisses (anciennes versions)](LocalFunctionality/Switzerland/how-to-print-swiss-vat-statements-older-version-.md)
...
##### [Reporter des paiements LSV](LocalFunctionality/Switzerland/how-to-post-lsv-payments.md)
##### [Fermer un recouvrement LSV](LocalFunctionality/Switzerland/how-to-close-an-lsv-collection.md)
...
##### [Imprimer des rapports contenant les listes de paiements fournisseur](LocalFunctionality/Switzerland/how-to-print-vendor-payments-list-reports.md)
#### Finances de base
##### [Comptes du grand livre suisses](LocalFunctionality/Switzerland/swiss-general-ledger-accounts.md)
...
##### [Afficher les soldes temporaires dans les journaux du grand livre](LocalFunctionality/Switzerland/how-to-view-temporary-balances-in-general-ledger-journals.md)
##### [Imprimer des informations de configuration du grand livre](LocalFunctionality/Switzerland/how-to-print-general-ledger-setup-information.md)
#### Achats
##### [Rappels de livraison](LocalFunctionality/Switzerland/delivery-reminders.md)
##### [Configurer des rappels de livraison](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminders.md)
##### [Configurer des modalités, des niveaux et des textes de rappel de livraison](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminder-terms-levels-and-text.md)
...
##### [Créer manuellement des rappels de livraison](LocalFunctionality/Switzerland/how-to-create-delivery-reminders-manually.md)
##### [Émettre des rappels de livraison](LocalFunctionality/Switzerland/how-to-issue-delivery-reminders.md)
##### [Générer des rappels de livraison](LocalFunctionality/Switzerland/how-to-generate-delivery-reminders.md)
##### [Imprimer des rapports de test pour les rappels de livraison](LocalFunctionality/Switzerland/how-to-print-test-reports-for-delivery-reminders.md)
#### Inventaire
##### [Gestion de l’inventaire suisse](LocalFunctionality/Switzerland/swiss-inventory-management.md)
##### [Imprimer la liste des prélèvements inventaire d’un document de vente](LocalFunctionality/Switzerland/how-to-print-an-inventory-picking-list-from-a-sales-order.md)
#### Général
##### [Importer des codes postaux suisses](LocalFunctionality/Switzerland/how-to-import-swiss-post-codes.md)
...
##### [Modifier la configuration de la TVA des journaux](LocalFunctionality/UnitedKingdom/how-to-change-vat-setup-in-journals.md)
##### [Imprimer des rapports d’audit de TVA](LocalFunctionality/UnitedKingdom/how-to-print-vat-audit-reports.md)
##### [Imprimer des rapports TVA](LocalFunctionality/UnitedKingdom/how-to-print-vat-reports.md)
##### [Configurer des frais inversés sur la TVA](LocalFunctionality/UnitedKingdom/how-to-set-up-reverse-charges-on-vat.md)
#### Banque et paiements
...
#### Général
##### [Configurer un avertissement de date de report](LocalFunctionality/UnitedKingdom/how-to-set-up-a-posting-date-warning.md)
...
##### [Déclaration de la taxe de vente aux États-Unis](LocalFunctionality/UnitedStates/us-sales-tax.md)
...
##### [Configurer et utiliser le formulaire IRS 1099 pour la version 24 (1re vague de lancement 2024)](LocalFunctionality/UnitedStates/set-up-use-irs1099-form-v24.md)
#### [Utilisation des formulaires IRS 1099](LocalFunctionality/UnitedStates/how-to-1099-use.md)
#### [Soumettre et déclarer les formulaires IRS 1099](LocalFunctionality/UnitedStates/how-to-1099-report.md)       
...
##### [Configurer la taxe de service et la taxe d’achat](LocalFunctionality/UnitedStates/how-to-set-up-use-tax-and-purchase-tax.md)  
##### [Configurer des taxes de vente non réalisées et des escomptes de paiement de vente](LocalFunctionality/UnitedStates/how-to-set-up-unrealized-sales-tax-and-sales-payment-discounts.md)  
#### Banque et paiements
...
#### [Configurer des groupes de report](finance-posting-groups.md)
...
#### [Automatiser des rappels dans les collectes](finance-automate-reminders.md)
...
#### [Configurer des méthodes de calcul et de report pour la taxe sur la valeur ajoutée (TVA)](finance-setup-vat.md)
...
#### [Activer l’affectation d’écritures dans des devises différentes](finance-how-enable-application-ledger-entries-different-currencies.md)
...
#### [Configurer l’arrondissement facture](finance-set-up-invoice-rounding.md)
...
#### [Utiliser des clés d’affectation dans les journaux généraux](ui-how-use-allocation-keys-general-journals.md)
...
#### [Enregistrer des prix de vente spéciaux et des escomptes](sales-how-record-sales-price-discount-payment-agreements.md)
#### [Configuration des groupes prix client](sales-how-to-set-up-customer-price-groups.md)
#### [Configurer des groupes d’escomptes client](sales-how-to-set-up-customer-discount-groups.md)
...
#### [Configuration de la gestion des projets](projects-setup-projects.md)
...
#### [Configuration des projets](projects-how-setup-jobs.md)
...
#### [Configurer l’entretien des immobilisations](fa-how-setup-maintenance.md)
...
#### [Utiliser des unités de mesure de lot de fabrication](production-how-to-use-the-manufacturing-batch-unit-of-measure.md)
...
#### [Sélection des rapports pour les documents](across-report-selections.md)
...
##### [Partager des enregistrements et des liens de page dans Teams](across-working-with-teams.md)
##### [Modifier la compagnie et d′autres paramètres](across-teams-settings.md)
##### [FAQ sur Teams](teams-faq.md)
...
### [Créer des séries de numéros](ui-create-number-series.md)
...
#### [Imprimantes par courriel](admin-printer-setup-email.md)
#### [Spécification d’une imprimante par défaut](ui-specify-printer-selection-reports.md)
...
# Analyses, business intelligence et rapports 

## [Présentation des analyses](reports-bi-reporting.md)
## [Analyse par zone fonctionnelle](analytics-by-functional-area.md)

## KPI, tableaux de bord et rapports financiers
...
### [Suivi des KPI avec les mesures Power BI](track-kpis-with-power-bi-metrics.md)
### [Utilisation de Financial Reporting](bi-how-work-account-schedule.md)
...
### [Analyse ad hoc par zone fonctionnelle](ad-hoc-data-analysis-by-functional-area.md)

## Utiliser des rapports au quotidien
### [Vue d’ensemble](reports-use-reports.md)
### [Exécuter des rapports](ui-work-report.md)
### [Ajouter un signet à un rapport](ui-bookmarks.md)
### [Analyser des données de rapport avec Excel](report-analyze-excel.md)
### [Imprimer des rapports](ui-specify-printer-selection-reports.md#default)
### [Programmer des rapports](ui-work-report.md#ScheduleReport)
### [Partager et exporter des rapports avec la boîte de réception Rapport](ui-work-report-inbox.md)
### [Gérer des paramètres de rapports enregistrés](reports-saving-reusing-settings.md)
### [Définir la disposition utilisée par un rapport](ui-set-report-layout.md)
### [(Hérité) Définir la disposition utilisée par un rapport](ui-how-change-layout-currently-used-report.md)
...
### Projet
#### [Rapports de projet](project-reports.md)
#### [Afficher les estimations d’utilisation de projet](projects-how-record-job-usage.md#to-view-project-usage-estimates-and-post-updates)
#### [Surveillance de la progression et des performances du projet](projects-how-monitor-progress-performance.md)
...
#### [Afficher des écritures atelier](production-how-to-post-capacities.md#to-view-work-center-ledger-entries)
...
### [État des déclarations de confidentialité](privacy-notices-status.md)
...
#### [Extensions de la migration dans le nuage](ui-extensions-data-replication.md)
#### [Base de la migration dans le nuage](ui-extensions-intelligent-cloud.md)
...
### [Intégration à Microsoft Dynamics 365 Field Service](admin-integrate-field-service.md)
...
#### [Détails de conception : traçabilité dans l’entrepôt](design-details-item-tracking-in-the-warehouse.md)
### Détails de conception : ligne report de journal général
#### [Ligne report de journal général](design-details-general-journal-post-line.md)
#### [Vue d’ensemble de la ligne report de journal général](design-details-general-journal-post-line-overview.md)  
#### [Détails de conception : structure de l’interface de report](design-details-posting-interface-structure.md)  
#### [Détails de conception : structure du moteur de report](design-details-posting-engine-structure.md)  
### Détails de conception : écritures d’ensemble de dimensions
...
### [Gestion de la migration vers le nuage](/dynamics365/business-central/dev-itpro/administration/migration-manage?toc=/dynamics365/business-central/toc.json)
...
### [FAQ sur la migration vers le nuage](/dynamics365/business-central/dev-itpro/administration/faq-migrate-data?toc=/dynamics365/business-central/toc.json)
...
## [À propos de Copilot dans Business Central](copilot-overview.md)
...
## Assistance pour les analyses (version préliminaire)
...
## Suggestion de ligne vente (version préliminaire)
### [Suggérer des lignes sur les documents de vente avec Copilot](sales-suggest-sales-lines-with-copilot.md)
### [FAQ sur les suggestions de ligne vente de Copilot](faq-sales-suggest-sales-lines-with-copilot.md)
## Mappage de document électronique (version préliminaire)
### [Mappage de documents électroniques avec des lignes bon de commande avec Copilot](map-edocuments-with-copilot.md)
### [FAQ sur le mappage de documents électroniques avec des bons de commande à l’aide de Copilot](faqs-map-edocuments.md)
# IA responsable
## [Vue d’ensemble](responsible-ai-overview.md)
## [FAQ sur la sécurité et la confidentialité des données de Copilot](/dynamics365/faqs-copilot-data-security-privacy?toc=/dynamics365/business-central/toc.json)
## [FAQ sur l’assistance pour les analyses (version préliminaire)](faqs-analysis-assist.md)
## [FAQ pour l’aide au rapprochement bancaire (version préliminaire)](faqs-bank-reconciliation.md)
## [FAQ sur la conversation instantanée avec Copilot (version préliminaire)](faqs-chat-with-copilot.md)
## [FAQ pour les suggestions de texte marketing](faqs-marketing-text.md)
## [FAQ sur les suggestions de ligne vente de Copilot (version préliminaire)](faq-sales-suggest-sales-lines-with-copilot.md)
## [FAQ sur le mappage de documents électroniques avec des bons de commande à l’aide de Copilot (version préliminaire)](faqs-map-edocuments.md)
