...
### [Affichage de données de liste dans des rapports Power BI dans Business Central](across-how-use-powerbi-reports-factbox.md)
...
### [Dépannage pour l'intégration avec Microsoft Flow- URL de demande trop longue](across-troubleshooting-how-use-financials-data-source-flow.md)
...
### [Nuage intelligent](ui-extensions-intelligent-cloud.md)
...
### [Créer des packages de configuration de compagnie personnalisés](admin-how-to-create-custom-company-configuration-packages.md)
...
## [Procédure pas-à-pas : Créer des prévisions de trésorerie à l'aide de les tableaux d'analyse](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)
...
### [Déclaration Intrastat belge](LocalFunctionality/Belgium/belgian-intrastat-reporting.md)  
...
### [Exporter et reporter les domiciliations](LocalFunctionality/Belgium/how-to-export-and-post-domiciliations.md)
...
### [Créer des dépôts](LocalFunctionality/Canada/how-to-create-deposits.md)  
### [Gérer les renseignements sur le crédit client](LocalFunctionality/Canada/how-to-manage-customer-credit-information.md)
...
### [Exporter des écritures pour les audits fiscaux](LocalFunctionality/France/how-to-export-general-ledger-entries-for-tax-audits.md)
### [Exporter des écritures vers un fichier XML](LocalFunctionality/France/how-to-export-general-ledger-entries-to-an-xml-file.md)
...
### [Configurer les états de règlement](LocalFunctionality/France/how-to-set-up-payment-statuses.md)
...
### [Annuler l'affectation d'écritures](LocalFunctionality/France/how-to-unapply-general-ledger-entries.md)
...
### [Calculer la quantité disponible pour une commande d'inventaire physique](LocalFunctionality/Germany/how-to-calculate-quantity-on-hand-for-a-physical-inventory-order.md)
...
### [Corriger les rapports fiscaux](LocalFunctionality/Germany/how-to-correct-vat-reports.md)
### [Créer un enregistrement d'inventaire physique](LocalFunctionality/Germany/how-to-create-a-physical-inventory-recording.md)
### [Créer manuellement des rappels de livraison](LocalFunctionality/Germany/how-to-create-delivery-reminders-manually.md)
### [Créer des rapports fiscaux](LocalFunctionality/Germany/how-to-create-vat-reports.md)
...
### [Saisir les dimensions pour des commandes inventaire physique](LocalFunctionality/Germany/how-to-enter-dimensions-for-physical-inventory-orders.md)
### [Saisir les commandes pour l'inventaire physique](LocalFunctionality/Germany/how-to-enter-physical-inventory-orders.md)
### [Liste des ventes intracommunautaires en Allemagne](LocalFunctionality/Germany/eu-sales-list-in-germany.md)  
### [Exemple - ligne de commande d'inventaire avec lignes traçabilité](LocalFunctionality/Germany/example-inventory-order-line-with-tracking-lines.md)
...
### [Terminer une commande d'inventaire physique](LocalFunctionality/Germany/how-to-finish-a-physical-inventory-order.md)
### [Terminer un enregistrement d'inventaire physique](LocalFunctionality/Germany/how-to-finish-a-physical-inventory-recording.md)
...
### [Documents d'inventaire physique](LocalFunctionality/Germany/physical-inventory-documents.md)  
### [Lignes de commande d'inventaire avec lignes traçabilité](LocalFunctionality/Germany/physical-inventory-order-lines-with-item-tracking-lines.md)
...
### [Reporter des commandes d'inventaire physique](LocalFunctionality/Germany/how-to-post-physical-inventory-orders.md)
...
### [Configurer les documents d'inventaire physique](LocalFunctionality/Germany/how-to-set-up-physical-inventory-documents.md)
...
### [Afficher les doublons de lignes de commande d'inventaire physique](LocalFunctionality/Germany/how-to-view-duplicate-physical-inventory-order-lines.md)
...
### [Règlements fiscaux islandais pour les escomptes conditionnels](LocalFunctionality/Iceland/icelandic-tax-regulations-of-conditional-discounts.md)
...
### [Créer des dépôts](LocalFunctionality/Mexico/how-to-create-deposits.md)  
...
### [Gérer les renseignements sur le crédit client](LocalFunctionality/Mexico/how-to-manage-customer-credit-information.md)
### [Taxe de vente Mexique](LocalFunctionality/Mexico/mexico-sales-tax.md)
### [Imprimer des rapports de dépannage](LocalFunctionality/Mexico/how-to-print-troubleshooting-reports.md)
### [Déclaration de la taxe de vente au Mexique](LocalFunctionality/Mexico/mexico-sales-tax.md)  
...
### [Configurer la taxe de service et la taxe d'achat](LocalFunctionality/Mexico/how-to-set-up-use-tax-and-purchase-tax.md)  
### [Configurer les escomptes de paiement de vente et la taxe de vente non réalisée](LocalFunctionality/Mexico/how-to-set-up-unrealized-sales-tax-and-sales-payment-discounts.md)  
...
### [Scénario de paiement 3 - Paiement étranger ($ en dev. étr.)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
...
### [Exporter paiements électroniques](LocalFunctionality/Spain/how-to-export-electronic-payments.md)
...
### [Rapports de TVA](LocalFunctionality/Spain/vat-reports.md)
...
### [Imprimer la liste des prélèvements d'inventaire d'un document de vente](LocalFunctionality/Switzerland/how-to-print-an-inventory-picking-list-from-a-sales-order.md)
...
### [Imprimer des rapports de détails des ventes et achats directs](LocalFunctionality/UnitedKingdom/how-to-print-direct-sales-and-purchase-details-reports.md)
...
### [Imprimer des rapports de TVA](LocalFunctionality/UnitedKingdom/how-to-print-vat-reports.md)
...
### [Créer des dépôts](LocalFunctionality/UnitedStates/how-to-create-deposits.md)  
### [Exporter un fichier Positive Pay](finance-how-positive-pay.md)
### [Procédure : gérer les renseignements sur le crédit client](LocalFunctionality/UnitedStates/how-to-manage-customer-credit-information.md)
...
### [Rapport sur la taxe de vente aux États-Unis](LocalFunctionality/UnitedStates/us-sales-tax.md)  
