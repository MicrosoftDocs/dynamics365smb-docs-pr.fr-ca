...
Sur la page **Configuration pile**, vous configurez des indicateurs pour toutes les piles disponibles dans la base de données de la compagnie.
...
1. Sous **Activités** sur votre page Tableau de bord, sélectionnez **Paramétrer piles**.  
   La page **Configuration pile** s'affiche. La page répertorie les indicateurs actuellement configurés sur des piles.
