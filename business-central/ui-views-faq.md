...
Les vues que vous voyez sur une liste sont une combinaison de vos vues personnelles avec des vues système. Les vues système peuvent provenir de l'application métier, d'extensions ou être spécifiques à un rôle si la liste a été personnalisée pour votre rôle.
