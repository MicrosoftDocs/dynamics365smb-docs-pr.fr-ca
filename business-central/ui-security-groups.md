...
1. Attribuez des autorisations de la manière suivante :
    ...
    * Pour attribuer plusieurs ensembles d’autorisations, choisissez l’action **Ajouter plusieurs**, puis choisissez les ensembles à attribuer.
1. Définissez la colonne **Compagnie** pour appliquer l’ensembles d’autorisations à une compagnie spécifique uniquement. Si vous souhaitez que l’ensemble d’autorisations s’applique à toutes les compagnies, laissez la colonne **Compagnie** vide. [En savoir plus](ui-define-granular-permissions.md#control-access-to-specific-companies).
