...
description: 'Fournit une fonctionnalité d’aperçu de toutes les fonctionnalités commerciales et des départements qui sont pris en charge par les domaines d’application, comme les finances, l’inventaire et la gestion de projets.'
author: brentholtorf
...
|Assurer un flux efficace des marchandises reçues et livrées.|[Vue d’ensemble de la gestion des entrepôts](design-details-warehouse-management.md)|
