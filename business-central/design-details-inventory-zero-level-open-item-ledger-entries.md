...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Détails de conception : problème connu lié à l'affectation d'articles
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Notions de base de l'affectation d'articles
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Affectation de quantité
...
### <a name="cost-application"></a><a name="cost-application"></a>Coût appliqué
