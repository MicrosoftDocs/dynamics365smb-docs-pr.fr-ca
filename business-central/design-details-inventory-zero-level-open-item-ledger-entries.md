...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Détails de conception : problème connu lié à l'affectation d'articles
...
## <a name="basics-of-item-application" />Notions de base de l'affectation d'articles
...
### <a name="quantity-application" />Affectation de quantité
...
### <a name="cost-application" />Coût appliqué
