...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Préparer la génération de rapports financiers avec des données financières et des catégories de compte
...
## <a name="financial-reports"></a><a name="financial-reports"></a>Rapports financiers
...
## <a name="gl-account-categories"></a><a name="gl-account-categories"></a>Catégories de compte GL
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Créer un rapport financier
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Configurer des rapports financiers avec des aperçus
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Imprimer et enregistrer des rapports financiers
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Programmer un rapport financier ou l’enregistrer au format PDF, Word ou Excel
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importation ou exportation de rapports financiers
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Importer et exporter des rapports financiers
