...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Pour ranger la production avec un rangement inventaire
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Pour ranger la production avec un rangement inventaire
