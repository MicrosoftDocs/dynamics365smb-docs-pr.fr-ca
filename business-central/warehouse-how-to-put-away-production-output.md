...
description: Le mode de rangement de la production dépend du mode de configuration de l'entrepôt en tant qu'emplacement. Le rangement inventaire peut être effectué des manières suivantes.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
