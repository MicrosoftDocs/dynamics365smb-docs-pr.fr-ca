...
## <a name="to-cancel-a-posted-sales-invoice" />Pour annuler une facture vente reportée
...
### <a name="partial-invoice-posting-also-supported" />Report partiel de facture également pris en charge
...
## <a name="to-correct-a-posted-sales-invoice" />Pour corriger une facture vente reportée
