...
## <a name="tracing-from-usage-to-origin" />Traçabilité de l'utilisation à l'origine
...
## <a name="tracing-from-origin-to-usage" />Traçabilité de l'origine à l'utilisation
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Pour trouver toutes les utilisations du lot défectueux
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders" />Pour rechercher toutes les occurrences du LOT1 dans les enregistrements non reportés, comme les commandes ouvertes
