...
ms.author: bholtorf
---
# <a name="report-selection-for-documents-in-business-central" />Sélection de rapport pour les documents dans Business Central
...
## <a name="available-report-selections" />Sélection des rapports disponible
...
## <a name="example-report-selection-for-sales-documents" />Exemple : Sélection des rapports pour les documents de vente
