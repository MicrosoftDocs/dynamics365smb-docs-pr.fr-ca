...
ms.author: edupont
---
# <a name="register-employees" />Enregistrer des employés
...
## <a name="to-set-up-an-employee" />Pour configurer un employé
...
## <a name="to-insert-a-picture-of-an-employee" />Pour insérer une photo d'un employé
...
## <a name="to-register-various-information-about-an-employee" />Pour enregistrer diverses informations sur un employé
