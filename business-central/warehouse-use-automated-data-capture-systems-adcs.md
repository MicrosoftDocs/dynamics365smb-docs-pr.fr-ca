...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user" />Pour spécifier qu'un employé d'entrepôt est un utilisateur ADCS
...
## <a name="to-create-and-customize-miniforms" />Pour créer et personnaliser des mini-formulaires
...
### <a name="to-create-a-miniform-for-adcs" />Pour créer un mini-formulaire de saisie automatisée
...
### <a name="to-customize-miniform-functions" />Pour personnaliser les fonctions de mini-formulaire
