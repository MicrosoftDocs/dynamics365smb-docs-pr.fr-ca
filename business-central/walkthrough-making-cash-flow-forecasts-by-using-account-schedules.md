...
---
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Procédure pas-à-pas : créer des prévisions de la trésorerie à l’aide de rapports financiers
...
## <a name="set-up-a-new-financial-report-name"></a>Configuration d’un nouveau nom de rapport financier
...
### <a name="set-up-a-new-financial-report-name-1"></a>Configurer un nouveau nom de rapport financier
...
### <a name="set-up-row-definition-lines-1"></a>Configuration des lignes de définition de ligne
...
## <a name="set-up-a-new-column-definition"></a>Configuration d’une nouvelle définition de colonne
...
### <a name="set-up-a-new-column-definition-1"></a>Configurer une nouvelle définition de colonne
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Affectation d’une définition de colonne au nom de rapport financier
