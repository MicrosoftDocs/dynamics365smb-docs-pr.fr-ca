---
title: Consommer des composantes en fonction de la production réalisée
description: Cet article décrit comment rincer les composantes en fonction de la sortie de l’opération et d’autres méthodes de rinçage impliquées.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
- **Évaluation de l'inventaire**
    ...
    Les écritures de valeur de production et de consommation sont créées parallèlement à la progression du bon de production. Sans les codes lien itinéraire, la valeur de l'inventaire augmente lorsque la production est reportée, puis diminue ultérieurement lorsque la valeur de la consommation des composantes est reportée en même temps que le bon de production terminé.  
