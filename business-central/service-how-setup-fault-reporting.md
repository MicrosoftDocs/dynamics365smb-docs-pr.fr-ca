...
# <a name="set-up-fault-reporting" />Configurer le rapport de panne
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Pour spécifier le niveau global du rapport panne
