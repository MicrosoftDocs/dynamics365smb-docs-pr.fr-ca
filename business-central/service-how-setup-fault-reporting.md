...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Configurer le rapport de panne
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Pour spécifier le niveau global du rapport panne
