...
| [Configurer la TVA non réalisée](finance-setup-unrealized-vat.md) | Si vous utilisez la comptabilité basée sur la trésorerie, cet article fournit des conseils sur la manière de spécifier le traitement de la TVA non réalisée pour les ventes et les achats.|
...
| [Configurer un relevé fiscal](finance-how-setup-vat-statement.md) | Cet article fournit des informations pour vous assurer que vous savez comment configurer un modèle de relevé fiscal et des noms pour répondre aux exigences changeantes de l’administration fiscale.|
