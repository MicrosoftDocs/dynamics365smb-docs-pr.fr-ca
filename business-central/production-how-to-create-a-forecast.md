...
## <a name="sales-forecasts-and-production-forecasts"></a>Prévisions des ventes et de la production
...
## <a name="forecast-by-locations"></a>Prévision par emplacements
...
### <a name="if-you-dont-use-forecast-by-locations"></a>Si vous n'utilisez pas la prévision par emplacements
