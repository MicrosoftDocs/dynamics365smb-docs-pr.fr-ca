...
4. Dans le champ **Compte bancaire préféré**, cliquez sur la banque sur laquelle l'argent est transféré lorsqu'il est traité par votre banque électronique.  
     ...
     La valeur du champ **Compte bancaire préféré** est copiée dans le champ **Cpte bancaire destinataire** de la page **Journal paiement**.  
...
4. Sur la page **Lots journal général**, sous l'onglet **Accueil**, dans le groupe **Gestion**, choisissez **Modifier la liste**.  
...
## <a name="preparing-the-payment-journal"></a>Préparation du journal paiement
...
## <a name="posting-the-payments"></a>Report des paiements
