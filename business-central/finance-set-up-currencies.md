...
## <a name="lcy-and-other-currencies" />$ et autres devises

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Arrondissement des devises
...
### <a name="unit-amount-rounding" />Arrondissement montant unité
...
### <a name="amount-rounding" />Arrondissement montant
...
## <a name="general-ledger-accounts" />Comptes GL
