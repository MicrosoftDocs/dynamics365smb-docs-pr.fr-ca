...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>$ et autres devises

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Arrondissement des devises
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Arrondissement montant unité
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Arrondissement montant
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Comptes GL
