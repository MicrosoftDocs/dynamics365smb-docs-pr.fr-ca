...
5. Pour obtenir la liste des documents avec un état d'affectation ou un état document spécifié, renseignez le champ **Filtre affectation/Filtre état**, puis appuyez sur **Entrée**.  
