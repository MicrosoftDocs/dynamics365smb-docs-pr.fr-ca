...
---
# <a name="share-and-export-reports-with-the-report-inbox" />Partager et exporter des rapports avec la boîte de réception Rapport
...
## <a name="download-generated-reports" />Télécharger les rapports générés
...
## <a name="open-generated-reports-in-onedrive" />Ouvrir les rapports générés dans OneDrive
...
## <a name="share-scheduled-reports" />Partager les rapports programmés
