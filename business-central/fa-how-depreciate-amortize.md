...
## Pour reporter un amortissement manuellement à partir du journal GL immobilisation
...
Si vous avez configuré des clés d'affectation immobilisation pour affecter des montants à plusieurs départements ou plusieurs projets, les montants sont affectés lors du report. Pour en savoir plus, voir [Configurer des informations générales sur les immobilisations](fa-how-setup-general.md).  

## Pour gérer la valeur comptable finale

Dans le champ **Valeur comptable finale** de la page **Registres amortissement immo.**, vous pouvez spécifier la valeur comptable que vous souhaitez pour votre immobilisation dans le registre amortissement actuel une fois que vous l'avez entièrement amortie. Vous pouvez entrer la valeur manuellement ou vous pouvez renseigner le champ **Valeur comptable finale par défaut** sur la page **Registre amortissement**. La valeur renseigner automatiquement le champ.
...
## Pour calculer les affectations pour une immobilisation
...
2. Cliquez sur **Informations connexes**, **Groupe de report**, **Affectations**, puis **Amortissement**.
3. Remplissez les comptes du grand livre et les pourcentages d'affectation correspondants pour chaque groupe de report, puis fermez la page.
4. Ensuite, sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), saisissez **Journaux GL immobilisation**, puis choisissez le lien associé.
5. Saisissez l’immobilisation, et le groupe de report immo. correspondant ainsi que le registre amortissement détermineront les lignes répartition.
6. Choisissez l'action **Reporter** pour reporter le journal.
...
## Utilisez les listes de duplication pour préparer le report vers plusieurs registres amortissement
...
## Pour reporter des écritures dans plusieurs registres amortissement
...
Les lignes copiées sont créées dans le journal GL immobilisation ou le journal immobilisation, selon que le registre amortissement que vous copiez a été intégré dans le grand livre ou non.  
