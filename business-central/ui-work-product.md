...
| Recherchez une page ou un rapport spécifique. |[Utilisation de l'icône Page ou état pour la recherche](ui-search.md) |
| Filtrez des données dans des vues, des rapports ou des fonctions en utilisant des symboles et caractères spéciaux. |[Saisir les critères pour les filtres](ui-enter-criteria-filters.md) |
...
|Affichez un aperçu, imprimez ou enregistrez des rapports.|[Utilisation des rapports](ui-work-report.md)|
