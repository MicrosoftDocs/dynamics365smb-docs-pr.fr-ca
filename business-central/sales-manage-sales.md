...
| Créer une note de crédit vente pour rembourser une facture vente reportée spécifique pour indiquer les produits retournés par le client et le montant règlement que vous remboursez. |[Traitement des retours ou annulations de ventes](sales-how-process-sales-returns-cancellations.md) |
