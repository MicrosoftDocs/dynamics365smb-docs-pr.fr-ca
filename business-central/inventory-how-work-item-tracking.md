...
Si vous créez des numéros de série en bloc à l’aide des actions **Créer numéros de série personnalisés** ou **Affecter numéros de série**, vous pouvez activer **Créer informations NS** et une fiche d’information sera créée pour chaque ligne de suivi.

Sinon, vous pouvez créer une fiche d’informations lorsque vous reportez des journaux ou des documents, sur la page **Code traçabilité**, activez les boutons bascule **Créer des infos NS au report** ou **Créer des infos NS au report**. 
