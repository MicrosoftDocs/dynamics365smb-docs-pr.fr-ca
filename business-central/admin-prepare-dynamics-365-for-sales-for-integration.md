...
### <a name="connection-settings-in-the-setup-guide" />Configuration de connexion dans le guide de configuration
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Configuration de connexion sur la page Configuration de la connexion Microsoft Dynamics 365
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synchronisation des articles et des ressources avec des produits dans différentes unités de mesure
...
### <a name="default-synchronization-job-queue-entries" />Écritures de file d'attente projets de synchronisation par défaut
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Connexion aux versions locales de la 1re vague de lancement de Business Central 2019 et Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Pour connecter la 1re vague de lancement 2019 Business Central et Dynamics NAV 2018
