...
Pour résoudre les problèmes liés à Microsoft Flow, voir [Résolution des problèmes d'intégration à Microsoft Flow](across-troubleshooting-how-use-financials-data-source-flow.md).
