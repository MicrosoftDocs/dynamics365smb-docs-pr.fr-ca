...
# <a name="building-power-bi-reports-to-display-include-prodlongincludesprodlongmd-data" />Création de rapports Power BI pour afficher des données [!INCLUDE [prod_long](includes/prod_long.md)]
...
## <a name="creating-accessible-reports" />Créer des rapports accessibles
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Création de rapports pour afficher des données associées à une liste
...
## <a name="a-namethemeausing-the-include-prodshortincludesprodshortmd-report-theme-optional" /><a name="theme"></a>Utilisation du thème du rapport [!INCLUDE [prod_short](includes/prod_short.md)] (facultatif)
...
### <a name="import-the-theme-on-a-report" />Importer le thème dans un rapport
...
## <a name="publish-reports" />Publier des rapports
...
## <a name="distribute-or-share-a-report" />Distribuer ou partager un rapport
