...
5. Sinon, créez une nouvelle URL de service web dans [!INCLUDE[d365fin_long_md](includes/d365fin_long_md.md)] à l'aide de l'action **Créer un ensemble de données** sur la page **Services web**, à l'aide du guide de configuration assistée **Configurer le rapport** ou en choisissant l'action **Modifier dans Excel** dans n'importe quelles listes.
