...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Création de rapports Power BI pour afficher des données [!INCLUDE [prod_long](includes/prod_long.md)]
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Créer des rapports accessibles
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Création de rapports pour afficher des données associées à une liste
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Utilisation du thème du rapport [!INCLUDE [prod_short](includes/prod_short.md)] (facultatif)
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Importer le thème dans un rapport
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Publier des rapports
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Distribuer ou partager un rapport
