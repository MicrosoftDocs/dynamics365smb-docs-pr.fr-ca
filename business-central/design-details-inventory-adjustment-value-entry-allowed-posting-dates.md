...
## <a name="change-the-user-setup" />Modifier la configuration utilisateur
...
### <a name="overview-of-involved-posting-date-setup" />Aperçu de la configuration de la date de report impliquée
...
#### <a name="user-setup" />Configuration utilisateur
