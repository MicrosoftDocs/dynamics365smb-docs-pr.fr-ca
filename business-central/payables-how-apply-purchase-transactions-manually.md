...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Rapprocher des paiements fournisseur avec le journal paiement ou à partir des écritures fournisseur
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Pour affecter un paiement à une seule ou à plusieurs écritures fournisseur
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Pour affecter une note de crédit à une seule ou à plusieurs écritures fournisseur
...
## <a name="to-apply-posted-vendor-ledger-entries" />Pour affecter des écritures fournisseur reportées
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Pour affecter des écritures fournisseur en devises différentes à une autre
...
## <a name="to-unapply-an-application-of-vendor-entries" />Pour annuler l'affectation des écritures fournisseur
