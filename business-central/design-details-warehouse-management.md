...
### <a name="locations-and-bins" />Emplacements et zones
...
### <a name="shelves-and-bins" />Tablettes et zones
...
#### <a name="bins-and-bin-content" />Zones et contenu zone
...
#### <a name="bin-ranking" />Classement de zone
...
#### <a name="bin-setup" />Configuration zone
...
#### <a name="warehouse-class" />Classe magasin
