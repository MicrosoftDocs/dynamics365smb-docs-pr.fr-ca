...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Emplacements et zones
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Tablettes et zones
...
#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Zones et contenu zone
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Type zone
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Classement de zone
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Configuration zone
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>Classe magasin
