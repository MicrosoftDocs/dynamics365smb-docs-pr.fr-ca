...
[!INCLUDE[d365fin](includes/d365fin_md.md)] prend en charge les déclarations de TVA inter-groupes pour les compagnies utilisant [!INCLUDE[d365fin](includes/d365fin_md.md)] sur site ou en ligne, et dans n’importe quelle combinaison. La configuration de la communication dépend de la constellation. Les sections suivantes décrivent comment configurer diverses constellations de groupe.
...
2. Partagez les informations techniques dont les membres du groupe TVA et la société représentante ont besoin pour connecter leurs locataires [!INCLUDE[d365fin](includes/d365fin_md.md)].
...
2. Pour définir le rôle du groupe TVA de la compagnie, choisissez **Membre** , puis **Suivant** .
...
5. Ajoutez le nom de la compagnie [!INCLUDE[d365fin](includes/d365fin_md.md)] qui représente le groupe TVA, tel que *CRONUS UK Ltd* .
6. Choisissez le **Type d’authentification** , **OAuth2** , puis **Suivant** .
7. Dans le champ **Code client** , saisissez le code fourni par la société représentante du groupe TVA.
