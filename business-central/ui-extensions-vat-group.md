...
4. Dans le champ  **OAuth Point de terminaison d’autorité 2.0**, entrez `https://login.microsoftonline.com/common/oauth2`.
5. Dans le champ  **OAuth URL de la ressource 2.0**, entrez `https://api.businesscentral.dynamics.com/`.
6. Dans le champ **OAuth URL de redirection 2.0**, saisissez `https://businesscentral.dynamics.com/OAuthLanding.htm`.
