...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Pour enregistrer les travaux d'entretien sur une immobilisation
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Pour reporter les coûts d'entretien à partir d'un journal GL immobilisation
...
## <a name="to-monitor-maintenance-costs" />Pour surveiller les coûts d'entretien
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Pour afficher ou imprimer les coûts d'entretien pour plusieurs immobilisations
...
## <a name="to-view-maintenance-ledger-entries" />Pour visualiser des écritures entretien
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Pour afficher ou imprimer les écritures d'entretien pour plusieurs immobilisations
