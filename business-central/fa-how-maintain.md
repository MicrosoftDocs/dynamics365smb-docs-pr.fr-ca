...
## Enregistrer un coût d'entretien directement sur une immobilisation
...
## Reporter les coûts d'entretien à partir d’un journal GL immobilisation
...
## Enregistrer le coût d'entretien à partir d’une facture achat
...
## Surveiller les coûts d’entretien
...
## Afficher ou imprimer les coûts d'entretien pour plusieurs immobilisations
...
## Visualiser des écritures entretien
...
## Afficher ou imprimer des écritures entretien pour plusieurs immobilisations
