...
## <a name="balances-between-cost-type-cost-center-and-cost-object" />Soldes entre le type de coût, un centre de coûts et les objets de coûts
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Pour transférer le plan des comptes du grand livre vers le plan des types de coûts
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Types de coûts sans relation avec le grand livre
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Pour transférer des valeurs de dimension du grand livre vers le plan des centres de coûts
...
## <a name="setting-up-cost-objects" />Configuration des objets de coûts
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Pour transférer des valeurs de dimension du grand livre vers le plan des objets de coûts
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Pour créer de nouveaux objets de coûts sur la page Plan comptable des objets de coûts
