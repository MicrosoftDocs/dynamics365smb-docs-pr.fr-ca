...
## <a name="to-create-a-physical-inventory-order"></a><a name="to-create-a-physical-inventory-order"></a>Pour créer une commande d'inventaire physique
...
## <a name="to-create-a-physical-inventory-recording"></a><a name="to-create-a-physical-inventory-recording"></a>Pour créer un enregistrement d'inventaire physique
...
## <a name="to-finish-a-physical-inventory-recording"></a><a name="to-finish-a-physical-inventory-recording"></a>Pour finaliser un enregistrement d'inventaire physique
...
## <a name="to-complete-a-physical-inventory-order"></a><a name="to-complete-a-physical-inventory-order"></a>Pour finaliser une commande d'inventaire physique
...
### <a name="to-find-duplicate-physical-inventory-order-lines"></a><a name="to-find-duplicate-physical-inventory-order-lines"></a>Pour rechercher les doublons de lignes de commande d'inventaire physique
...
### <a name="to-post-a-physical-inventory-order"></a><a name="to-post-a-physical-inventory-order"></a>Pour reporter une commande d'inventaire physique
...
### <a name="to-view-posted-physical-inventory-orders"></a><a name="to-view-posted-physical-inventory-orders"></a>Pour afficher les commandes d'inventaire physique reportées
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a><a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a>Exemple - Préparer un enregistrement d'inventaire physique pour un article - Article suivi
...
### <a name="example---record-and-post-counted-lot-number-differences"></a><a name="example---record-and-post-counted-lot-number-differences"></a>Exemple - Enregistrer et reporter les différences de numéro de lot comptabilisé
...
### <a name="to-set-up-numbering-for-inventory-documents"></a><a name="to-set-up-numbering-for-inventory-documents"></a>Pour configurer la numérotation des documents d'inventaire
...
### <a name="to-create-and-post-an-inventory-document"></a><a name="to-create-and-post-an-inventory-document"></a>Pour créer et reporter un document d'inventaire
...
## <a name="printing-inventory-documents"></a><a name="printing-inventory-documents"></a>Impression des documents inventaire
