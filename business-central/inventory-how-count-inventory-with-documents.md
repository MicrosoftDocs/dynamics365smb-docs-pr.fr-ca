...
## <a name="to-create-a-physical-inventory-order" />Pour créer une commande d'inventaire physique
...
## <a name="to-create-a-physical-inventory-recording" />Pour créer un enregistrement d'inventaire physique
...
## <a name="to-finish-a-physical-inventory-recording" />Pour finaliser un enregistrement d'inventaire physique
...
## <a name="to-complete-a-physical-inventory-order" />Pour finaliser une commande d'inventaire physique
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Pour rechercher les doublons de lignes de commande d'inventaire physique
...
### <a name="to-post-a-physical-inventory-order" />Pour reporter une commande d'inventaire physique
...
### <a name="to-view-posted-physical-inventory-orders" />Pour afficher les commandes d'inventaire physique reportées
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Exemple - Préparer un enregistrement d'inventaire physique pour un article - Article suivi
...
### <a name="example---record-and-post-counted-lot-number-differences" />Exemple - Enregistrer et reporter les différences de numéro de lot comptabilisé
...
### <a name="to-set-up-numbering-for-inventory-documents" />Pour configurer la numérotation des documents d'inventaire
...
### <a name="to-create-and-post-an-inventory-document" />Pour créer et reporter un document d'inventaire
...
## <a name="printing-inventory-documents" />Impression des documents inventaire
