...
# <a name="set-up-locations-to-use-bins"></a><a name="set-up-locations-to-use-bins"></a>Configurer des emplacements de sorte qu'ils utilisent des zones
...
## <a name="to-set-up-a-location-to-use-bins"></a><a name="to-set-up-a-location-to-use-bins"></a>Pour configurer un emplacement de sorte qu'il utilise des zones
...
## <a name="fill-in-the-consumption-bin"></a><a name="fill-in-the-consumption-bin"></a>Renseigner la zone consommation
