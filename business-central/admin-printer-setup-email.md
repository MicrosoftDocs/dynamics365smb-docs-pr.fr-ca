...
---
# <a name="set-up-email-printers"></a><a name="set-up-email-printers"></a>Configurer des imprimantes par courriel
...
## <a name="add-an-email-printer"></a><a name="add-an-email-printer"></a>Ajouter une imprimante par courriel
