...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Détails de conception : rapprochement de GL
...
## <a name="post-inventory-cost-to-gl-batch-job" />Traitement par lots Reporter le coût de l'inventaire au grand livre.
...
## <a name="automatic-cost-posting" />Report coûts automatique
